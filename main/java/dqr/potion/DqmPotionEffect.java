...
public class DqmPotionEffect extends PotionEffect{
    ...
    /*
	public DqmPotionEffect(int p_i1574_1_, int p_i1574_2_) {
		super(p_i1574_1_, p_i1574_2_);
		// TODO 自動生成されたコンストラクター・スタブ
	}

	public DqmPotionEffect(int p_i1574_1_, int p_i1574_2_, int p_i1574_3_) {
		super(p_i1574_1_, p_i1574_2_, p_i1574_3_);
		// TODO 自動生成されたコンストラクター・スタブ
	}

	public DqmPotionEffect(int p_i1574_1_, int p_i1574_2_, int p_i1574_3_, boolean p_i1574_4_) {
		super(p_i1574_1_, p_i1574_2_, p_i1574_3_, p_i1574_4_);
		// TODO 自動生成されたコンストラクター・スタブ
	}

	public DqmPotionEffect(PotionEffect pot) {
		super(pot);
		// TODO 自動生成されたコンストラクター・スタブ
	}
	*/
    ...
    {
		//DQR.func.debugString("PotionTest B");
        if (this.duration > 0)
        {
        	//DQR.func.debugString("PotionTest A");
            //Potion.potionTypes[this.potionID].performEffect(p_76457_1_, this.amplifier);
        	DqmPotionBase pot = (DqmPotionBase)DqmPotionBase.potionTypes[this.potionID];
        	pot.performEffect2(p_76457_1_, this.amplifier);
        }
    }
    ...
    public DqmPotionEffect(int p_i1575_1_, int p_i1575_2_, int p_i1575_3_)
    {
        this(p_i1575_1_, p_i1575_2_, p_i1575_3_, false);
    }

    public DqmPotionEffect(int p_i1576_1_, int p_i1576_2_, int p_i1576_3_, boolean p_i1576_4_)
    {
    ...
    public DqmPotionEffect(DqmPotionEffect p_i1577_1_)
    {
    	super(p_i1577_1_);
    ...
    public DqmPotionEffect(PotionEffect p_i1577_1_)
    {
    	super(p_i1577_1_);
        this.potionID = p_i1577_1_.getPotionID();
        this.duration = p_i1577_1_.getDuration();
        this.amplifier = p_i1577_1_.getAmplifier();
        this.curativeItems = p_i1577_1_.getCurativeItems();
    }
     ...
     */
    public void combine(DqmPotionEffect p_76452_1_)
    {
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        {
        	DqmPotionEffect potioneffect = (DqmPotionEffect)p_equals_1_;
