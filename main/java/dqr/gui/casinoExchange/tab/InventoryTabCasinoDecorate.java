...
public class InventoryTabCasinoDecorate  extends AbstractTab {
	...
	public void onTabClicked() {
		...
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQR.conf.GuiID_CEDecorate));
	...
	public ItemStack getItemStack() {
		return new ItemStack(DQDecorates.DqmBlockHondana, 1);
	}
	...
	public String getTabName() {
		return "dqm.guin.tab.medalking.Decorate";
	}
