...
public class InventoryTabCasinoDecorateH  extends AbstractTab {
	...
	public void onTabClicked() {
		...
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQR.conf.GuiID_CEDecorateH));
	...
	public ItemStack getItemStack() {
		return new ItemStack(DQDecorates.DqmBlockHasiraue, 1);
	}
	...
	public String getTabName() {
		return "dqm.guin.tab.medalking.DecorateH";
	}
