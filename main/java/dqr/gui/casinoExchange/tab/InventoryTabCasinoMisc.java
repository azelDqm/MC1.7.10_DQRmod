...
public class InventoryTabCasinoMisc  extends AbstractTab {
	...
	public void onTabClicked() {
		...
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQR.conf.GuiID_CEMisc));
	...
	public ItemStack getItemStack() {
		return new ItemStack(DQMiscs.itemKimeranotubasa, 1);
	}
	...
	public String getTabName() {
		return "dqm.guin.tab.medalking.Misc";
	}
