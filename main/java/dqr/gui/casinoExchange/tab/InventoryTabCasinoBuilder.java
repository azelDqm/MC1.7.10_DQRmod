...
public class InventoryTabCasinoBuilder  extends AbstractTab {
	...
	public void onTabClicked() {
		...
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQR.conf.GuiID_CEBuilder));
	...
	public ItemStack getItemStack() {
		return new ItemStack(DQBuilders.itemBuilderDama, 1);
	}
	...
	public String getTabName() {
		return "dqm.guin.tab.medalking.Builder";
	}
