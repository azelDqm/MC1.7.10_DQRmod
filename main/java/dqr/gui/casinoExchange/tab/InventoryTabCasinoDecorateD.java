...
public class InventoryTabCasinoDecorateD  extends AbstractTab {
	...
	public void onTabClicked() {
		...
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQR.conf.GuiID_CEDecorateD));
	...
	public ItemStack getItemStack() {
		return new ItemStack(DQDecorates.DqmBlockDaizaS, 1);
	}
	...
	public String getTabName() {
		return "dqm.guin.tab.medalking.DecorateD";
	}
