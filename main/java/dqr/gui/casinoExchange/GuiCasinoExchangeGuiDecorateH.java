...
public class GuiCasinoExchangeGuiDecorateH extends InventoryEffectRenderer
{
    ...
    public GuiCasinoExchangeGuiDecorateH(EntityPlayer p_i1094_1_)
    {
        //super(new ContainerPlayerNext(p_i1094_1_.inventory, p_i1094_1_));
    	super(new GuiCasinoExchangeContainer(p_i1094_1_.inventory, DQR.conf.GuiID_CEDecorateH));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, CasinoExchangeTabs.tabCasinoDecorateH,false);
