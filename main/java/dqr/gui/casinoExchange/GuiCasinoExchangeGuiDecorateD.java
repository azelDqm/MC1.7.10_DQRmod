...
public class GuiCasinoExchangeGuiDecorateD extends InventoryEffectRenderer
{
    ...
    public GuiCasinoExchangeGuiDecorateD(EntityPlayer p_i1094_1_)
    {
        //super(new ContainerPlayerNext(p_i1094_1_.inventory, p_i1094_1_));
    	super(new GuiCasinoExchangeContainer(p_i1094_1_.inventory, DQR.conf.GuiID_CEDecorateD));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, CasinoExchangeTabs.tabCasinoDecorateD,false);
