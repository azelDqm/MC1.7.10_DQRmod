...
public class InventoryCasinoExchange implements IInventory
{
    ...
    public InventoryCasinoExchange(InventoryPlayer inventory, EntityPlayer ep, int guiId)
    {
        ...
        if(guiId == DQR.conf.GuiID_CEWeapon)
        {
        	itemMap = DQR.casinoItem.medalWeapon;
        }else if(guiId == DQR.conf.GuiID_CEArmor)
        {
        	itemMap = DQR.casinoItem.medalArmor;
        }
        /*else if(guiId == DQR.conf.GuiID_CEMagic)
        {
        	itemMap = DQR.casinoItem.medalMagic;
        }*/else if(guiId == DQR.conf.GuiID_CEMisc)
        {
        	//itemMap = DQR.medalItem.medalItem;
        	itemMap = DQR.casinoItem.medalItem;
        }else if(guiId == DQR.conf.GuiID_CEAccessory)
        {
        	//itemMap = DQR.medalItem.medalItem;
        	itemMap = DQR.casinoItem.medalAccessory;
        }else if(guiId == DQR.conf.GuiID_CEBuilder)
        {
        	//itemMap = DQR.medalItem.medalItem;
        	itemMap = DQR.casinoItem.medalBuilder;
        }else if(guiId == DQR.conf.GuiID_CEDecorate)
        {
        	//itemMap = DQR.medalItem.medalItem;
        	itemMap = DQR.casinoItem.medalDecorate;
        }else if(guiId == DQR.conf.GuiID_CEDecorateD)
        {
        	//itemMap = DQR.medalItem.medalItem;
        	itemMap = DQR.casinoItem.medalDecorateDaiza;
        }else if(guiId == DQR.conf.GuiID_CEDecorateH)
        {
        	//itemMap = DQR.medalItem.medalItem;
        	itemMap = DQR.casinoItem.medalDecorateHasira;
        }
        ...
        for (Item key : itemMap.keySet()) {
			...
			*/
        	...
        	nbt.setInteger("casinocoin", itemMap.get(key));
