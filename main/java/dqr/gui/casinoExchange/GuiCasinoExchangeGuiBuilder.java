...
public class GuiCasinoExchangeGuiBuilder extends InventoryEffectRenderer
{
    ...
    public GuiCasinoExchangeGuiBuilder(EntityPlayer p_i1094_1_)
    {
        //super(new ContainerPlayerNext(p_i1094_1_.inventory, p_i1094_1_));
    	super(new GuiCasinoExchangeContainer(p_i1094_1_.inventory, DQR.conf.GuiID_CEBuilder));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, CasinoExchangeTabs.tabCasinoBuilder,false);
