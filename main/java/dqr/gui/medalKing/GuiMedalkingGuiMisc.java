...
public class GuiMedalkingGuiMisc extends InventoryEffectRenderer
{
    ...
    public GuiMedalkingGuiMisc(EntityPlayer p_i1094_1_)
    {
        //super(new ContainerPlayerNext(p_i1094_1_.inventory, p_i1094_1_));
    	super(new GuiMedalkingContainer(p_i1094_1_.inventory, DQR.conf.GuiID_MKMisc));
    	this.ySize = 173;
