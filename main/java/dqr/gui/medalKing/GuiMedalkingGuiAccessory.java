...
public class GuiMedalkingGuiAccessory extends InventoryEffectRenderer
{
    ...
    public GuiMedalkingGuiAccessory(EntityPlayer p_i1094_1_)
    {
        //super(new ContainerPlayerNext(p_i1094_1_.inventory, p_i1094_1_));
    	super(new GuiMedalkingContainer(p_i1094_1_.inventory, DQR.conf.GuiID_MKAccessory));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, MedalKingTabs.tabMedalAccessory,false);
