...
public class TabButton  extends GuiButton{
    ...
    public void drawButton (Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            ...
            //this.itemRenderer.renderItemAndEffectIntoGUI(mc.fontRenderer, mc.renderEngine, new ItemStack(Items.iron_ingot, 1), xPosition + 6, yPosition + 8);

            //TestX
            this.itemRenderer.renderItemOverlayIntoGUI(mc.fontRenderer, mc.renderEngine, tab.getItemStack(), xPosition + 6, yPosition + 8);
            //this.itemRenderer.renderItemOverlayIntoGUI(mc.fontRenderer, mc.renderEngine, new ItemStack(Items.iron_sword, 1), xPosition + 6, yPosition + 8);
