...
public class InventoryTabMedalMagic2  extends AbstractTab {
	...
	public void onTabClicked() {
		...
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQR.conf.GuiID_MKMagic2));
	...
	public ItemStack getItemStack() {
		return new ItemStack(DQMagics.itemBehoma, 1);
	}
	...
	public String getTabName() {
		return "dqm.guin.tab.medalking.magics2";
	}
