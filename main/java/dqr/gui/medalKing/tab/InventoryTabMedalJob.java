...
public class InventoryTabMedalJob  extends AbstractTab {
	...
	public void onTabClicked() {
		...
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQR.conf.GuiID_MKJob));
	...
	public ItemStack getItemStack() {
		return new ItemStack(DQEmblems.itemEmbHero, 1);
	}
	...
	public String getTabName() {
		return "dqm.guin.tab.medalking.job";
	}
