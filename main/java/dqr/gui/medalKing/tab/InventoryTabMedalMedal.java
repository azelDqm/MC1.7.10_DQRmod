...
public class InventoryTabMedalMedal  extends AbstractTab {
	...
	public void onTabClicked() {
		...
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQR.conf.GuiID_MKMedal));
	...
	public ItemStack getItemStack() {
		return new ItemStack(DQMiscs.itemLittlemedal, 1);
	}
	...
	public String getTabName() {
		return "dqm.guin.tab.medalking.Medal";
	}
