...
public class FuncSyuuriPriceTable
{
    ...
    public static int Gold(ItemStack par1ItemStack)
    {
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemGinganoturugi2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemNyoraikon2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemSinryuunotume2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemHakainotekkyuu2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemGodakkusu2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemTyouguringamunomuti2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemSinken2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemMetarukingnoyari2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemToririondaga2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemSefiramunoyumi2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemHaipanova2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemSaisyuuougi2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
        ...
        if (par1ItemStack.getItem() == DQWeapons.itemSeiginosoroban2)
        {
            fixPrice = 50000;
            return fixPrice;
        }
