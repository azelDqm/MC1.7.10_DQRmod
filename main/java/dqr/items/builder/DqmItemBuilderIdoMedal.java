...
import dqr.thread.ThreadBuilderIdoMedal;

public class DqmItemBuilderIdoMedal extends DqmItemBuilderBase{

	public DqmItemBuilderIdoMedal(EnumDqmBuilder par1)
	{
		super(par1);
	}
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
    	...
    	}else
    	{
        	...
        	if(!par3World.isRemote)
        	{
        		ThreadBuilderIdoMedal builderThread = new ThreadBuilderIdoMedal(par3World, mSize + 1, mHeight, mUnder, par1ItemStack, par2EntityPlayer);
        		builderThread.start();
        	}
