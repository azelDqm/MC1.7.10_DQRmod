...
public class DqmItemMagicDragonF extends DqmItemMagicBase{
    private static final String __OBFID = "CL_00000072";

    public DqmItemMagicDragonF(Item.ToolMaterial p_i45356_1_, float attackDam, int maxDamage, EnumDqmMagic par4)
    {
		...
		*/
		...
		if(true)
    	{
        	...
        	*/
    		...
    		if(par1ItemStack.getItem() == DQMagics.itemBreathF1)
    		{

    			magic = new MagicEntityMeraB[1];
    			magic[0] = new MagicEntityMeraB(par2World, par3EntityPlayer, 1.5F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
    			((MagicEntityMeraB) magic[0]).setWorldFlg(par3EntityPlayer.isSneaking());
    		...
    		}else if(par1ItemStack.getItem() == DQMagics.itemBreathF2)
    		{
    			magic = new MagicEntityMeramiB[3];
    			for(int cnt = 0;cnt < 3; cnt++)
    			{
    				magic[cnt] = new MagicEntityMeramiB(par2World, par3EntityPlayer, 1.5F, 1.0F, 0.0F, 0.0F, 0.0F, (float)(-15.0F + (15.0F * cnt)), 0.0F);
    				((MagicEntityMeramiB) magic[cnt]).setWorldFlg(par3EntityPlayer.isSneaking());
    		...
    		}else if(par1ItemStack.getItem() == DQMagics.itemBreathF3)
    		{
    			magic = new MagicEntityMeramiB[7];
    			for(int cnt = 0;cnt < 7; cnt++)
    			{
    				magic[cnt] = new MagicEntityMeramiB(par2World, par3EntityPlayer, 1.5F, 1.0F, 0.0F, 0.0F, 0.0F, (float)(-45.0F + (15.0F * cnt)), 0.0F);
    				((MagicEntityMeramiB) magic[cnt]).setWorldFlg(par3EntityPlayer.isSneaking());
    				//magic[cnt].setMaxTicksRange(this.getEnumMagic().getTickRange());
    			}
    		...
    		}else if(par1ItemStack.getItem() == DQMagics.itemBreathF4)
    		{
    			magic = new MagicEntityMerazomaB[16];
    			for(int cnt = 0;cnt < 16; cnt++)
    			{
    				magic[cnt] = new MagicEntityMerazomaB(par2World, par3EntityPlayer, 1.5F, 1.0F, 0.0F, 0.0F, 0.0F, (float)(-157.5F + (22.5F * cnt)), 0.0F);
    				((MagicEntityMerazomaB) magic[cnt]).setWorldFlg(par3EntityPlayer.isSneaking());
    				//magic[cnt].setMaxTicksRange(this.getEnumMagic().getTickRange());
    			}
    			/*
    	   		minusMP = 38;
    		...
    		}else if(par1ItemStack.getItem() == DQMagics.itemBreathF5)
    		{
    			magic = new MagicEntityMeragaiaB[32];
    			for(int cnt = 0;cnt < 32; cnt++)
    			{
    				magic[cnt] = new MagicEntityMeragaiaB(par2World, par3EntityPlayer, 1.5F, 1.0F, 0.0F, 0.0F, 0.0F, (float)(-157.5F + (11.25F * cnt)), 0.0F);
