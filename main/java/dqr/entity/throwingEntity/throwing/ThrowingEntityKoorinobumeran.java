 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityKoorinobumeran extends ThrowingEntity implements IProjectile{


    public ThrowingEntityKoorinobumeran(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityKoorinobumeran(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
