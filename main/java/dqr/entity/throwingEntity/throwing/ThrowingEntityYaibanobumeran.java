 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityYaibanobumeran extends ThrowingEntity implements IProjectile{


    public ThrowingEntityYaibanobumeran(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityYaibanobumeran(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
