 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityMeteoejji extends ThrowingEntity implements IProjectile{


    public ThrowingEntityMeteoejji(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityMeteoejji(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
