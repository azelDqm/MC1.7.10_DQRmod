 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityHaipanova2 extends ThrowingEntity implements IProjectile{


    public ThrowingEntityHaipanova2(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityHaipanova2(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
