 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityBumeran extends ThrowingEntity implements IProjectile{
    ...
    /*
    double[] posSet = new double[4];
    float[] rotateSet = new float[2];
	*/
    public ThrowingEntityBumeran(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityBumeran(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
