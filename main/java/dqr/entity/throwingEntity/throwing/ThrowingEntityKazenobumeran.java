 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityKazenobumeran extends ThrowingEntity implements IProjectile{


    public ThrowingEntityKazenobumeran(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityKazenobumeran(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
