 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityKurosubumeran extends ThrowingEntity implements IProjectile{


    public ThrowingEntityKurosubumeran(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityKurosubumeran(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
