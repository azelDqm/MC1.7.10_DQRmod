 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityHonoonobumeran extends ThrowingEntity implements IProjectile{


    public ThrowingEntityHonoonobumeran(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityHonoonobumeran(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
