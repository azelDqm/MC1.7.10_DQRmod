 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowingEntityKuresentoejji extends ThrowingEntity implements IProjectile{


    public ThrowingEntityKuresentoejji(World par1World)
    {
        super(par1World);
    ...
    public ThrowingEntityKuresentoejji(World par1World, Entity par2EntityLivingBase, float speed, float speed2,
