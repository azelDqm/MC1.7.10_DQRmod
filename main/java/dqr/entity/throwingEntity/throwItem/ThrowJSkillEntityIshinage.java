 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowJSkillEntityIshinage extends MagicEntity implements IProjectile{
    ...
    public ThrowJSkillEntityIshinage(World par1World)
    {
        super(par1World);
    ...
    public ThrowJSkillEntityIshinage(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
            		...
            		if (target != null && target.entityHit != null)
            		{
                        ...
                        else
                        {
                    		...
                    		if(pe != null && this.shootingEntity != null && this.shootingEntity instanceof EntityLivingBase)
                    		{
                                ...
                                {
                            		if(elv instanceof EntityLiving && this.shootingEntity instanceof EntityLivingBase)
                            		{
                            			EntityLiving el = (EntityLiving)elv;
                            			el.setAttackTarget((EntityLivingBase)this.shootingEntity);
                            			if(el instanceof EntityCreature)
                            			{
                            				((EntityCreature)el).setAttackTarget((EntityLivingBase)this.shootingEntity);
                            			}
                            		}
                                    ...
                                    //ここでヒット時の効果音がなる
                                    this.playSound("dqr:mob.hit2", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                    		...
                    		}else
                    		{
	                            ...
	                            {
	                        		if(target.entityHit instanceof EntityLiving && this.shootingEntity instanceof EntityLivingBase)
                            		{
                            			EntityLiving el = (EntityLiving)target.entityHit;
                            			el.setAttackTarget((EntityLivingBase)this.shootingEntity);
                            			if(el instanceof EntityCreature)
                            			{
                            				((EntityCreature)el).setAttackTarget((EntityLivingBase)this.shootingEntity);
