 ...
 * 発射されるエンティティのクラス。
 * */
public class ThrowItemEntityIshitubute extends MagicEntity implements IProjectile{
    ...
    public ThrowItemEntityIshitubute(World par1World)
    {
        super(par1World);
    ...
    public ThrowItemEntityIshitubute(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
