...
public class DqmEntitySabotenboru extends DqmMobBaseDay
{

	public DqmEntitySabotenboru(World world)
	{
		super(world, EnumDqmMonster.SABOTENBORU );

		//this.monsterType = EnumDqmMonster.SABOTENBORU;
	...
	{
		return EnumDqmMonster.SABOTENBORU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SABOTENBORU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SABOTENBORU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SABOTENBORU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SABOTENBORU.getDF();
    }
