...
public class DqmEntityObakeumiusi extends DqmMobBaseDay
{

	public DqmEntityObakeumiusi(World world)
	{
		super(world, EnumDqmMonster.OBAKEUMIUSI );

		//this.monsterType = EnumDqmMonster.OBAKEUMIUSI;
	...
	{
		return EnumDqmMonster.OBAKEUMIUSI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.OBAKEUMIUSI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.OBAKEUMIUSI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.OBAKEUMIUSI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.OBAKEUMIUSI.getDF();
    }
