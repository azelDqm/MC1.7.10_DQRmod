...
public class DqmEntityKirikabuobake extends DqmMobBaseDay
{

	public DqmEntityKirikabuobake(World world)
	{
		super(world, EnumDqmMonster.KIRIKABUOBAKE );

		//this.monsterType = EnumDqmMonster.KIRIKABUOBAKE;
	...
	{
		return EnumDqmMonster.KIRIKABUOBAKE.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRIKABUOBAKE.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRIKABUOBAKE.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRIKABUOBAKE.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRIKABUOBAKE.getDF();
    }
