...
public class DqmEntitySuraimunaito extends DqmMobBaseDay
{

	public DqmEntitySuraimunaito(World world)
	{
		super(world, EnumDqmMonster.SURAIMUNAITO );

		//this.monsterType = EnumDqmMonster.SURAIMUNAITO;
	...
	{
		return EnumDqmMonster.SURAIMUNAITO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUNAITO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUNAITO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUNAITO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUNAITO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemMidorinokoke, 1);
        }
        if (DQR.funcMob.getCalcDROP(200, 1))
        {
            this.dropItem(DQArmors.itemUrokonoyoroi, 1);
        }
        if (DQR.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQMiscs.itemSuraimuosyarebana, 1);
        }
        if (DQR.funcMob.getCalcDROP(100, 1))
        {
            this.dropItem(DQAccessories.itemSuraimutorei, 1);
        }
        ...
        if (DQR.funcMob.getCalcDROP(60, 1))
        {
