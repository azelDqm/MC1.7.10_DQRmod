...
public class DqmEntityZukkinya extends DqmMobBaseDay
{

	public DqmEntityZukkinya(World world)
	{
		super(world, EnumDqmMonster.ZUKKINYA );

		//this.monsterType = EnumDqmMonster.ZUKKINYA;
	...
	{
		return EnumDqmMonster.ZUKKINYA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ZUKKINYA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ZUKKINYA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ZUKKINYA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ZUKKINYA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQSeeds.itemDokukesisou, 1);
        }
