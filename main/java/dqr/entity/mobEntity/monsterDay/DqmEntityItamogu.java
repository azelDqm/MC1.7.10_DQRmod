...
public class DqmEntityItamogu extends DqmMobBaseDay
{

	public DqmEntityItamogu(World world)
	{
		super(world, EnumDqmMonster.ITAMOGU );

		//this.monsterType = EnumDqmMonster.ITAMOGU;
	...
	{
		return EnumDqmMonster.ITAMOGU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ITAMOGU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ITAMOGU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ITAMOGU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ITAMOGU.getDF();
    }
