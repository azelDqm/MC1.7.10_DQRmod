...
public class DqmEntityZinmentyou extends DqmMobBaseDay
{

	public DqmEntityZinmentyou(World world)
	{
		super(world, EnumDqmMonster.ZINMENTYOU );

		//this.monsterType = EnumDqmMonster.ZINMENTYOU;
	...
	{
		return EnumDqmMonster.ZINMENTYOU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ZINMENTYOU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ZINMENTYOU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ZINMENTYOU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ZINMENTYOU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemTyounohane, 1);
        }
