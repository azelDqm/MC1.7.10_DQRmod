...
public class DqmEntityHitokuisaberu extends DqmMobBaseDay
{

	public DqmEntityHitokuisaberu(World world)
	{
		super(world, EnumDqmMonster.HITOKUISABERU );

		//this.monsterType = EnumDqmMonster.HITOKUISABERU;
	...
	{
		return EnumDqmMonster.HITOKUISABERU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HITOKUISABERU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HITOKUISABERU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HITOKUISABERU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HITOKUISABERU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemTukemonoisi, 1);
        }
