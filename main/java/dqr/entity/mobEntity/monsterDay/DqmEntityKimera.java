...
public class DqmEntityKimera extends DqmMobBaseDay
{

	public DqmEntityKimera(World world)
	{
		super(world, EnumDqmMonster.KIMERA );

		//this.monsterType = EnumDqmMonster.KIMERA;
	...
	{
		return EnumDqmMonster.KIMERA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIMERA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIMERA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIMERA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIMERA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemKazekirinohane, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
            this.dropItem(DQMiscs.itemKimeranotubasa, 1);
        }
        if (DQR.funcMob.getCalcDROP(12, 1))
        {
            this.dropItem(DQMiscs.itemHaganenoobane, 1);
        }
