...
public class DqmEntityDorozara extends DqmMobBaseDay
{

	public DqmEntityDorozara(World world)
	{
		super(world, EnumDqmMonster.DOROZARA );

		//this.monsterType = EnumDqmMonster.DOROZARA;
	...
	{
		return EnumDqmMonster.DOROZARA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DOROZARA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DOROZARA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DOROZARA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DOROZARA.getDF();
    }
