...
public class DqmEntityMadohando extends DqmMobBaseDay
{

	public DqmEntityMadohando(World world)
	{
		super(world, EnumDqmMonster.MADOHANDO );

		//this.monsterType = EnumDqmMonster.MADOHANDO;
	...
	{
		return EnumDqmMonster.MADOHANDO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MADOHANDO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MADOHANDO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MADOHANDO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MADOHANDO.getDF();
    }
