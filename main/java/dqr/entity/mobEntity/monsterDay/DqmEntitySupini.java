...
public class DqmEntitySupini extends DqmMobBaseDay
{

	public DqmEntitySupini(World world)
	{
		super(world, EnumDqmMonster.SUPINI );

		//this.monsterType = EnumDqmMonster.SUPINI;
	...
	{
		return EnumDqmMonster.SUPINI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SUPINI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SUPINI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SUPINI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SUPINI.getDF();
    }
