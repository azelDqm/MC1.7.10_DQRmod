...
public class DqmEntityBigCrow extends DqmMobBaseDay
{

	public DqmEntityBigCrow(World world)
	{
		super(world, EnumDqmMonster.BIGCROW );

		//this.monsterType = EnumDqmMonster.BIGCROW;
	...
	{
		return EnumDqmMonster.BIGCROW.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BIGCROW.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BIGCROW.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BIGCROW.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BIGCROW.getDF();
    }
