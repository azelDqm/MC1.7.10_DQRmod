...
public class DqmEntityObakekinoko extends DqmMobBaseDay
{

	public DqmEntityObakekinoko(World world)
	{
		super(world, EnumDqmMonster.OBAKEKINOKO );

		//this.monsterType = EnumDqmMonster.OBAKEKINOKO;
	...
	{
		return EnumDqmMonster.OBAKEKINOKO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.OBAKEKINOKO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.OBAKEKINOKO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.OBAKEKINOKO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.OBAKEKINOKO.getDF();
    }
