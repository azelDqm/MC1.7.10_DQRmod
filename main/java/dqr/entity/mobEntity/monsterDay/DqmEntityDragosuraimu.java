...
public class DqmEntityDragosuraimu extends DqmMobBaseDay
{

	public DqmEntityDragosuraimu(World world)
	{
		super(world, EnumDqmMonster.DRAGOSURAIMU );

		//this.monsterType = EnumDqmMonster.DRAGOSURAIMU;
	...
	{
		return EnumDqmMonster.DRAGOSURAIMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DRAGOSURAIMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DRAGOSURAIMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DRAGOSURAIMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DRAGOSURAIMU.getDF();
    }
