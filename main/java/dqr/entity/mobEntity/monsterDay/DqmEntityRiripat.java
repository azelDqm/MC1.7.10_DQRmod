...
public class DqmEntityRiripat extends DqmMobBaseDay
{

	public DqmEntityRiripat(World world)
	{
		super(world, EnumDqmMonster.RIRIPAT );

		//this.monsterType = EnumDqmMonster.RIRIPAT;
	...
	{
		return EnumDqmMonster.RIRIPAT.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.RIRIPAT.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.RIRIPAT.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.RIRIPAT.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.RIRIPAT.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemYuuwakunoyumi, 1);
        }
