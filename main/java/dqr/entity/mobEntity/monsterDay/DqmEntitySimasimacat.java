...
public class DqmEntitySimasimacat extends DqmMobBaseDay
{

	public DqmEntitySimasimacat(World world)
	{
		super(world, EnumDqmMonster.SIMASIMACAT );

		//this.monsterType = EnumDqmMonster.SIMASIMACAT;
	...
	{
		return EnumDqmMonster.SIMASIMACAT.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIMASIMACAT.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIMASIMACAT.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIMASIMACAT.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIMASIMACAT.getDF();
    }
