...
public class DqmEntityBubsura extends DqmMobBaseDay
{

	public DqmEntityBubsura(World world)
	{
		super(world, EnumDqmMonster.BUBSURA );

		//this.monsterType = EnumDqmMonster.BUBSURA;
	...
	{
		return EnumDqmMonster.BUBSURA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BUBSURA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BUBSURA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BUBSURA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BUBSURA.getDF();
    }
