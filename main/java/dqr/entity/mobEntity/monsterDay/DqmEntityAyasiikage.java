...
public class DqmEntityAyasiikage extends DqmMobBaseDay
{

	public DqmEntityAyasiikage(World world)
	{
		super(world, EnumDqmMonster.AYASIIKAGE );

		//this.monsterType = EnumDqmMonster.AYASIIKAGE;
	...
	{
		return EnumDqmMonster.AYASIIKAGE.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.AYASIIKAGE.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.AYASIIKAGE.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.AYASIIKAGE.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.AYASIIKAGE.getDF();
    }
