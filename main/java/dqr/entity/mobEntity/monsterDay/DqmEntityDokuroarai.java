...
public class DqmEntityDokuroarai extends DqmMobBaseDay
{

	public DqmEntityDokuroarai(World world)
	{
		super(world, EnumDqmMonster.DOKUROARAI );

		//this.monsterType = EnumDqmMonster.DOKUROARAI;
	...
	{
		return EnumDqmMonster.DOKUROARAI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DOKUROARAI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DOKUROARAI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DOKUROARAI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DOKUROARAI.getDF();
    }
