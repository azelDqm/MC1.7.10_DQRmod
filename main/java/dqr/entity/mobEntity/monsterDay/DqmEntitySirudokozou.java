...
public class DqmEntitySirudokozou extends DqmMobBaseDay
{

	public DqmEntitySirudokozou(World world)
	{
		super(world, EnumDqmMonster.SIRUDOKOZOU );

		//this.monsterType = EnumDqmMonster.SIRUDOKOZOU;
	...
	{
		return EnumDqmMonster.SIRUDOKOZOU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIRUDOKOZOU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIRUDOKOZOU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIRUDOKOZOU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIRUDOKOZOU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQAccessories.itemUrokonotate, 1);
        }
