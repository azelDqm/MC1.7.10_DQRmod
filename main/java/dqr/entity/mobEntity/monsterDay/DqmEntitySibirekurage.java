...
public class DqmEntitySibirekurage extends DqmMobBaseDay
{

	public DqmEntitySibirekurage(World world)
	{
		super(world, EnumDqmMonster.SIBIREKURAGE );

		//this.monsterType = EnumDqmMonster.SIBIREKURAGE;
	...
	{
		return EnumDqmMonster.SIBIREKURAGE.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIBIREKURAGE.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIBIREKURAGE.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIBIREKURAGE.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIBIREKURAGE.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemUruwasikinoko, 1);
        }
