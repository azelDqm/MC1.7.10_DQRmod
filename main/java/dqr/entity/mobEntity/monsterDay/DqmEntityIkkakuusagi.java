...
public class DqmEntityIkkakuusagi extends DqmMobBaseDay
{

	public DqmEntityIkkakuusagi(World world)
	{
		super(world, EnumDqmMonster.IKKAKUUSAGI );

		//this.monsterType = EnumDqmMonster.IKKAKUUSAGI;
	...
	{
		return EnumDqmMonster.IKKAKUUSAGI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.IKKAKUUSAGI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.IKKAKUUSAGI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.IKKAKUUSAGI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.IKKAKUUSAGI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemYawarakauru, 1);
        }
