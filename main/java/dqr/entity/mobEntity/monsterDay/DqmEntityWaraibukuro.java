...
public class DqmEntityWaraibukuro extends DqmMobBaseDay
{

	public DqmEntityWaraibukuro(World world)
	{
		super(world, EnumDqmMonster.WARAIBUKURO );

		//this.monsterType = EnumDqmMonster.WARAIBUKURO;
	...
	{
		return EnumDqmMonster.WARAIBUKURO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.WARAIBUKURO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.WARAIBUKURO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.WARAIBUKURO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.WARAIBUKURO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemMadarakumonoito, 1);
        }
        if (DQR.funcMob.getCalcDROP(14, 1))
        {
