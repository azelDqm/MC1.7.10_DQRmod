...
public class DqmEntityMomon extends DqmMobBaseDay
{

	public DqmEntityMomon(World world)
	{
		super(world, EnumDqmMonster.MOMON );

		//this.monsterType = EnumDqmMonster.MOMON;
	...
	{
		return EnumDqmMonster.MOMON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MOMON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MOMON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MOMON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MOMON.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(new ItemStack(Blocks.wool, 1, 0).getItem(), 1);
        }
