...
public class DqmEntityPurizunyan extends DqmMobBaseDay
{

	public DqmEntityPurizunyan(World world)
	{
		super(world, EnumDqmMonster.PURIZUNYAN );

		//this.monsterType = EnumDqmMonster.PURIZUNYAN;
	...
	{
		return EnumDqmMonster.PURIZUNYAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PURIZUNYAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PURIZUNYAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PURIZUNYAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PURIZUNYAN.getDF();
    }
