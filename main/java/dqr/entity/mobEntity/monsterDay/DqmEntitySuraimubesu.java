...
public class DqmEntitySuraimubesu extends DqmMobBaseDay
{

	public DqmEntitySuraimubesu(World world)
	{
		super(world, EnumDqmMonster.SURAIMUBESU );

		//this.monsterType = EnumDqmMonster.SURAIMUBESU;
	...
	{
		return EnumDqmMonster.SURAIMUBESU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUBESU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUBESU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUBESU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUBESU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemSuraimuzeri, 1);
        }
        if (DQR.funcMob.getCalcDROP(300, 1))
        {
            this.dropItem(DQArmors.itemSuraimuhead, 1);
        }
