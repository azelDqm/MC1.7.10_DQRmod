...
public class DqmEntityDoruido extends DqmMobBaseDay
{

	public DqmEntityDoruido(World world)
	{
		super(world, EnumDqmMonster.DORUIDO );

		//this.monsterType = EnumDqmMonster.DORUIDO;
	...
	{
		return EnumDqmMonster.DORUIDO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DORUIDO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DORUIDO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DORUIDO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DORUIDO.getDF();
    }
