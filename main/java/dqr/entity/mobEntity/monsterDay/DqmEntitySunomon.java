...
public class DqmEntitySunomon extends DqmMobBaseDay
{

	public DqmEntitySunomon(World world)
	{
		super(world, EnumDqmMonster.SUNOMON );

		//this.monsterType = EnumDqmMonster.SUNOMON;
	...
	{
		return EnumDqmMonster.SUNOMON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SUNOMON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SUNOMON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SUNOMON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SUNOMON.getDF();
    }
