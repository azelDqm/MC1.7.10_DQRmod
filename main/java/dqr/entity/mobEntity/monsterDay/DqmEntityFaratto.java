...
public class DqmEntityFaratto extends DqmMobBaseDay
{

	public DqmEntityFaratto(World world)
	{
		super(world, EnumDqmMonster.FARATTO );

		//this.monsterType = EnumDqmMonster.FARATTO;
	...
	{
		return EnumDqmMonster.FARATTO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.FARATTO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.FARATTO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.FARATTO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.FARATTO.getDF();
    }
