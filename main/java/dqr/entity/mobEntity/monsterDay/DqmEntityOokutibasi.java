...
public class DqmEntityOokutibasi extends DqmMobBaseDay
{

	public DqmEntityOokutibasi(World world)
	{
		super(world, EnumDqmMonster.OOKUTIBASI );

		//this.monsterType = EnumDqmMonster.OOKUTIBASI;
	...
	{
		return EnumDqmMonster.OOKUTIBASI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.OOKUTIBASI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.OOKUTIBASI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.OOKUTIBASI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.OOKUTIBASI.getDF();
    }
