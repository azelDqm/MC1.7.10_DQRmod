...
public class DqmEntityGizumoAZ extends DqmMobBaseDay
{

	public DqmEntityGizumoAZ(World world)
	{
		super(world, EnumDqmMonster.GIZUMOAZ );

		//this.monsterType = EnumDqmMonster.GIZUMOAZ;
	...
	{
		return EnumDqmMonster.GIZUMOAZ.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GIZUMOAZ.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GIZUMOAZ.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GIZUMOAZ.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GIZUMOAZ.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemAyakasisou, 1);
        }
