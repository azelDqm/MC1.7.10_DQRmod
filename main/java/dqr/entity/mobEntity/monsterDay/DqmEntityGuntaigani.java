...
public class DqmEntityGuntaigani extends DqmMobBaseDay
{

	public DqmEntityGuntaigani(World world)
	{
		super(world, EnumDqmMonster.GUNTAIGANI );

		//this.monsterType = EnumDqmMonster.GUNTAIGANI;
	...
	{
		return EnumDqmMonster.GUNTAIGANI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GUNTAIGANI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GUNTAIGANI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GUNTAIGANI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GUNTAIGANI.getDF();
    }
