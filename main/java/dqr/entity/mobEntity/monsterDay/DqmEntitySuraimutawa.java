...
public class DqmEntitySuraimutawa extends DqmMobBaseDay
{

	public DqmEntitySuraimutawa(World world)
	{
		super(world, EnumDqmMonster.SURAIMUTAWA );

		//this.monsterType = EnumDqmMonster.SURAIMUTAWA;
	...
	{
		return EnumDqmMonster.SURAIMUTAWA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUTAWA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUTAWA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUTAWA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUTAWA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQArmors.itemSuraimunofuku, 1);
        }
