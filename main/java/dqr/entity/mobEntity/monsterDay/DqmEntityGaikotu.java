...
public class DqmEntityGaikotu extends DqmMobBaseDay
{

	public DqmEntityGaikotu(World world)
	{
		super(world, EnumDqmMonster.GAIKOTU );

		//this.monsterType = EnumDqmMonster.GAIKOTU;
	...
	{
		return EnumDqmMonster.GAIKOTU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GAIKOTU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GAIKOTU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GAIKOTU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GAIKOTU.getDF();
    }
