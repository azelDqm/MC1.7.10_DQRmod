...
public class DqmEntityButisuraimu extends DqmMobBaseDay
{

	public DqmEntityButisuraimu(World world)
	{
		super(world, EnumDqmMonster.BUTISURAIMU );

		//this.monsterType = EnumDqmMonster.BUTISURAIMU;
	...
	{
		return EnumDqmMonster.BUTISURAIMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BUTISURAIMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BUTISURAIMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BUTISURAIMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BUTISURAIMU.getDF();
    }
