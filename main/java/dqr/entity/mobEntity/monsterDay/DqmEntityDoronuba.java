...
public class DqmEntityDoronuba extends DqmMobBaseDay
{

	public DqmEntityDoronuba(World world)
	{
		super(world, EnumDqmMonster.DORONUBA );

		//this.monsterType = EnumDqmMonster.DORONUBA;
	...
	{
		return EnumDqmMonster.DORONUBA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DORONUBA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DORONUBA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DORONUBA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DORONUBA.getDF();
    }
