...
public class DqmEntitySukippaa extends DqmMobBaseDay
{

	public DqmEntitySukippaa(World world)
	{
		super(world, EnumDqmMonster.SUKIPPAA );

		//this.monsterType = EnumDqmMonster.SUKIPPAA;
	...
	{
		return EnumDqmMonster.SUKIPPAA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SUKIPPAA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SUKIPPAA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SUKIPPAA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SUKIPPAA.getDF();
    }
