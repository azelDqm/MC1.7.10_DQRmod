...
public class DqmEntityOonamekuji extends DqmMobBaseDay
{

	public DqmEntityOonamekuji(World world)
	{
		super(world, EnumDqmMonster.OONAMEKUJI );

		//this.monsterType = EnumDqmMonster.OONAMEKUJI;
	...
	{
		return EnumDqmMonster.OONAMEKUJI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.OONAMEKUJI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.OONAMEKUJI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.OONAMEKUJI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.OONAMEKUJI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemUmanofun, 1);
        }
