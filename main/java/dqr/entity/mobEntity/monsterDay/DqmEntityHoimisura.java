...
public class DqmEntityHoimisura extends DqmMobBaseDay
{

	public DqmEntityHoimisura(World world)
	{
		super(world, EnumDqmMonster.HOIMISURA );

		//this.monsterType = EnumDqmMonster.HOIMISURA;
	...
	{
		return EnumDqmMonster.HOIMISURA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HOIMISURA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HOIMISURA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HOIMISURA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HOIMISURA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQSeeds.itemBannouyaku, 1);
        }
