...
public class DqmEntityOokiduti extends DqmMobBaseDay
{

	public DqmEntityOokiduti(World world)
	{
		super(world, EnumDqmMonster.OOKIDUTI );

		//this.monsterType = EnumDqmMonster.OOKIDUTI;
	...
	{
		return EnumDqmMonster.OOKIDUTI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.OOKIDUTI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.OOKIDUTI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.OOKIDUTI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.OOKIDUTI.getDF();
    }
