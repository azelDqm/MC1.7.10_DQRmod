...
public class DqmEntityOomedama extends DqmMobBaseDay
{

	public DqmEntityOomedama(World world)
	{
		super(world, EnumDqmMonster.OOMEDAMA );

		//this.monsterType = EnumDqmMonster.OOMEDAMA;
	...
	{
		return EnumDqmMonster.OOMEDAMA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.OOMEDAMA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.OOMEDAMA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.OOMEDAMA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.OOMEDAMA.getDF();
    }
