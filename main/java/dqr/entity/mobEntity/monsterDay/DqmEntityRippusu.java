...
public class DqmEntityRippusu extends DqmMobBaseDay
{

	public DqmEntityRippusu(World world)
	{
		super(world, EnumDqmMonster.RIPPUSU );

		//this.monsterType = EnumDqmMonster.RIPPUSU;
	...
	{
		return EnumDqmMonster.RIPPUSU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.RIPPUSU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.RIPPUSU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.RIPPUSU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.RIPPUSU.getDF();
    }
