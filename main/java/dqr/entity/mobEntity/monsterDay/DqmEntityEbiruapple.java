...
public class DqmEntityEbiruapple extends DqmMobBaseDay
{

	public DqmEntityEbiruapple(World world)
	{
		super(world, EnumDqmMonster.EBIRUAPPLE );

		//this.monsterType = EnumDqmMonster.EBIRUAPPLE;
	...
	{
		return EnumDqmMonster.EBIRUAPPLE.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.EBIRUAPPLE.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.EBIRUAPPLE.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.EBIRUAPPLE.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.EBIRUAPPLE.getDF();
    }
