...
public class DqmEntityTukaima extends DqmMobBaseDay
{

	public DqmEntityTukaima(World world)
	{
		super(world, EnumDqmMonster.TUKAIMA );

		//this.monsterType = EnumDqmMonster.TUKAIMA;
	...
	{
		return EnumDqmMonster.TUKAIMA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TUKAIMA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TUKAIMA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TUKAIMA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TUKAIMA.getDF();
    }
