...
public class DqmEntityPapetkozou extends DqmMobBaseDay
{

	public DqmEntityPapetkozou(World world)
	{
		super(world, EnumDqmMonster.PAPETKOZOU );

		//this.monsterType = EnumDqmMonster.PAPETKOZOU;
	...
	{
		return EnumDqmMonster.PAPETKOZOU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PAPETKOZOU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PAPETKOZOU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PAPETKOZOU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PAPETKOZOU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemNekozuna, 1);
        }
