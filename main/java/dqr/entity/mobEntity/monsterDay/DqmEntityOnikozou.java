...
public class DqmEntityOnikozou extends DqmMobBaseDay
{

	public DqmEntityOnikozou(World world)
	{
		super(world, EnumDqmMonster.ONIKOZOU );

		//this.monsterType = EnumDqmMonster.ONIKOZOU;
	...
	{
		return EnumDqmMonster.ONIKOZOU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ONIKOZOU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ONIKOZOU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ONIKOZOU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ONIKOZOU.getDF();
    }
