...
public class DqmEntityHitokuikibako extends DqmMobBaseDay
{

	public DqmEntityHitokuikibako(World world)
	{
		super(world, EnumDqmMonster.HITOKUIKIBAKO );

		//this.monsterType = EnumDqmMonster.HITOKUIKIBAKO;
	...
	{
		return EnumDqmMonster.HITOKUIKIBAKO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HITOKUIKIBAKO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HITOKUIKIBAKO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HITOKUIKIBAKO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HITOKUIKIBAKO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemDokubari, 1);
        }
        if (DQR.funcMob.getCalcDROP(15, 1))
        {
            this.dropItem(DQIngots.itemTokinosuisyou, 1);
        }
        ...
        {
            this.dropItem(DQSeeds.itemYakusou, 1);
        }
