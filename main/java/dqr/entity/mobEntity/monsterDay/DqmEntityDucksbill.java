...
public class DqmEntityDucksbill extends DqmMobBaseDay
{

	public DqmEntityDucksbill(World world)
	{
		super(world, EnumDqmMonster.DUCKSBILL );

		//this.monsterType = EnumDqmMonster.DUCKSBILL;
	...
	{
		return EnumDqmMonster.DUCKSBILL.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DUCKSBILL.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DUCKSBILL.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DUCKSBILL.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DUCKSBILL.getDF();
    }
