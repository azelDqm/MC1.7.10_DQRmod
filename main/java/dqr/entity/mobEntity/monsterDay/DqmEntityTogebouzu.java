...
public class DqmEntityTogebouzu extends DqmMobBaseDay
{

	public DqmEntityTogebouzu(World world)
	{
		super(world, EnumDqmMonster.TOGEBOUZU );

		//this.monsterType = EnumDqmMonster.TOGEBOUZU;
	...
	{
		return EnumDqmMonster.TOGEBOUZU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TOGEBOUZU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TOGEBOUZU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TOGEBOUZU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TOGEBOUZU.getDF();
    }
