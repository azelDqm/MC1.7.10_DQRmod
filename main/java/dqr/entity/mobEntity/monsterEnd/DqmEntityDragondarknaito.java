...
public class DqmEntityDragondarknaito extends DqmMobBaseEnd
{

	public DqmEntityDragondarknaito(World world)
	{
		super(world, EnumDqmMonster.DRAGONDARKNAITO );

		//this.monsterType = EnumDqmMonster.DRAGONDARKNAITO;
	...
	{
		return EnumDqmMonster.DRAGONDARKNAITO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DRAGONDARKNAITO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DRAGONDARKNAITO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DRAGONDARKNAITO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DRAGONDARKNAITO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemHaounoono, 1);
        }
