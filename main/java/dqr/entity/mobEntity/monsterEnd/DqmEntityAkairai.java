...
public class DqmEntityAkairai extends DqmMobBaseEnd
{

	public DqmEntityAkairai(World world)
	{
		super(world, EnumDqmMonster.AKAIRAI );

		//this.monsterType = EnumDqmMonster.AKAIRAI;
	...
	{
		return EnumDqmMonster.AKAIRAI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.AKAIRAI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.AKAIRAI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.AKAIRAI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.AKAIRAI.getDF();
    }
