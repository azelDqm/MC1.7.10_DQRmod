...
public class DqmEntityShadopan2 extends DqmMobBaseEnd
{

	public DqmEntityShadopan2(World world)
	{
		super(world, EnumDqmMonster.SHADOPAN2 );

		//this.monsterType = EnumDqmMonster.KIRAPAN2;
	...
	{
		return EnumDqmMonster.SHADOPAN2.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SHADOPAN2.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SHADOPAN2.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SHADOPAN2.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SHADOPAN2.getDF();
    }
