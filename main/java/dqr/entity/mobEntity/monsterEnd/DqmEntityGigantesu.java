...
public class DqmEntityGigantesu extends DqmMobBaseEnd
{

	public DqmEntityGigantesu(World world)
	{
		super(world, EnumDqmMonster.GIGANTESU );

		//this.monsterType = EnumDqmMonster.GIGANTESU;
	...
	{
		return EnumDqmMonster.GIGANTESU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GIGANTESU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GIGANTESU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GIGANTESU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GIGANTESU.getDF();
    }
