...
public class DqmEntityManemane extends DqmMobBaseEnd
{

	public DqmEntityManemane(World world)
	{
		super(world, EnumDqmMonster.MANEMANE );

		//this.monsterType = EnumDqmMonster.MANEMANE;
	...
	{
		return EnumDqmMonster.MANEMANE.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MANEMANE.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MANEMANE.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MANEMANE.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MANEMANE.getDF();
    }
