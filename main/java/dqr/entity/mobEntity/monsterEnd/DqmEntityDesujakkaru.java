...
public class DqmEntityDesujakkaru extends DqmMobBaseEnd
{

	public DqmEntityDesujakkaru(World world)
	{
		super(world, EnumDqmMonster.DESUJAKKARU );

		//this.monsterType = EnumDqmMonster.DESUJAKKARU;
	...
	{
		return EnumDqmMonster.DESUJAKKARU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DESUJAKKARU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DESUJAKKARU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DESUJAKKARU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DESUJAKKARU.getDF();
    }
