...
public class DqmEntityJigokunoyoroi extends DqmMobBaseEnd
{

	public DqmEntityJigokunoyoroi(World world)
	{
		super(world, EnumDqmMonster.JIGOKUNOYOROI );

		//this.monsterType = EnumDqmMonster.JIGOKUNOYOROI;
	...
	{
		return EnumDqmMonster.JIGOKUNOYOROI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.JIGOKUNOYOROI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.JIGOKUNOYOROI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.JIGOKUNOYOROI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.JIGOKUNOYOROI.getDF();
    }
