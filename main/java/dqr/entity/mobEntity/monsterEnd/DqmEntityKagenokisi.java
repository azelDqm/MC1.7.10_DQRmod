...
public class DqmEntityKagenokisi extends DqmMobBaseEnd
{

	public DqmEntityKagenokisi(World world)
	{
		super(world, EnumDqmMonster.KAGENOKISI );

		//this.monsterType = EnumDqmMonster.KAGENOKISI;
	...
	{
		return EnumDqmMonster.KAGENOKISI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KAGENOKISI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KAGENOKISI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KAGENOKISI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KAGENOKISI.getDF();
    }
