...
public class DqmEntityDakunaito extends DqmMobBaseEnd
{

	public DqmEntityDakunaito(World world)
	{
		super(world, EnumDqmMonster.DAKUNAITO );

		//this.monsterType = EnumDqmMonster.DAKUNAITO;
	...
	{
		return EnumDqmMonster.DAKUNAITO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DAKUNAITO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DAKUNAITO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DAKUNAITO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DAKUNAITO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQIngots.itemOriharukon, 1);
        }
