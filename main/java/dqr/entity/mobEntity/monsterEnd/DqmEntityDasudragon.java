...
public class DqmEntityDasudragon extends DqmMobBaseEnd
{

	public DqmEntityDasudragon(World world)
	{
		super(world, EnumDqmMonster.DASUDRAGON );

		//this.monsterType = EnumDqmMonster.DASUDRAGON;
	...
	{
		return EnumDqmMonster.DASUDRAGON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DASUDRAGON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DASUDRAGON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DASUDRAGON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DASUDRAGON.getDF();
    }
