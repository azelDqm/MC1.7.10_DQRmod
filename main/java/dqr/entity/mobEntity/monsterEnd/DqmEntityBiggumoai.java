...
public class DqmEntityBiggumoai extends DqmMobBaseEnd
{

	public DqmEntityBiggumoai(World world)
	{
		super(world, EnumDqmMonster.BIGGUMOAI );

		//this.monsterType = EnumDqmMonster.BIGGUMOAI;
	...
	{
		return EnumDqmMonster.BIGGUMOAI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BIGGUMOAI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BIGGUMOAI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BIGGUMOAI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BIGGUMOAI.getDF();
    }
