...
public class DqmEntityDakuhobitto extends DqmMobBaseEnd
{

	public DqmEntityDakuhobitto(World world)
	{
		super(world, EnumDqmMonster.DAKUHOBITTO );

		//this.monsterType = EnumDqmMonster.DAKUHOBITTO;
	...
	{
		return EnumDqmMonster.DAKUHOBITTO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DAKUHOBITTO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DAKUHOBITTO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DAKUHOBITTO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DAKUHOBITTO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQAccessories.itemOogasirudo, 1);
        }
