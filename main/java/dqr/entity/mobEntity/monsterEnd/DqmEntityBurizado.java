...
public class DqmEntityBurizado extends DqmMobBaseEnd
{

	public DqmEntityBurizado(World world)
	{
		super(world, EnumDqmMonster.BURIZADO );

		//this.monsterType = EnumDqmMonster.BURIZADO;
	...
	{
		return EnumDqmMonster.BURIZADO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BURIZADO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BURIZADO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BURIZADO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BURIZADO.getDF();
    }
