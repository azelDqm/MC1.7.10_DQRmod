...
public class DqmEntityGodraida extends DqmMobBaseEnd
{

	public DqmEntityGodraida(World world)
	{
		super(world, EnumDqmMonster.GODRAIDA );

		//this.monsterType = EnumDqmMonster.GODRAIDA;
	...
	{
		return EnumDqmMonster.GODRAIDA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GODRAIDA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GODRAIDA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GODRAIDA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GODRAIDA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemHaganenoturugi, 1);
        }
        if (DQR.funcMob.getCalcDROP(70, 1))
        {
            this.dropItem(DQWeapons.itemMorohanoturugi, 1);
        }
        if (DQR.funcMob.getCalcDROP(500, 1))
        {
            this.dropItem(DQWeapons.itemHayabusanoturugi, 1);
        }
        if (DQR.funcMob.getCalcDROP(25, 1))
        {
            this.dropItem(DQWeapons.itemHaganenoturugi, 1);
        }
