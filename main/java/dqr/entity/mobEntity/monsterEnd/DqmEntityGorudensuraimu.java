...
public class DqmEntityGorudensuraimu extends DqmMobBaseEnd
{

	public DqmEntityGorudensuraimu(World world)
	{
		super(world, EnumDqmMonster.GORUDENSURAIMU );

		//this.monsterType = EnumDqmMonster.GORUDENSURAIMU;
	...
	{
		return EnumDqmMonster.GORUDENSURAIMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GORUDENSURAIMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GORUDENSURAIMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GORUDENSURAIMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GORUDENSURAIMU.getDF();
    }
