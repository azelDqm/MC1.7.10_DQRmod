...
public class DqmEntityPandorabox extends DqmMobBaseEnd
{

	public DqmEntityPandorabox(World world)
	{
		super(world, EnumDqmMonster.PANDORABOX );

		//this.monsterType = EnumDqmMonster.PANDORABOX;
	...
	{
		return EnumDqmMonster.PANDORABOX.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PANDORABOX.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PANDORABOX.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PANDORABOX.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PANDORABOX.getDF();
    }
