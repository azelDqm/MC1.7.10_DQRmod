...
public class DqmEntityBatorurex extends DqmMobBaseEnd
{

	public DqmEntityBatorurex(World world)
	{
		super(world, EnumDqmMonster.BATORUREX );

		//this.monsterType = EnumDqmMonster.BATORUREX;
	...
	{
		return EnumDqmMonster.BATORUREX.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BATORUREX.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BATORUREX.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BATORUREX.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BATORUREX.getDF();
    }
