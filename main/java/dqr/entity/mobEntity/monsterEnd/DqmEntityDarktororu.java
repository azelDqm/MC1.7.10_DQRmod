...
public class DqmEntityDarktororu extends DqmMobBaseEnd
{

	public DqmEntityDarktororu(World world)
	{
		super(world, EnumDqmMonster.DARKTORORU );

		//this.monsterType = EnumDqmMonster.DARKTORORU;
	...
	{
		return EnumDqmMonster.DARKTORORU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DARKTORORU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DARKTORORU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DARKTORORU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DARKTORORU.getDF();
    }
