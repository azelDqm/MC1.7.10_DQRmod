...
public class DqmEntityDesusutoka extends DqmMobBaseEnd
{

	public DqmEntityDesusutoka(World world)
	{
		super(world, EnumDqmMonster.DESUSUTOKA );

		//this.monsterType = EnumDqmMonster.DENGA;
	...
	{
		return EnumDqmMonster.DESUSUTOKA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DESUSUTOKA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DESUSUTOKA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DESUSUTOKA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DESUSUTOKA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemHeisinoken, 1);
        }
        if (DQR.funcMob.getCalcDROP(80, 1))
        {
            this.dropItem(DQWeapons.itemMinagorosinoken, 1);
        }
        if (DQR.funcMob.getCalcDROP(500, 1))
        {
