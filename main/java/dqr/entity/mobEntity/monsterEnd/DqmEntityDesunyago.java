...
public class DqmEntityDesunyago extends DqmMobBaseEnd
{

	public DqmEntityDesunyago(World world)
	{
		super(world, EnumDqmMonster.DESUNYAGO );

		//this.monsterType = EnumDqmMonster.DESUNYAGO;
	...
	{
		return EnumDqmMonster.DESUNYAGO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DESUNYAGO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DESUNYAGO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DESUNYAGO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DESUNYAGO.getDF();
    }
