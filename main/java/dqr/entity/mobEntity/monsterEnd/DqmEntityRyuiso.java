...
public class DqmEntityRyuiso extends DqmMobBaseEnd
{

	public DqmEntityRyuiso(World world)
	{
		super(world, EnumDqmMonster.RYUISO );

		//this.monsterType = EnumDqmMonster.RYUISO;
	...
	{
		return EnumDqmMonster.RYUISO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.RYUISO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.RYUISO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.RYUISO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.RYUISO.getDF();
    }
