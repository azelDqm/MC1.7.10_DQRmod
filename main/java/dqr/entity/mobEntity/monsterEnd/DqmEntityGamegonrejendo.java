...
public class DqmEntityGamegonrejendo extends DqmMobBaseEnd
{

	public DqmEntityGamegonrejendo(World world)
	{
		super(world, EnumDqmMonster.GAMEGONREJENDO );

		//this.monsterType = EnumDqmMonster.GAMEGONREJENDO;
	...
	{
		return EnumDqmMonster.GAMEGONREJENDO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GAMEGONREJENDO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GAMEGONREJENDO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GAMEGONREJENDO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GAMEGONREJENDO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQR.funcMob.getCalcDROP(500, 1))
        {
            this.dropItem(DQArmors.itemSinpinoyoroi, 1);
        }
