...
public class DqmEntityYamatanooroti extends DqmMobBaseSP
{

	public DqmEntityYamatanooroti(World world)
	{
		super(world, EnumDqmMonster.YAMATANOOROTI );

		//this.monsterType = EnumDqmMonster.YAMATANOOROTI;
	...
	{
		return EnumDqmMonster.YAMATANOOROTI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.YAMATANOOROTI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.YAMATANOOROTI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.YAMATANOOROTI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.YAMATANOOROTI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQAccessories.itemHadokunoring, 1);
        }
        ...
        if (DQR.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQMiscs.itemYamatanooroti, 1);
        }
        if (DQR.funcMob.getCalcDROP(3, 1))
        {
