...
public class DqmEntityKandatakobun extends DqmMobBaseSP
{

	public DqmEntityKandatakobun(World world)
	{
		super(world, EnumDqmMonster.KANDATAKOBUN );

		//this.monsterType = EnumDqmMonster.KANDATAKOBUN;
	...
	{
		return EnumDqmMonster.KANDATAKOBUN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KANDATAKOBUN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KANDATAKOBUN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KANDATAKOBUN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KANDATAKOBUN.getDF();
    }
