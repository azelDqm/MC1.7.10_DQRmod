...
public class DqmEntityKiramajinga extends DqmMobBaseSP
{

	public DqmEntityKiramajinga(World world)
	{
		super(world, EnumDqmMonster.KIRAMAJINGA );

		//this.monsterType = EnumDqmMonster.KIRAMAJINGA;
	...
	{
		return EnumDqmMonster.KIRAMAJINGA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRAMAJINGA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRAMAJINGA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRAMAJINGA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRAMAJINGA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
            this.dropItem(DQMiscs.itemTuti, 1);
        }
        ...
        {
            this.dropItem(DQAccessories.itemMahounopiasu, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
            this.dropItem(DQAccessories.itemRoiyarubajjji, 1);
        }
        if (DQR.funcMob.getCalcDROP(5, 1))
        {
            this.dropItem(DQWeapons.itemKisekinoturugi, 1);
        }
        if (DQR.funcMob.getCalcDROP(5, 1))
        {
            this.dropItem(DQMiscs.itemIerooubu, 1);
        }
        if (DQR.funcMob.getCalcDROP(3, 1))
        {
        ...
        {
            this.dropItem(DQMiscs.itemKiramajinga, 1);
        }
