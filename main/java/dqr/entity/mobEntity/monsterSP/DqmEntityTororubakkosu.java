...
public class DqmEntityTororubakkosu extends DqmMobBaseSP
{

	public DqmEntityTororubakkosu(World world)
	{
		super(world, EnumDqmMonster.TORORUBAKKOSU );

		//this.monsterType = EnumDqmMonster.TORORUBAKKOSU;
	...
	{
		return EnumDqmMonster.TORORUBAKKOSU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TORORUBAKKOSU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TORORUBAKKOSU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TORORUBAKKOSU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TORORUBAKKOSU.getDF();
    }
