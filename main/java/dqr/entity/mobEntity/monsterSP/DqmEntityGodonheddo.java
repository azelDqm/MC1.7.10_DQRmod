...
public class DqmEntityGodonheddo extends DqmMobBaseSP
{

	public DqmEntityGodonheddo(World world)
	{
		super(world, EnumDqmMonster.GODONHEDDO );

		//this.monsterType = EnumDqmMonster.GODONHEDDO;
	...
	{
		return EnumDqmMonster.GODONHEDDO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GODONHEDDO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GODONHEDDO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GODONHEDDO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GODONHEDDO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQR.funcMob.getCalcDROP(20, 1))
        {
            this.dropItem(DQWeapons.itemDaitikudaki, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
