...
public class DqmEntityMashougumo extends DqmMobBaseSP
{

	public DqmEntityMashougumo(World world)
	{
		super(world, EnumDqmMonster.MASHOUGUMO );

		//this.monsterType = EnumDqmMonster.MASHOUGUMO;
	...
	{
		return EnumDqmMonster.MASHOUGUMO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MASHOUGUMO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MASHOUGUMO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MASHOUGUMO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MASHOUGUMO.getDF();
    }
