...
public class DqmEntityTattyan extends DqmMobBaseSP
{

	public DqmEntityTattyan(World world)
	{
		super(world, EnumDqmMonster.TATTYAN );

		//this.monsterType = EnumDqmMonster.TATTYAN;
	...
	{
		return EnumDqmMonster.TATTYAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TATTYAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TATTYAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TATTYAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TATTYAN.getDF();
    }
