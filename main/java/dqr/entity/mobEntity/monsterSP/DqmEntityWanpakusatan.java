...
public class DqmEntityWanpakusatan extends DqmMobBaseSP
{

	public DqmEntityWanpakusatan(World world)
	{
		super(world, EnumDqmMonster.WANPAKUSATAN );

		//this.monsterType = EnumDqmMonster.WANPAKUSATAN;
	...
	{
		return EnumDqmMonster.WANPAKUSATAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.WANPAKUSATAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.WANPAKUSATAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.WANPAKUSATAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.WANPAKUSATAN.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQR.funcMob.getCalcDROP(20, 1))
        {
            this.dropItem(DQWeapons.itemOdinbou, 1);
        }
