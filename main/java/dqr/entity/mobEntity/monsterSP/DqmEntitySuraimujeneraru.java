...
public class DqmEntitySuraimujeneraru extends DqmMobBaseSP
{

	public DqmEntitySuraimujeneraru(World world)
	{
		super(world, EnumDqmMonster.SURAIMUJENERARU );

		//this.monsterType = EnumDqmMonster.SURAIMUJENERARU;
	...
	{
		return EnumDqmMonster.SURAIMUJENERARU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUJENERARU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUJENERARU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUJENERARU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUJENERARU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemHayabusanoturugi, 1);
        }
        if (DQR.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQAccessories.itemMangetunoring, 1);
        }
        if (DQR.funcMob.getCalcDROP(8, 1))
        {
            this.dropItem(DQAccessories.itemSuraimupiasu, 1);
        }
        if (DQR.funcMob.getCalcDROP(8, 1))
        {
            this.dropItem(DQMiscs.itemToukonekisu, 1);
        }
        if (DQR.funcMob.getCalcDROP(5, 1))
        {
            this.dropItem(DQMiscs.itemRedoubu, 1);
        }
        ...
        if (DQR.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQMiscs.itemSuraimujeneraru, 1);
        }
        if (DQR.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQMiscs.itemLittlemedal, 1);
