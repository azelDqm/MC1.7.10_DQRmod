...
public class DqmEntityKinghidora extends DqmMobBaseSP
{

	public DqmEntityKinghidora(World world)
	{
		super(world, EnumDqmMonster.KINGHIDORA );
	...
	{
		return EnumDqmMonster.KINGHIDORA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KINGHIDORA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KINGHIDORA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KINGHIDORA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KINGHIDORA.getDF();
    }
