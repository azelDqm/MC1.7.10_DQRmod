...
public class DqmEntityKiratoti extends DqmMobBaseSP
{

	public DqmEntityKiratoti(World world)
	{
		super(world, EnumDqmMonster.KIRATOTI );

		//this.monsterType = EnumDqmMonster.KIRATOTI;
	...
	{
		return EnumDqmMonster.KIRATOTI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRATOTI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRATOTI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRATOTI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRATOTI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemInazumanoyari, 1);
        }
