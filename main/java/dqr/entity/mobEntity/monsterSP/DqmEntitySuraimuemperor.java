...
public class DqmEntitySuraimuemperor extends DqmMobBaseSP
{

	public DqmEntitySuraimuemperor(World world)
	{
		super(world, EnumDqmMonster.SURAIMUEMPEROR );

		//this.monsterType = EnumDqmMonster.KINGHIDORA;
	...
	{
		return EnumDqmMonster.SURAIMUEMPEROR.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUEMPEROR.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUEMPEROR.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUEMPEROR.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUEMPEROR.getDF();
    }
