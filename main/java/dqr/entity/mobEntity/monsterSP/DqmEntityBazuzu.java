...
public class DqmEntityBazuzu extends DqmMobBaseSP
{

	public DqmEntityBazuzu(World world)
	{
		super(world, EnumDqmMonster.BAZUZU );

		//this.monsterType = EnumDqmMonster.BAZUZU;
	...
	{
		return EnumDqmMonster.BAZUZU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BAZUZU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BAZUZU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BAZUZU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BAZUZU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQAccessories.itemSingonnojuzu, 1);
        }
        if (DQR.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQWeapons.itemOninokanabou, 1);
        }
        if (DQR.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQMiscs.itemPaapuruoubu, 1);
        }
        if (DQR.funcMob.getCalcDROP(10, 1))
        {
        ...
        {
            this.dropItem(DQMiscs.itemBazuzu, 1);
        }
        if (DQR.funcMob.getCalcDROP(5, 1))
        {
