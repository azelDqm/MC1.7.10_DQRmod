...
public class DqmEntityBlackchack extends DqmMobBaseSP
{

	public DqmEntityBlackchack(World world)
	{
		super(world, EnumDqmMonster.BLACKCHACK );
	...
	{
		return EnumDqmMonster.BLACKCHACK.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BLACKCHACK.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BLACKCHACK.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BLACKCHACK.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BLACKCHACK.getDF();
    }
