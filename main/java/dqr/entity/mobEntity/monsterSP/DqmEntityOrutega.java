...
public class DqmEntityOrutega extends DqmMobBaseSP
{

	public DqmEntityOrutega(World world)
	{
		super(world, EnumDqmMonster.ORUTEGA );
	...
	{
		return EnumDqmMonster.ORUTEGA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ORUTEGA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ORUTEGA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ORUTEGA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ORUTEGA.getDF();
    }
