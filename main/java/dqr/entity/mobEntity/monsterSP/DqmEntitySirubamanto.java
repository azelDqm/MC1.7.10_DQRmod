...
public class DqmEntitySirubamanto extends DqmMobBaseSP
{

	public DqmEntitySirubamanto(World world)
	{
		super(world, EnumDqmMonster.SIRUBAMANTO );

		//this.monsterType = EnumDqmMonster.SIRUBAMANTO;
	...
	{
		return EnumDqmMonster.SIRUBAMANTO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIRUBAMANTO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIRUBAMANTO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIRUBAMANTO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIRUBAMANTO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemSuiseinoturugi, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
