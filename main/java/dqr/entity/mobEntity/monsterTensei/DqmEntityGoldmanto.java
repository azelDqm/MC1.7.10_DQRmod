...
public class DqmEntityGoldmanto extends DqmMobBaseTensei
{

	public DqmEntityGoldmanto(World world)
	{
		super(world, EnumDqmMonster.GOLDMANTO );

		//this.monsterType = EnumDqmMonster.GOLDMANTO;
	...
	{
		return EnumDqmMonster.GOLDMANTO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GOLDMANTO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GOLDMANTO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GOLDMANTO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GOLDMANTO.getDF();
    }
