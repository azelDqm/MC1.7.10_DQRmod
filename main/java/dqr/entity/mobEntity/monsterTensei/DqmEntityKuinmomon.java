...
public class DqmEntityKuinmomon extends DqmMobBaseTensei
{

	public DqmEntityKuinmomon(World world)
	{
		super(world, EnumDqmMonster.KUINMOMON );

		//this.monsterType = EnumDqmMonster.KUINMOMON;
	...
	{
		return EnumDqmMonster.KUINMOMON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KUINMOMON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KUINMOMON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KUINMOMON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KUINMOMON.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQR.funcMob.getCalcDROP(200, 6))
        {
            this.dropItem(DQMiscs.itemLittlemedal5, 1);
        }
        if (DQR.funcMob.getCalcDROP(1, 1))
        {
            this.dropItem(DQArmors.itemSuraimunokanmuriK, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
