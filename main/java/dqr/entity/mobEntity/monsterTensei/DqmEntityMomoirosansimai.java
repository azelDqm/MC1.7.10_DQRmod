...
public class DqmEntityMomoirosansimai extends DqmMobBaseTensei
{

	public DqmEntityMomoirosansimai(World world)
	{
		super(world, EnumDqmMonster.MOMOIROSANSIMAI );

		//this.monsterType = EnumDqmMonster.MOMOIROSANSIMAI;
	...
	{
		return EnumDqmMonster.MOMOIROSANSIMAI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MOMOIROSANSIMAI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MOMOIROSANSIMAI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MOMOIROSANSIMAI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MOMOIROSANSIMAI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemMuti, 1);
        }
