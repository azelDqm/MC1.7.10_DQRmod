...
public class DqmEntityMoonkimera extends DqmMobBaseTensei
{

	public DqmEntityMoonkimera(World world)
	{
		super(world, EnumDqmMonster.MOONKIMERA );

		//this.monsterType = EnumDqmMonster.MOONKIMERA;
	...
	{
		return EnumDqmMonster.MOONKIMERA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MOONKIMERA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MOONKIMERA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MOONKIMERA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MOONKIMERA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemOujanoturugi, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
        ...
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
            this.dropItem(DQMiscs.itemOugiR, 1);
        }
