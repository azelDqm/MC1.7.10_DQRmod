...
public class DqmEntityShuvaluts extends DqmMobBaseTensei
{

	public DqmEntityShuvaluts(World world)
	{
		super(world, EnumDqmMonster.SHUVALUTS );

		//this.monsterType = EnumDqmMonster.SHUVALUTS;
	...
	{
		return EnumDqmMonster.SHUVALUTS.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SHUVALUTS.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SHUVALUTS.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SHUVALUTS.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SHUVALUTS.getDF();
    }
