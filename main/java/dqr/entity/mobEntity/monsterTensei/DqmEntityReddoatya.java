...
public class DqmEntityReddoatya extends DqmMobBaseTensei
{

	public DqmEntityReddoatya(World world)
	{
		super(world, EnumDqmMonster.REDDOATYA );

		//this.monsterType = EnumDqmMonster.REDDOATYA;
	...
	{
		return EnumDqmMonster.REDDOATYA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.REDDOATYA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.REDDOATYA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.REDDOATYA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.REDDOATYA.getDF();
    }
