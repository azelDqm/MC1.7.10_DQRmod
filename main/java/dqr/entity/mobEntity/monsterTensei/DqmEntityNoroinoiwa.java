...
public class DqmEntityNoroinoiwa extends DqmMobBaseTensei
{

	public DqmEntityNoroinoiwa(World world)
	{
		super(world, EnumDqmMonster.NOROINOIWA );

		//this.monsterType = EnumDqmMonster.NOROINOIWA;
	...
	{
		return EnumDqmMonster.NOROINOIWA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.NOROINOIWA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.NOROINOIWA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.NOROINOIWA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.NOROINOIWA.getDF();
    }
