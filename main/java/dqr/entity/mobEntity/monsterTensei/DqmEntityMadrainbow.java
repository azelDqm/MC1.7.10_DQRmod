...
public class DqmEntityMadrainbow extends DqmMobBaseTensei
{

	public DqmEntityMadrainbow(World world)
	{
		super(world, EnumDqmMonster.MADRAINBOW );

		//this.monsterType = EnumDqmMonster.MADRAINBOW;
	...
	{
		return EnumDqmMonster.MADRAINBOW.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MADRAINBOW.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MADRAINBOW.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MADRAINBOW.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MADRAINBOW.getDF();
    }
