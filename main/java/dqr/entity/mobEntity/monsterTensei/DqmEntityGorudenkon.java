...
public class DqmEntityGorudenkon extends DqmMobBaseTensei
{

	public DqmEntityGorudenkon(World world)
	{
		super(world, EnumDqmMonster.GORUDENKON );

		//this.monsterType = EnumDqmMonster.GORUDENKON;
	...
	{
		return EnumDqmMonster.GORUDENKON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GORUDENKON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GORUDENKON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GORUDENKON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GORUDENKON.getDF();
    }
