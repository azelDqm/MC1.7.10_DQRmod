...
public class DqmEntitySeigin extends DqmMobBaseTensei
{

	public DqmEntitySeigin(World world)
	{
		super(world, EnumDqmMonster.SEIGIN );

		//this.monsterType = EnumDqmMonster.SEIGIN;
	...
	{
		return EnumDqmMonster.SEIGIN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SEIGIN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SEIGIN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SEIGIN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SEIGIN.getDF();
    }
