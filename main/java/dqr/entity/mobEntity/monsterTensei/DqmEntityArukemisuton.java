...
public class DqmEntityArukemisuton extends DqmMobBaseTensei
{

	public DqmEntityArukemisuton(World world)
	{
		super(world, EnumDqmMonster.ARUKEMISUTON );

		//this.monsterType = EnumDqmMonster.ARUKEMISUTON;
	...
	{
		return EnumDqmMonster.ARUKEMISUTON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ARUKEMISUTON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ARUKEMISUTON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ARUKEMISUTON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ARUKEMISUTON.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQArmors.itemKenjanoroubu, 1);
        }
