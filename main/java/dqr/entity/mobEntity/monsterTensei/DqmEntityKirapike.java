...
public class DqmEntityKirapike extends DqmMobBaseTensei
{

	public DqmEntityKirapike(World world)
	{
		super(world, EnumDqmMonster.KIRAPIKE );

		//this.monsterType = EnumDqmMonster.KIRAPIKE;
	...
	{
		return EnumDqmMonster.KIRAPIKE.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRAPIKE.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRAPIKE.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRAPIKE.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRAPIKE.getDF();
    }
