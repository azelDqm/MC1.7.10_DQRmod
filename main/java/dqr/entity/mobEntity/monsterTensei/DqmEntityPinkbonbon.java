...
public class DqmEntityPinkbonbon extends DqmMobBaseTensei
{

	public DqmEntityPinkbonbon(World world)
	{
		super(world, EnumDqmMonster.PINKBONBON );

		//this.monsterType = EnumDqmMonster.PINKBONBON;
	...
	{
		return EnumDqmMonster.PINKBONBON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PINKBONBON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PINKBONBON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PINKBONBON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PINKBONBON.getDF();
    }
