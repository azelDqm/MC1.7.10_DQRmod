...
public class DqmEntityTaipug extends DqmMobBaseTensei
{

	public DqmEntityTaipug(World world)
	{
		super(world, EnumDqmMonster.TAIPUG );

		//this.monsterType = EnumDqmMonster.TAIPUG;
	...
	{
		return EnumDqmMonster.TAIPUG.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TAIPUG.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TAIPUG.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TAIPUG.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TAIPUG.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemToririondaga, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
