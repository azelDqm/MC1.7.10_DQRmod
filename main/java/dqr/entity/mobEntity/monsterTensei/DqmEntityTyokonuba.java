...
public class DqmEntityTyokonuba extends DqmMobBaseTensei
{

	public DqmEntityTyokonuba(World world)
	{
		super(world, EnumDqmMonster.TYOKONUBA );

		//this.monsterType = EnumDqmMonster.TYOKONUBA;
	...
	{
		return EnumDqmMonster.TYOKONUBA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TYOKONUBA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TYOKONUBA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TYOKONUBA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TYOKONUBA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemDoragonteiru, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
