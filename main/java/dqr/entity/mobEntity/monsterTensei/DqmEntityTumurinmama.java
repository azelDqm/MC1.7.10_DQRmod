...
public class DqmEntityTumurinmama extends DqmMobBaseTensei
{

	public DqmEntityTumurinmama(World world)
	{
		super(world, EnumDqmMonster.TUMURINMAMA );

		//this.monsterType = EnumDqmMonster.TUMURINMAMA;
	...
	{
		return EnumDqmMonster.TUMURINMAMA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TUMURINMAMA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TUMURINMAMA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TUMURINMAMA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TUMURINMAMA.getDF();
    }
