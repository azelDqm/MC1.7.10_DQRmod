...
public class DqmEntityMetaruhoimin extends DqmMobBaseTensei
{

	public DqmEntityMetaruhoimin(World world)
	{
		super(world, EnumDqmMonster.METARUHOIMIN );

		//this.monsterType = EnumDqmMonster.METARUHOIMIN;
	...
	{
		return EnumDqmMonster.METARUHOIMIN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.METARUHOIMIN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.METARUHOIMIN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.METARUHOIMIN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.METARUHOIMIN.getDF();
    }
