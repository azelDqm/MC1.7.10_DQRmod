...
public class DqmEntityObakekyandoru extends DqmMobBaseNight
{

	public DqmEntityObakekyandoru(World world)
	{
		super(world, EnumDqmMonster.OBAKEKYANDORU );

		//this.monsterType = EnumDqmMonster.OBAKEKYANDORU;
	...
	{
		return EnumDqmMonster.OBAKEKYANDORU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.OBAKEKYANDORU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.OBAKEKYANDORU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.OBAKEKYANDORU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.OBAKEKYANDORU.getDF();
    }
