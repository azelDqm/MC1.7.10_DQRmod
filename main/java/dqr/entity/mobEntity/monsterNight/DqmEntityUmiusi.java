...
public class DqmEntityUmiusi extends DqmMobBaseNight
{

	public DqmEntityUmiusi(World world)
	{
		super(world, EnumDqmMonster.UMIUSI );

		//this.monsterType = EnumDqmMonster.UMIUSI;
	...
	{
		return EnumDqmMonster.UMIUSI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.UMIUSI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.UMIUSI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.UMIUSI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.UMIUSI.getDF();
    }
