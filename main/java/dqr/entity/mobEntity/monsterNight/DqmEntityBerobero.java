...
public class DqmEntityBerobero extends DqmMobBaseNight
{

	public DqmEntityBerobero(World world)
	{
		super(world, EnumDqmMonster.BEROBERO );

		//this.monsterType = EnumDqmMonster.BEROBERO;
	...
	{
		return EnumDqmMonster.BEROBERO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BEROBERO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BEROBERO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BEROBERO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BEROBERO.getDF();
    }
