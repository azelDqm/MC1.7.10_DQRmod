...
public class DqmEntityMarinsuraimu extends DqmMobBaseNight
{

	public DqmEntityMarinsuraimu(World world)
	{
		super(world, EnumDqmMonster.MARINSURAIMU );

		//this.monsterType = EnumDqmMonster.MARINSURAIMU;
	...
	{
		return EnumDqmMonster.MARINSURAIMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MARINSURAIMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MARINSURAIMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MARINSURAIMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MARINSURAIMU.getDF();
    }
