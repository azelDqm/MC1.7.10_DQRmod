...
public class DqmEntityKirasuko extends DqmMobBaseNight
{

	public DqmEntityKirasuko(World world)
	{
		super(world, EnumDqmMonster.KIRASUKO );

		//this.monsterType = EnumDqmMonster.KIRASUKO;
	...
	{
		return EnumDqmMonster.KIRASUKO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRASUKO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRASUKO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRASUKO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRASUKO.getDF();
    }
