...
public class DqmEntityDansunidoru extends DqmMobBaseNight
{

	public DqmEntityDansunidoru(World world)
	{
		super(world, EnumDqmMonster.DANSUNIDORU );

		//this.monsterType = EnumDqmMonster.DANSUNIDORU;
	...
	{
		return EnumDqmMonster.DANSUNIDORU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DANSUNIDORU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DANSUNIDORU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DANSUNIDORU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DANSUNIDORU.getDF();
    }
