...
public class DqmEntitySibireageha extends DqmMobBaseNight
{

	public DqmEntitySibireageha(World world)
	{
		super(world, EnumDqmMonster.SIBIREAGEHA );

		//this.monsterType = EnumDqmMonster.SIBIREAGEHA;
	...
	{
		return EnumDqmMonster.SIBIREAGEHA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIBIREAGEHA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIBIREAGEHA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIBIREAGEHA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIBIREAGEHA.getDF();
    }
