...
public class DqmEntityDokuyazukin extends DqmMobBaseNight
{

	public DqmEntityDokuyazukin(World world)
	{
		super(world, EnumDqmMonster.DOKUYAZUKIN );

		//this.monsterType = EnumDqmMonster.DOKUYAZUKIN;
	...
	{
		return EnumDqmMonster.DOKUYAZUKIN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DOKUYAZUKIN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DOKUYAZUKIN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DOKUYAZUKIN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DOKUYAZUKIN.getDF();
    }
