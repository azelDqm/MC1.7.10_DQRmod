...
public class DqmEntityMinidemon extends DqmMobBaseNight
{

	public DqmEntityMinidemon(World world)
	{
		super(world, EnumDqmMonster.MINIDEMON );

		//this.monsterType = EnumDqmMonster.MINIDEMON;
	...
	{
		return EnumDqmMonster.MINIDEMON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MINIDEMON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MINIDEMON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MINIDEMON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MINIDEMON.getDF();
    }
