...
public class DqmEntityTomosibikozou extends DqmMobBaseNight
{

	public DqmEntityTomosibikozou(World world)
	{
		super(world, EnumDqmMonster.TOMOSIBIKOZOU );

		//this.monsterType = EnumDqmMonster.TOMOSIBIKOZOU;
	...
	{
		return EnumDqmMonster.TOMOSIBIKOZOU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TOMOSIBIKOZOU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TOMOSIBIKOZOU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TOMOSIBIKOZOU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TOMOSIBIKOZOU.getDF();
    }
