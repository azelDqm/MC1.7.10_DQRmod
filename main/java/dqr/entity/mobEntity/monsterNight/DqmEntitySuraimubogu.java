...
public class DqmEntitySuraimubogu extends DqmMobBaseNight
{

	public DqmEntitySuraimubogu(World world)
	{
		super(world, EnumDqmMonster.SURAIMUBOGU );

		//this.monsterType = EnumDqmMonster.SURAIMUBOGU;
	...
	{
		return EnumDqmMonster.SURAIMUBOGU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUBOGU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUBOGU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUBOGU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUBOGU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemTetunokugi, 1);
        }
