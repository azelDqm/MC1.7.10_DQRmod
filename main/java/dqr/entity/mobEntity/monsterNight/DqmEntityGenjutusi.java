...
public class DqmEntityGenjutusi extends DqmMobBaseNight
{

	public DqmEntityGenjutusi(World world)
	{
		super(world, EnumDqmMonster.GENJUTUSI );

		//this.monsterType = EnumDqmMonster.GENJUTUSI;
	...
	{
		return EnumDqmMonster.GENJUTUSI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GENJUTUSI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GENJUTUSI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GENJUTUSI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GENJUTUSI.getDF();
    }
