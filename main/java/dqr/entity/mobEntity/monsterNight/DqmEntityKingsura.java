...
public class DqmEntityKingsura extends DqmMobBaseNight
{

	public DqmEntityKingsura(World world)
	{
		super(world, EnumDqmMonster.KINGSURA );

		//this.monsterType = EnumDqmMonster.KINGSURA;
	...
	{
		return EnumDqmMonster.KINGSURA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KINGSURA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KINGSURA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KINGSURA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KINGSURA.getDF();
    }
