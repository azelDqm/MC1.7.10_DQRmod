...
public class DqmEntityMetaruraida extends DqmMobBaseNight
{

	public DqmEntityMetaruraida(World world)
	{
		super(world, EnumDqmMonster.METARURAIDA );

		//this.monsterType = EnumDqmMonster.METARURAIDA;
	...
	{
		return EnumDqmMonster.METARURAIDA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.METARURAIDA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.METARURAIDA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.METARURAIDA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.METARURAIDA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemDoragonkira, 1);
        }
