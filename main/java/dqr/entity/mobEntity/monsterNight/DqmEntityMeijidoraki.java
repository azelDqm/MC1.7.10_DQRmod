...
public class DqmEntityMeijidoraki extends DqmMobBaseNight
{

	public DqmEntityMeijidoraki(World world)
	{
		super(world, EnumDqmMonster.MEIJIDORAKI );

		//this.monsterType = EnumDqmMonster.MEIJIDORAKI;
	...
	{
		return EnumDqmMonster.MEIJIDORAKI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MEIJIDORAKI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MEIJIDORAKI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MEIJIDORAKI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MEIJIDORAKI.getDF();
    }
