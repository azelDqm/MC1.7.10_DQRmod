...
public class DqmEntityDesufuratta extends DqmMobBaseNight
{

	public DqmEntityDesufuratta(World world)
	{
		super(world, EnumDqmMonster.DESUFURATTA );

		//this.monsterType = EnumDqmMonster.DESUFURATTA;
	...
	{
		return EnumDqmMonster.DESUFURATTA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DESUFURATTA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DESUFURATTA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DESUFURATTA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DESUFURATTA.getDF();
    }
