...
public class DqmEntityBesuking extends DqmMobBaseNight
{

	public DqmEntityBesuking(World world)
	{
		super(world, EnumDqmMonster.BESUKING );

		//this.monsterType = EnumDqmMonster.BESUKING;
	...
	{
		return EnumDqmMonster.BESUKING.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BESUKING.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BESUKING.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BESUKING.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BESUKING.getDF();
    }
