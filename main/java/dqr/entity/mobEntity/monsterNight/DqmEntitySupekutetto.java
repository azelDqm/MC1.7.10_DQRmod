...
public class DqmEntitySupekutetto extends DqmMobBaseNight
{

	public DqmEntitySupekutetto(World world)
	{
		super(world, EnumDqmMonster.SUPEKUTETTO );

		//this.monsterType = EnumDqmMonster.SUPEKUTETTO;
	...
	{
		return EnumDqmMonster.SUPEKUTETTO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SUPEKUTETTO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SUPEKUTETTO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SUPEKUTETTO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SUPEKUTETTO.getDF();
    }
