...
public class DqmEntityTutiwarasi extends DqmMobBaseNight
{

	public DqmEntityTutiwarasi(World world)
	{
		super(world, EnumDqmMonster.TUTIWARASI );

		//this.monsterType = EnumDqmMonster.TUTIWARASI;
	...
	{
		return EnumDqmMonster.TUTIWARASI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TUTIWARASI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TUTIWARASI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TUTIWARASI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TUTIWARASI.getDF();
    }
