...
public class DqmEntityGhost extends DqmMobBaseNight
{

	public DqmEntityGhost(World world)
	{
		super(world, EnumDqmMonster.GHOST );

		//this.monsterType = EnumDqmMonster.GHOST;
	...
	{
		return EnumDqmMonster.GHOST.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GHOST.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GHOST.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GHOST.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GHOST.getDF();
    }
