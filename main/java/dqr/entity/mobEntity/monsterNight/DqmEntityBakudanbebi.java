...
public class DqmEntityBakudanbebi extends DqmMobBaseNight
{

	public DqmEntityBakudanbebi(World world)
	{
		super(world, EnumDqmMonster.BAKUDANBEBI );

		//this.monsterType = EnumDqmMonster.BAKUDANBEBI;
	...
	{
		return EnumDqmMonster.BAKUDANBEBI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BAKUDANBEBI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BAKUDANBEBI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BAKUDANBEBI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BAKUDANBEBI.getDF();
    }
