...
public class DqmEntityMeijikimera extends DqmMobBaseNight
{

	public DqmEntityMeijikimera(World world)
	{
		super(world, EnumDqmMonster.MEIJIKIMERA );

		//this.monsterType = EnumDqmMonster.MEIJIKIMERA;
	...
	{
		return EnumDqmMonster.MEIJIKIMERA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MEIJIKIMERA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MEIJIKIMERA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MEIJIKIMERA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MEIJIKIMERA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemMeijikimeranohane, 1);
        }
