...
public class DqmEntityHerughost extends DqmMobBaseNight
{

	public DqmEntityHerughost(World world)
	{
		super(world, EnumDqmMonster.HERUGHOST );

		//this.monsterType = EnumDqmMonster.HERUGHOST;
	...
	{
		return EnumDqmMonster.HERUGHOST.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HERUGHOST.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HERUGHOST.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HERUGHOST.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HERUGHOST.getDF();
    }
