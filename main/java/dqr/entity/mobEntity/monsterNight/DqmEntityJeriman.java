...
public class DqmEntityJeriman extends DqmMobBaseNight
{

	public DqmEntityJeriman(World world)
	{
		super(world, EnumDqmMonster.JERIMAN );

		//this.monsterType = EnumDqmMonster.JERIMAN;
	...
	{
		return EnumDqmMonster.JERIMAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.JERIMAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.JERIMAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.JERIMAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.JERIMAN.getDF();
    }
