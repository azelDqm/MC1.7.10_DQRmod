...
public class DqmEntitySamayoutamasii extends DqmMobBaseNight
{

	public DqmEntitySamayoutamasii(World world)
	{
		super(world, EnumDqmMonster.SAMAYOUTAMASII );

		//this.monsterType = EnumDqmMonster.SAMAYOUTAMASII;
	...
	{
		return EnumDqmMonster.SAMAYOUTAMASII.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SAMAYOUTAMASII.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SAMAYOUTAMASII.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SAMAYOUTAMASII.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SAMAYOUTAMASII.getDF();
    }
