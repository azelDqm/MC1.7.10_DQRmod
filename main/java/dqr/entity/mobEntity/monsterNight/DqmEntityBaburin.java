...
public class DqmEntityBaburin extends DqmMobBaseNight
{

	public DqmEntityBaburin(World world)
	{
		super(world, EnumDqmMonster.BABURIN );

		//this.monsterType = EnumDqmMonster.BABURIN;
	...
	{
		return EnumDqmMonster.BABURIN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BABURIN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BABURIN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BABURIN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BABURIN.getDF();
    }
