...
public class DqmEntityYouganmajin extends DqmMobBaseNight
{

	public DqmEntityYouganmajin(World world)
	{
		super(world, EnumDqmMonster.YOUGANMAJIN );

		//this.monsterType = EnumDqmMonster.YOUGANMAJIN;
	...
	{
		return EnumDqmMonster.YOUGANMAJIN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.YOUGANMAJIN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.YOUGANMAJIN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.YOUGANMAJIN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.YOUGANMAJIN.getDF();
    }
