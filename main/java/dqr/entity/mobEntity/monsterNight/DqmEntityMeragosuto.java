...
public class DqmEntityMeragosuto extends DqmMobBaseNight
{

	public DqmEntityMeragosuto(World world)
	{
		super(world, EnumDqmMonster.MERAGOSUTO );

		//this.monsterType = EnumDqmMonster.MERAGOSUTO;
	...
	{
		return EnumDqmMonster.MERAGOSUTO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MERAGOSUTO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MERAGOSUTO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MERAGOSUTO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MERAGOSUTO.getDF();
    }
