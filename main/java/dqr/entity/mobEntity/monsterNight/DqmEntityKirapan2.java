...
public class DqmEntityKirapan2 extends DqmMobBaseNight
{

	public DqmEntityKirapan2(World world)
	{
		super(world, EnumDqmMonster.KIRAPAN2 );
	...
	{
		return EnumDqmMonster.KIRAPAN2.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRAPAN2.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRAPAN2.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRAPAN2.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRAPAN2.getDF();
    }
