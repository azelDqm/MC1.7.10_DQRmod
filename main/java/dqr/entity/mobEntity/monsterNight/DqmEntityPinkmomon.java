...
public class DqmEntityPinkmomon extends DqmMobBaseNight
{

	public DqmEntityPinkmomon(World world)
	{
		super(world, EnumDqmMonster.PINKMOMON );

		//this.monsterType = EnumDqmMonster.PINKMOMON;
	...
	{
		return EnumDqmMonster.PINKMOMON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PINKMOMON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PINKMOMON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PINKMOMON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PINKMOMON.getDF();
    }
