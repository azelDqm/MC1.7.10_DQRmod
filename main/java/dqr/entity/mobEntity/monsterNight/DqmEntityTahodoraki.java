...
public class DqmEntityTahodoraki extends DqmMobBaseNight
{

	public DqmEntityTahodoraki(World world)
	{
		super(world, EnumDqmMonster.TAHODORAKI );

		//this.monsterType = EnumDqmMonster.TAHODORAKI;
	...
	{
		return EnumDqmMonster.TAHODORAKI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TAHODORAKI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TAHODORAKI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TAHODORAKI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TAHODORAKI.getDF();
    }
