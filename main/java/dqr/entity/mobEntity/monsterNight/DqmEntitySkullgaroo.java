...
public class DqmEntitySkullgaroo extends DqmMobBaseNight
{

	public DqmEntitySkullgaroo(World world)
	{
		super(world, EnumDqmMonster.SKULLGAROO );

		//this.monsterType = EnumDqmMonster.SKULLGAROO;
	...
	{
		return EnumDqmMonster.SKULLGAROO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SKULLGAROO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SKULLGAROO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SKULLGAROO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SKULLGAROO.getDF();
    }
