...
public class DqmEntityTororu extends DqmMobBaseNight
{

	public DqmEntityTororu(World world)
	{
		super(world, EnumDqmMonster.TORORU );

		//this.monsterType = EnumDqmMonster.TORORU;
	...
	{
		return EnumDqmMonster.TORORU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TORORU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TORORU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TORORU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TORORU.getDF();
    }
