...
public class DqmEntityMetoroghost extends DqmMobBaseNight
{

	public DqmEntityMetoroghost(World world)
	{
		super(world, EnumDqmMonster.METOROGHOST );

		//this.monsterType = EnumDqmMonster.METOROGHOST;
	...
	{
		return EnumDqmMonster.METOROGHOST.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.METOROGHOST.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.METOROGHOST.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.METOROGHOST.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.METOROGHOST.getDF();
    }
