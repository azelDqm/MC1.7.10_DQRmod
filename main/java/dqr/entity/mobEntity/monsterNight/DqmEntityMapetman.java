...
public class DqmEntityMapetman extends DqmMobBaseNight
{

	public DqmEntityMapetman(World world)
	{
		super(world, EnumDqmMonster.MAPETMAN );

		//this.monsterType = EnumDqmMonster.MAPETMAN;
	...
	{
		return EnumDqmMonster.MAPETMAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MAPETMAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MAPETMAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MAPETMAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MAPETMAN.getDF();
    }
