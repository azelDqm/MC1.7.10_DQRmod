...
public class DqmEntityBakudaniwa extends DqmMobBaseNight
{

	public DqmEntityBakudaniwa(World world)
	{
		super(world, EnumDqmMonster.BAKUDANIWA );

		//this.monsterType = EnumDqmMonster.BAKUDANIWA;
	...
	{
		return EnumDqmMonster.BAKUDANIWA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BAKUDANIWA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BAKUDANIWA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BAKUDANIWA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BAKUDANIWA.getDF();
    }
