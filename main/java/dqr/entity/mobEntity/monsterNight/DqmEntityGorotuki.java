...
public class DqmEntityGorotuki extends DqmMobBaseNight
{

	public DqmEntityGorotuki(World world)
	{
		super(world, EnumDqmMonster.GOROTUKI );

		//this.monsterType = EnumDqmMonster.GOROTUKI;
	...
	{
		return EnumDqmMonster.GOROTUKI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GOROTUKI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GOROTUKI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GOROTUKI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GOROTUKI.getDF();
    }
