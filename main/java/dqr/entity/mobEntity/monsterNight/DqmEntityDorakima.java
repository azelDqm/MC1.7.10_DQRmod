...
public class DqmEntityDorakima extends DqmMobBaseNight
{

	public DqmEntityDorakima(World world)
	{
		super(world, EnumDqmMonster.DORAKIMA );

		//this.monsterType = EnumDqmMonster.DORAKIMA;
	...
	{
		return EnumDqmMonster.DORAKIMA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DORAKIMA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DORAKIMA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DORAKIMA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DORAKIMA.getDF();
    }
