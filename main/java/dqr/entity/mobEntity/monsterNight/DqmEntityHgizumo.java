...
public class DqmEntityHgizumo extends DqmMobBaseNight
{

	public DqmEntityHgizumo(World world)
	{
		super(world, EnumDqmMonster.HGIZUMO );

		//this.monsterType = EnumDqmMonster.HGIZUMO;
	...
	{
		return EnumDqmMonster.HGIZUMO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HGIZUMO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HGIZUMO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HGIZUMO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HGIZUMO.getDF();
    }
