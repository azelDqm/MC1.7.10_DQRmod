...
public class DqmEntityMokomokojuu extends DqmMobBaseNight
{
	...
	public DqmEntityMokomokojuu(World world)
	{
		...
		//this.monsterType = EnumDqmMonster.MOKOMOKOJUU;
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MOKOMOKOJUU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MOKOMOKOJUU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MOKOMOKOJUU.getPW()));
	}
