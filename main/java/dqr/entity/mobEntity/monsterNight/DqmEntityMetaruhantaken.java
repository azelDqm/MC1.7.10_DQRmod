...
public class DqmEntityMetaruhantaken extends DqmMobBaseNight
{

	public DqmEntityMetaruhantaken(World world)
	{
		super(world, EnumDqmMonster.METARUHANTAKEN );

		//this.monsterType = EnumDqmMonster.METARUHANTAKEN;
	...
	{
		return EnumDqmMonster.METARUHANTAKEN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.METARUHANTAKEN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.METARUHANTAKEN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.METARUHANTAKEN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.METARUHANTAKEN.getDF();
    }
