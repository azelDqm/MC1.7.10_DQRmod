...
public class DqmEntitySibiredanbira extends DqmMobBaseNight
{

	public DqmEntitySibiredanbira(World world)
	{
		super(world, EnumDqmMonster.SIBIREDANBIRA );

		//this.monsterType = EnumDqmMonster.SIBIREDANBIRA;
	...
	{
		return EnumDqmMonster.SIBIREDANBIRA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIBIREDANBIRA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIBIREDANBIRA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIBIREDANBIRA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIBIREDANBIRA.getDF();
    }
