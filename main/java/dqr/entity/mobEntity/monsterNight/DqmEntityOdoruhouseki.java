...
public class DqmEntityOdoruhouseki extends DqmMobBaseNight
{

	public DqmEntityOdoruhouseki(World world)
	{
		super(world, EnumDqmMonster.ODORUHOUSEKI );

		//this.monsterType = EnumDqmMonster.ODORUHOUSEKI;
	...
	{
		return EnumDqmMonster.ODORUHOUSEKI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ODORUHOUSEKI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ODORUHOUSEKI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ODORUHOUSEKI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ODORUHOUSEKI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQR.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQIngots.itemRubinogenseki, 1);
        }
        if (DQR.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQMiscs.itemDoragonnonamida, 1);
        }
        if (DQR.funcMob.getCalcDROP(10, 1))
        {
        ...
        if (DQR.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQIngots.itemInotinoisi, 1);
        }
        if (DQR.funcMob.getCalcDROP(10, 1))
        {
        ...
        if (DQR.funcMob.getCalcDROP(600, 1))
        {
