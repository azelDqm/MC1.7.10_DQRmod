...
public class DqmEntityBuraddihando extends DqmMobBaseNight
{

	public DqmEntityBuraddihando(World world)
	{
		super(world, EnumDqmMonster.BURADDIHANDO );

		//this.monsterType = EnumDqmMonster.BURADDIHANDO;
	...
	{
		return EnumDqmMonster.BURADDIHANDO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BURADDIHANDO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BURADDIHANDO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BURADDIHANDO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BURADDIHANDO.getDF();
    }
