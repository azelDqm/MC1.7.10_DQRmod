...
public class DqmEntitySumoruguru extends DqmMobBaseNight
{

	public DqmEntitySumoruguru(World world)
	{
		super(world, EnumDqmMonster.SUMORUGURU );

		//this.monsterType = EnumDqmMonster.SUMORUGURU;
	...
	{
		return EnumDqmMonster.SUMORUGURU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SUMORUGURU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SUMORUGURU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SUMORUGURU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SUMORUGURU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQIngots.itemHosinokakera, 1);
        }
