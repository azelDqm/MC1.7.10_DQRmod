...
public class DqmEntityBehoimusuraimu extends DqmMobBaseNight
{

	public DqmEntityBehoimusuraimu(World world)
	{
		super(world, EnumDqmMonster.BEHOIMUSURAIMU );

		//this.monsterType = EnumDqmMonster.BEHOIMUSURAIMU;
	...
	{
		return EnumDqmMonster.BEHOIMUSURAIMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BEHOIMUSURAIMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BEHOIMUSURAIMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BEHOIMUSURAIMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BEHOIMUSURAIMU.getDF();
    }
