...
public class DqmEntityMatango extends DqmMobBaseNight
{

	public DqmEntityMatango(World world)
	{
		super(world, EnumDqmMonster.MATANGO );

		//this.monsterType = EnumDqmMonster.MATANGO;
	...
	{
		return EnumDqmMonster.MATANGO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MATANGO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MATANGO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MATANGO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MATANGO.getDF();
    }
