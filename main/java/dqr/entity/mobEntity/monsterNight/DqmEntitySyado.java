...
public class DqmEntitySyado extends DqmMobBaseNight
{

	public DqmEntitySyado(World world)
	{
		super(world, EnumDqmMonster.SYADO );

		//this.monsterType = EnumDqmMonster.SYADO;
	...
	{
		return EnumDqmMonster.SYADO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SYADO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SYADO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SYADO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SYADO.getDF();
    }
