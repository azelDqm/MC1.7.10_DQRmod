...
public class DqmEntityDoroningyou extends DqmMobBaseNight
{

	public DqmEntityDoroningyou(World world)
	{
		super(world, EnumDqmMonster.DORONINGYOU );

		//this.monsterType = EnumDqmMonster.DORONINGYOU;
	...
	{
		return EnumDqmMonster.DORONINGYOU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DORONINGYOU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DORONINGYOU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DORONINGYOU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DORONINGYOU.getDF();
    }
