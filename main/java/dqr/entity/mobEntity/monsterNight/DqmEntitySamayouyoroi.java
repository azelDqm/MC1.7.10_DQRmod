...
public class DqmEntitySamayouyoroi extends DqmMobBaseNight
{

	public DqmEntitySamayouyoroi(World world)
	{
		super(world, EnumDqmMonster.SAMAYOUYOROI );

		//this.monsterType = EnumDqmMonster.SAMAYOUYOROI;
	...
	{
		return EnumDqmMonster.SAMAYOUYOROI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SAMAYOUYOROI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SAMAYOUYOROI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SAMAYOUYOROI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SAMAYOUYOROI.getDF();
    }
