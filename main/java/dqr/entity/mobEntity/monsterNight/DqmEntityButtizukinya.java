...
public class DqmEntityButtizukinya extends DqmMobBaseNight
{

	public DqmEntityButtizukinya(World world)
	{
		super(world, EnumDqmMonster.BUTTIZUKINYA );

		//this.monsterType = EnumDqmMonster.BUTTIZUKINYA;
	...
	{
		return EnumDqmMonster.BUTTIZUKINYA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BUTTIZUKINYA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BUTTIZUKINYA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BUTTIZUKINYA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BUTTIZUKINYA.getDF();
    }
