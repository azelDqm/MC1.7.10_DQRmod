...
public class DqmEntitySura2 extends DqmMobBaseNight
{

	public DqmEntitySura2(World world)
	{
		super(world, EnumDqmMonster.SURA2 );

		//this.monsterType = EnumDqmMonster.SURA2;
	...
	{
		return EnumDqmMonster.SURA2.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURA2.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURA2.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURA2.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURA2.getDF();
    }
