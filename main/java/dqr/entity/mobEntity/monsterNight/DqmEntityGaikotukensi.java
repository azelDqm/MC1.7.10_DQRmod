...
public class DqmEntityGaikotukensi extends DqmMobBaseNight
{

	public DqmEntityGaikotukensi(World world)
	{
		super(world, EnumDqmMonster.GAIKOTUKENSI );

		//this.monsterType = EnumDqmMonster.GAIKOTUKENSI;
	...
	{
		return EnumDqmMonster.GAIKOTUKENSI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GAIKOTUKENSI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GAIKOTUKENSI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GAIKOTUKENSI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GAIKOTUKENSI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemHonehone, 1);
        }
