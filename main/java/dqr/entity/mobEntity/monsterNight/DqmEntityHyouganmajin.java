...
public class DqmEntityHyouganmajin extends DqmMobBaseNight
{

	public DqmEntityHyouganmajin(World world)
	{
		super(world, EnumDqmMonster.HYOUGANMAJIN );

		//this.monsterType = EnumDqmMonster.HYOUGANMAJIN;
	...
	{
		return EnumDqmMonster.HYOUGANMAJIN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HYOUGANMAJIN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HYOUGANMAJIN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HYOUGANMAJIN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HYOUGANMAJIN.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemRisaikurusuton, 1);
        }
