...
public class DqmEntityArumiraji extends DqmMobBaseNight
{

	public DqmEntityArumiraji(World world)
	{
		super(world, EnumDqmMonster.ARUMIRAJI );

		//this.monsterType = EnumDqmMonster.ARUMIRAJI;
	...
	{
		return EnumDqmMonster.ARUMIRAJI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ARUMIRAJI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ARUMIRAJI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ARUMIRAJI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ARUMIRAJI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemUsaginosippo, 1);
        }
