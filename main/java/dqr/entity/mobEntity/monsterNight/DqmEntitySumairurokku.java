...
public class DqmEntitySumairurokku extends DqmMobBaseNight
{

	public DqmEntitySumairurokku(World world)
	{
		super(world, EnumDqmMonster.SUMAIRUROKKU );

		//this.monsterType = EnumDqmMonster.SUMAIRUROKKU;
	...
	{
		return EnumDqmMonster.SUMAIRUROKKU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SUMAIRUROKKU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SUMAIRUROKKU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SUMAIRUROKKU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SUMAIRUROKKU.getDF();
    }
