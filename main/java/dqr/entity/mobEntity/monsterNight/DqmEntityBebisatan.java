...
public class DqmEntityBebisatan extends DqmMobBaseNight
{

	public DqmEntityBebisatan(World world)
	{
		super(world, EnumDqmMonster.BEBISATAN );

		//this.monsterType = EnumDqmMonster.BEBISATAN;
	...
	{
		return EnumDqmMonster.BEBISATAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BEBISATAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BEBISATAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BEBISATAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BEBISATAN.getDF();
    }
