...
public class DqmEntityAkumanosyo extends DqmMobBaseNight
{

	public DqmEntityAkumanosyo(World world)
	{
		super(world, EnumDqmMonster.AKUMANOSYO );

		//this.monsterType = EnumDqmMonster.AKUMANOSYO;
	...
	{
		return EnumDqmMonster.AKUMANOSYO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.AKUMANOSYO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.AKUMANOSYO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.AKUMANOSYO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.AKUMANOSYO.getDF();
    }
