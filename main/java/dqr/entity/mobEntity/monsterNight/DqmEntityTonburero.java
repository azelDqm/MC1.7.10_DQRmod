...
public class DqmEntityTonburero extends DqmMobBaseNight
{

	public DqmEntityTonburero(World world)
	{
		super(world, EnumDqmMonster.TONBURERO );

		//this.monsterType = EnumDqmMonster.TONBURERO;
	...
	{
		return EnumDqmMonster.TONBURERO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TONBURERO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TONBURERO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TONBURERO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TONBURERO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemUsinofun, 1);
        }
        if (DQR.funcMob.getCalcDROP(300, 1))
        {
            this.dropItem(DQArmors.itemMahounobousi, 1);
        }
