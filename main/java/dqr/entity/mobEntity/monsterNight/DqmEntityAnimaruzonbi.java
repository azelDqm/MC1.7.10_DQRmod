...
public class DqmEntityAnimaruzonbi extends DqmMobBaseNight
{

	public DqmEntityAnimaruzonbi(World world)
	{
		super(world, EnumDqmMonster.ANIMARUZONBI );

		//this.monsterType = EnumDqmMonster.ANIMARUZONBI;
	...
	{
		return EnumDqmMonster.ANIMARUZONBI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ANIMARUZONBI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ANIMARUZONBI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ANIMARUZONBI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ANIMARUZONBI.getDF();
    }
