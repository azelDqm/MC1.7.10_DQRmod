...
public class DqmEntityEnzeruslime extends DqmMobBaseNight
{

	public DqmEntityEnzeruslime(World world)
	{
		super(world, EnumDqmMonster.ENZERUSLIME );

		//this.monsterType = EnumDqmMonster.ENZERUSLIME;
	...
	{
		return EnumDqmMonster.ENZERUSLIME.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ENZERUSLIME.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ENZERUSLIME.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ENZERUSLIME.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ENZERUSLIME.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemTensinohane, 1);
        }
