...
public class DqmEntityBehoimisuraimu extends DqmMobBaseNight
{

	public DqmEntityBehoimisuraimu(World world)
	{
		super(world, EnumDqmMonster.BEHOIMISURAIMU );

		//this.monsterType = EnumDqmMonster.BEHOIMISURAIMU;
	...
	{
		return EnumDqmMonster.BEHOIMISURAIMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BEHOIMISURAIMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BEHOIMISURAIMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BEHOIMISURAIMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BEHOIMISURAIMU.getDF();
    }
