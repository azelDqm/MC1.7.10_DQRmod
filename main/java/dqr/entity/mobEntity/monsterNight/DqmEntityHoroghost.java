...
public class DqmEntityHoroghost extends DqmMobBaseNight
{

	public DqmEntityHoroghost(World world)
	{
		super(world, EnumDqmMonster.HOROGHOST );

		//this.monsterType = EnumDqmMonster.HOROGHOST;
	...
	{
		return EnumDqmMonster.HOROGHOST.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HOROGHOST.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HOROGHOST.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HOROGHOST.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HOROGHOST.getDF();
    }
