...
public class DqmEntityAxedoragon extends DqmMobBaseNight
{

	public DqmEntityAxedoragon(World world)
	{
		super(world, EnumDqmMonster.AXEDORAGON );

		//this.monsterType = EnumDqmMonster.AXEDORAGON;
	...
	{
		return EnumDqmMonster.AXEDORAGON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.AXEDORAGON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.AXEDORAGON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.AXEDORAGON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.AXEDORAGON.getDF();
    }
