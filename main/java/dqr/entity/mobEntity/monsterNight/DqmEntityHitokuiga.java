...
public class DqmEntityHitokuiga extends DqmMobBaseNight
{

	public DqmEntityHitokuiga(World world)
	{
		super(world, EnumDqmMonster.HITOKUIGA );

		//this.monsterType = EnumDqmMonster.HITOKUIGA;
	...
	{
		return EnumDqmMonster.HITOKUIGA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HITOKUIGA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HITOKUIGA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HITOKUIGA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HITOKUIGA.getDF();
    }
