...
public class DqmEntityBeronyaago extends DqmMobBaseNight
{

	public DqmEntityBeronyaago(World world)
	{
		super(world, EnumDqmMonster.BERONYAAGO );

		//this.monsterType = EnumDqmMonster.BERONYAAGO;
	...
	{
		return EnumDqmMonster.BERONYAAGO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BERONYAAGO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BERONYAAGO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BERONYAAGO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BERONYAAGO.getDF();
    }
