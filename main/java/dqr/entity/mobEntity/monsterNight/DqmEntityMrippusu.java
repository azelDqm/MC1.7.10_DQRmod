...
public class DqmEntityMrippusu extends DqmMobBaseNight
{

	public DqmEntityMrippusu(World world)
	{
		super(world, EnumDqmMonster.MRIPPUSU );

		//this.monsterType = EnumDqmMonster.MRIPPUSU;
	...
	{
		return EnumDqmMonster.MRIPPUSU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MRIPPUSU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MRIPPUSU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MRIPPUSU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MRIPPUSU.getDF();
    }
