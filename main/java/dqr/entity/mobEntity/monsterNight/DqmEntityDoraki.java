...
public class DqmEntityDoraki extends DqmMobBaseNight
{

	public DqmEntityDoraki(World world)
	{
		super(world, EnumDqmMonster.DORAKI );

		//this.monsterType = EnumDqmMonster.DORAKI;
	...
	{
		return EnumDqmMonster.DORAKI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DORAKI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DORAKI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DORAKI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DORAKI.getDF();
    }
