...
public class EntityAINearestAttackableTarget2 extends EntityAITarget
{
    ...
    private final EntityAINearestAttackableTarget2.Sorter theNearestAttackableTargetSorter;
    /**
    ...
    public EntityAINearestAttackableTarget2(EntityCreature p_i1664_1_, Class p_i1664_2_, int p_i1664_3_, boolean p_i1664_4_, boolean p_i1664_5_)
    {
    ...
    public EntityAINearestAttackableTarget2(EntityCreature p_i1665_1_, Class p_i1665_2_, int p_i1665_3_, boolean p_i1665_4_, boolean p_i1665_5_, final IEntitySelector p_i1665_6_)
    {
        ...
        this.theNearestAttackableTargetSorter = new EntityAINearestAttackableTarget2.Sorter(p_i1665_1_);
        this.setMutexBits(1);
        this.targetEntitySelector = new IEntitySelector()
        {
            ...
            {
                return !(p_82704_1_ instanceof EntityLivingBase) ? false : (p_i1665_6_ != null && !p_i1665_6_.isEntityApplicable(p_82704_1_) ? false : EntityAINearestAttackableTarget2.this.isSuitableTarget((EntityLivingBase)p_82704_1_, false));
            }
        };
    }
