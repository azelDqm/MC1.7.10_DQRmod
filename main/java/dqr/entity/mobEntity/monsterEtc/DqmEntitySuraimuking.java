...
public class DqmEntitySuraimuking extends DqmMobBaseEtc
{

	public DqmEntitySuraimuking(World world)
	{
		super(world, EnumDqmMonster.SURAIMUKING );

		//this.monsterType = EnumDqmMonster.SURAIMUKING;
	...
	{
		return EnumDqmMonster.SURAIMUKING.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUKING.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUKING.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUKING.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUKING.getDF();
    }
