...
public class DqmEntityFurosutogizumo extends DqmMobBaseEtc
{

	public DqmEntityFurosutogizumo(World world)
	{
		super(world, EnumDqmMonster.FUROSUTOGIZUMO );

		//this.monsterType = EnumDqmMonster.FUROSUTOGIZUMO;
	...
	{
		return EnumDqmMonster.FUROSUTOGIZUMO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.FUROSUTOGIZUMO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.FUROSUTOGIZUMO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.FUROSUTOGIZUMO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.FUROSUTOGIZUMO.getDF();
    }
