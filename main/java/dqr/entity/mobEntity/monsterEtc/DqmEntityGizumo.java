...
public class DqmEntityGizumo extends DqmMobBaseEtc
{

	public DqmEntityGizumo(World world)
	{
		super(world, EnumDqmMonster.GIZUMO );

		//this.monsterType = EnumDqmMonster.GIZUMO;
	...
	{
		return EnumDqmMonster.GIZUMO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GIZUMO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GIZUMO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GIZUMO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GIZUMO.getDF();
    }
