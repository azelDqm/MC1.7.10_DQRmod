...
public class DqmEntityNorowaretaturugi extends DqmMobBaseEtc
{

	public DqmEntityNorowaretaturugi(World world)
	{
		super(world, EnumDqmMonster.NOROWARETATURUGI );

		//this.monsterType = EnumDqmMonster.NOROWARETATURUGI;
	...
	{
		return EnumDqmMonster.NOROWARETATURUGI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.NOROWARETATURUGI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.NOROWARETATURUGI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.NOROWARETATURUGI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.NOROWARETATURUGI.getDF();
    }
