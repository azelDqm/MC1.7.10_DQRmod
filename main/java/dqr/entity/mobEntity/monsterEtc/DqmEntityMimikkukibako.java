...
public class DqmEntityMimikkukibako extends DqmMobBaseEtc
{

	public DqmEntityMimikkukibako(World world)
	{
		super(world, EnumDqmMonster.MIMIKKUKIBAKO );

		//this.monsterType = EnumDqmMonster.MIMIKKUKIBAKO;
	...
	{
		return EnumDqmMonster.MIMIKKUKIBAKO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MIMIKKUKIBAKO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MIMIKKUKIBAKO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MIMIKKUKIBAKO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MIMIKKUKIBAKO.getDF();
    }
