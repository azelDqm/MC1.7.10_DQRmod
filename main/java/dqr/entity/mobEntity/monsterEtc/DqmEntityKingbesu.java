...
public class DqmEntityKingbesu extends DqmMobBaseEtc
{

	public DqmEntityKingbesu(World world)
	{
		super(world, EnumDqmMonster.KINGBESU );

		//this.monsterType = EnumDqmMonster.KINGBESU;
	...
	{
		return EnumDqmMonster.KINGBESU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KINGBESU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KINGBESU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KINGBESU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KINGBESU.getDF();
    }
