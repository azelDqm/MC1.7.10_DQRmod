...
public class DqmEntityHiitogizumo extends DqmMobBaseEtc
{

	public DqmEntityHiitogizumo(World world)
	{
		super(world, EnumDqmMonster.HIITOGIZUMO );

		//this.monsterType = EnumDqmMonster.HIITOGIZUMO;
	...
	{
		return EnumDqmMonster.HIITOGIZUMO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HIITOGIZUMO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HIITOGIZUMO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HIITOGIZUMO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HIITOGIZUMO.getDF();
    }
