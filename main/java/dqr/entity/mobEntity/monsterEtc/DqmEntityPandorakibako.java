...
public class DqmEntityPandorakibako extends DqmMobBaseEtc
{

	public DqmEntityPandorakibako(World world)
	{
		super(world, EnumDqmMonster.PANDORAKIBAKO );

		//this.monsterType = EnumDqmMonster.PANDORAKIBAKO;
	...
	{
		return EnumDqmMonster.PANDORAKIBAKO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PANDORAKIBAKO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PANDORAKIBAKO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PANDORAKIBAKO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PANDORAKIBAKO.getDF();
    }
