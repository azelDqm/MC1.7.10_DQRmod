    ...
    */
    ...
    public void damageEntity(DamageSource source, float p_70665_2_)
    {
        ...
        if (!this.isEntityInvulnerable())
        {
            ...
            p_70665_2_ = DQR.calcDamage.applyDamageResist(p_70665_2_, this, source);
            ...
            if(source!= null)
            {
            	...
            	if(source.getEntity() instanceof EntityPlayer)
            	{
					...
					if(!ep.worldObj.isRemote)
					{
						...
						{
							ep.addChatMessage(new ChatComponentTranslation("msg.toDamage3.txt",new Object[] {EnumDqmMessageConv.MonsterName.getStartS() + this.getEntityString() + EnumDqmMessageConv.MonsterName.getEndS(), p_70665_2_}));
						}else
						{
							ep.addChatMessage(new ChatComponentTranslation("msg.toDamage.txt",new Object[] {EnumDqmMessageConv.MonsterName.getStartS() + this.getEntityString() + EnumDqmMessageConv.MonsterName.getEndS(), p_70665_2_}));
						}
						*/
					}
...
=======
			...
			((MagicEntityMera) magic[0]).setWorldFlg(DQR.conf.magicSpHonoo == 1 && rand.nextInt(10) == 0);
...
=======
				...
				((MagicEntityMerami) magic[cnt]).setWorldFlg(DQR.conf.magicSpHonoo == 1 && rand.nextInt(10) == 0);
>>>>>>> parent of 2aede75... ver0.8.7.8
			}
...
=======
				...
				((MagicEntityMerazoma) magic[cnt]).setWorldFlg(DQR.conf.magicSpHonoo == 1 && rand.nextInt(10) == 0);
>>>>>>> parent of 2aede75... ver0.8.7.8
			}
			/*
	   		minusMP = 38;
