...
public class DqmEntityZoma extends DqmMobBaseBoss
{
	...
	public DqmEntityZoma(World world)
	{
		super(world, EnumDqmMonster.ZOMA );

		//this.monsterType = EnumDqmMonster.ZOMA;
	...
	{
		return EnumDqmMonster.ZOMA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ZOMA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ZOMA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ZOMA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ZOMA.getDF();
    }
