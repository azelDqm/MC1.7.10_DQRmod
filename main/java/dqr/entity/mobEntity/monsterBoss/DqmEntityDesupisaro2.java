...
public class DqmEntityDesupisaro2 extends DqmMobBaseBoss
{

	public DqmEntityDesupisaro2(World world)
	{
		super(world, EnumDqmMonster.DESUPISARO2 );

		//this.monsterType = EnumDqmMonster.DESUPISARO2;
	...
	{
		return EnumDqmMonster.DESUPISARO2.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DESUPISARO2.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DESUPISARO2.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DESUPISARO2.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DESUPISARO2.getDF();
    }
