...
public class DqmEntityMetaruburazazu extends DqmMobBaseMetaru
{

	public DqmEntityMetaruburazazu(World world)
	{
		super(world, EnumDqmMonster.METARUBURAZAZU );

		//this.monsterType = EnumDqmMonster.METARUBURAZAZU;
	...
	{
		return EnumDqmMonster.METARUBURAZAZU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.METARUBURAZAZU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.METARUBURAZAZU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.METARUBURAZAZU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.METARUBURAZAZU.getDF();
    }
