...
public class DqmEntityMetasura extends DqmMobBaseMetaru
{

	public DqmEntityMetasura(World world)
	{
		super(world, EnumDqmMonster.METASURA );

		//this.monsterType = EnumDqmMonster.METASURA;
	...
	{
		return EnumDqmMonster.METASURA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.METASURA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.METASURA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.METASURA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.METASURA.getDF();
    }
