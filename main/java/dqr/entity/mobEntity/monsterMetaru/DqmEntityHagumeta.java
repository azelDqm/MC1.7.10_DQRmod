...
public class DqmEntityHagumeta extends DqmMobBaseMetaru
{

	public DqmEntityHagumeta(World world)
	{
		super(world, EnumDqmMonster.HAGUMETA );

		//this.monsterType = EnumDqmMonster.HAGUMETA;
	...
	{
		return EnumDqmMonster.HAGUMETA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HAGUMETA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HAGUMETA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HAGUMETA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HAGUMETA.getDF();
    }
