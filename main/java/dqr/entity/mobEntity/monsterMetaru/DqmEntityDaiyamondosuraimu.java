...
public class DqmEntityDaiyamondosuraimu extends DqmMobBaseMetaru
{

	public DqmEntityDaiyamondosuraimu(World world)
	{
		super(world, EnumDqmMonster.DAIYAMONDOSURAIMU );

		//this.monsterType = EnumDqmMonster.DAIYAMONDOSURAIMU;
	...
	{
		return EnumDqmMonster.DAIYAMONDOSURAIMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DAIYAMONDOSURAIMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DAIYAMONDOSURAIMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DAIYAMONDOSURAIMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DAIYAMONDOSURAIMU.getDF();
    }
