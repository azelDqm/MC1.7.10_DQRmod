...
public class DqmEntityEriminator extends DqmMobBaseHell
{

	public DqmEntityEriminator(World world)
	{
		super(world, EnumDqmMonster.ERIMINATOR );
	...
	{
		return EnumDqmMonster.ERIMINATOR.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ERIMINATOR.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ERIMINATOR.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ERIMINATOR.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ERIMINATOR.getDF();
    }
