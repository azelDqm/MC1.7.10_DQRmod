...
public class DqmEntityBighanma extends DqmMobBaseHell
{

	public DqmEntityBighanma(World world)
	{
		super(world, EnumDqmMonster.BIGHANMA );

		//this.monsterType = EnumDqmMonster.BIGHANMA;
	...
	{
		return EnumDqmMonster.BIGHANMA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BIGHANMA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BIGHANMA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BIGHANMA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BIGHANMA.getDF();
    }
