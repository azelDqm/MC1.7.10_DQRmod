...
public class DqmEntitySodofantomu extends DqmMobBaseHell
{

	public DqmEntitySodofantomu(World world)
	{
		super(world, EnumDqmMonster.SODOFANTOMU );

		//this.monsterType = EnumDqmMonster.SODOFANTOMU;
	...
	{
		return EnumDqmMonster.SODOFANTOMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SODOFANTOMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SODOFANTOMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SODOFANTOMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SODOFANTOMU.getDF();
    }
