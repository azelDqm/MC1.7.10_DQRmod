...
public class DqmEntityGoremu extends DqmMobBaseHell
{

	public DqmEntityGoremu(World world)
	{
		super(world, EnumDqmMonster.GOREMU );

		//this.monsterType = EnumDqmMonster.GOREMU;
	...
	{
		return EnumDqmMonster.GOREMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GOREMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GOREMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GOREMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GOREMU.getDF();
    }
