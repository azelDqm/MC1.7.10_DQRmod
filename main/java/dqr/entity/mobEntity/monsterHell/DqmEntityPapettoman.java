...
public class DqmEntityPapettoman extends DqmMobBaseHell
{

	public DqmEntityPapettoman(World world)
	{
		super(world, EnumDqmMonster.PAPETTOMAN );

		//this.monsterType = EnumDqmMonster.PAPETTOMAN;
	...
	{
		return EnumDqmMonster.PAPETTOMAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PAPETTOMAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PAPETTOMAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PAPETTOMAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PAPETTOMAN.getDF();
    }
