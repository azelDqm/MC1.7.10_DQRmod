...
public class DqmEntityBariidodog extends DqmMobBaseHell
{

	public DqmEntityBariidodog(World world)
	{
		super(world, EnumDqmMonster.BARIIDODOG );

		//this.monsterType = EnumDqmMonster.BARIIDODOG;
	...
	{
		return EnumDqmMonster.BARIIDODOG.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BARIIDODOG.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BARIIDODOG.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BARIIDODOG.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BARIIDODOG.getDF();
    }
