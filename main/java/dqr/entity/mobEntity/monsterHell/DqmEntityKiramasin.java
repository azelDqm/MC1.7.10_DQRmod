...
public class DqmEntityKiramasin extends DqmMobBaseHell
{

	public DqmEntityKiramasin(World world)
	{
		super(world, EnumDqmMonster.KIRAMASIN );

		//this.monsterType = EnumDqmMonster.KIRAMASIN;
	...
	{
		return EnumDqmMonster.KIRAMASIN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRAMASIN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRAMASIN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRAMASIN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRAMASIN.getDF();
    }
