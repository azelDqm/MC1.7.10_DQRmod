...
public class DqmEntityAnkokumajin extends DqmMobBaseHell
{

	public DqmEntityAnkokumajin(World world)
	{
		super(world, EnumDqmMonster.ANKOKUMAJIN );

		//this.monsterType = EnumDqmMonster.ANKOKUMAJIN;
	...
	{
		return EnumDqmMonster.ANKOKUMAJIN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.ANKOKUMAJIN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.ANKOKUMAJIN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.ANKOKUMAJIN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.ANKOKUMAJIN.getDF();
    }
