...
public class DqmEntityJigokunohasami extends DqmMobBaseHell
{

	public DqmEntityJigokunohasami(World world)
	{
		super(world, EnumDqmMonster.JIGOKUNOHASAMI );

		//this.monsterType = EnumDqmMonster.JIGOKUNOHASAMI;
	...
	{
		return EnumDqmMonster.JIGOKUNOHASAMI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.JIGOKUNOHASAMI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.JIGOKUNOHASAMI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.JIGOKUNOHASAMI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.JIGOKUNOHASAMI.getDF();
    }
