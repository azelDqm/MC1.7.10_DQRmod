...
public class DqmEntityBoureikensi extends DqmMobBaseHell
{

	public DqmEntityBoureikensi(World world)
	{
		super(world, EnumDqmMonster.BOUREIKENSI );

		//this.monsterType = EnumDqmMonster.BOUREIKENSI;
	...
	{
		return EnumDqmMonster.BOUREIKENSI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BOUREIKENSI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BOUREIKENSI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BOUREIKENSI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BOUREIKENSI.getDF();
    }
    ...
    {
        if (DQR.funcMob.getCalcDROP(16, 1))
        {
        ...
        {
            this.dropItem(DQWeapons.itemKoorinoyaiba, 1);
        }
