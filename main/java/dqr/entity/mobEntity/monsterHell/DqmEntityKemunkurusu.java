...
public class DqmEntityKemunkurusu extends DqmMobBaseHell
{

	public DqmEntityKemunkurusu(World world)
	{
		super(world, EnumDqmMonster.KEMUNKURUSU );

		//this.monsterType = EnumDqmMonster.KEMUNKURUSU;
	...
	{
		return EnumDqmMonster.KEMUNKURUSU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KEMUNKURUSU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KEMUNKURUSU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KEMUNKURUSU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KEMUNKURUSU.getDF();
    }
