...
public class DqmEntityBaburuking extends DqmMobBaseHell
{

	public DqmEntityBaburuking(World world)
	{
		super(world, EnumDqmMonster.BABURUKING );

		//this.monsterType = EnumDqmMonster.BABURUKING;
	...
	{
		return EnumDqmMonster.BABURUKING.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BABURUKING.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BABURUKING.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BABURUKING.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BABURUKING.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemDokudokuhedoro, 1);
        }
        if (DQR.funcMob.getCalcDROP(2, 1))
        {
            this.dropItem(DQMiscs.itemDokuganokona, 1);
        }
        if (DQR.funcMob.getCalcDROP(2, 1))
        {
            this.dropItem(DQMiscs.itemBekkou, 1);
        }
        if (DQR.funcMob.getCalcDROP(6, 1))
        {
            this.dropItem(DQMiscs.itemGamanoabura, 1);
        }
