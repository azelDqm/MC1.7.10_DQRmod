...
public class DqmEntityDoragonsoruja extends DqmMobBaseHell
{

	public DqmEntityDoragonsoruja(World world)
	{
		super(world, EnumDqmMonster.DORAGONSORUJA );

		//this.monsterType = EnumDqmMonster.DORAGONSORUJA;
	...
	{
		return EnumDqmMonster.DORAGONSORUJA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DORAGONSORUJA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DORAGONSORUJA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DORAGONSORUJA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DORAGONSORUJA.getDF();
    }
