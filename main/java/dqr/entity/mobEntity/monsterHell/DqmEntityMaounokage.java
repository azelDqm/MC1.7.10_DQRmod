...
public class DqmEntityMaounokage extends DqmMobBaseHell
{

	public DqmEntityMaounokage(World world)
	{
		super(world, EnumDqmMonster.MAOUNOKAGE );

		//this.monsterType = EnumDqmMonster.MAOUNOKAGE;
	...
	{
		return EnumDqmMonster.MAOUNOKAGE.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MAOUNOKAGE.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MAOUNOKAGE.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MAOUNOKAGE.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MAOUNOKAGE.getDF();
    }
