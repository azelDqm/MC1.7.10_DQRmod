...
public class DqmEntityBurakkubejita extends DqmMobBaseHell
{

	public DqmEntityBurakkubejita(World world)
	{
		super(world, EnumDqmMonster.BURAKKUBEJITA );

		//this.monsterType = EnumDqmMonster.BURAKKUBEJITA;
	...
	{
		return EnumDqmMonster.BURAKKUBEJITA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BURAKKUBEJITA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BURAKKUBEJITA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BURAKKUBEJITA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BURAKKUBEJITA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQIngots.itemBakudanisi, 1);
        }
        if (DQR.funcMob.getCalcDROP(500, 1))
        {
            this.dropItem(DQWeapons.itemToraidento, 1);
        }
