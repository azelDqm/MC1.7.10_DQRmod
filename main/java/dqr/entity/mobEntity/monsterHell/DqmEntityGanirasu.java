...
public class DqmEntityGanirasu extends DqmMobBaseHell
{

	public DqmEntityGanirasu(World world)
	{
		super(world, EnumDqmMonster.GANIRASU );

		//this.monsterType = EnumDqmMonster.GANIRASU;
	...
	{
		return EnumDqmMonster.GANIRASU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GANIRASU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GANIRASU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GANIRASU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GANIRASU.getDF();
    }
