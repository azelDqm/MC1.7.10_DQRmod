...
public class DqmEntityMegazarurokku extends DqmMobBaseHell
{

	public DqmEntityMegazarurokku(World world)
	{
		super(world, EnumDqmMonster.MEGAZARUROKKU );

		//this.monsterType = EnumDqmMonster.MEGAZARUROKKU;
	...
	{
		return EnumDqmMonster.MEGAZARUROKKU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MEGAZARUROKKU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MEGAZARUROKKU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MEGAZARUROKKU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MEGAZARUROKKU.getDF();
    }
