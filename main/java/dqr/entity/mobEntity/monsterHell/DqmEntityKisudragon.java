...
public class DqmEntityKisudragon extends DqmMobBaseHell
{

	public DqmEntityKisudragon(World world)
	{
		super(world, EnumDqmMonster.KISUDRAGON );

		//this.monsterType = EnumDqmMonster.KISUDRAGON;
	...
	{
		return EnumDqmMonster.KISUDRAGON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KISUDRAGON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KISUDRAGON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KISUDRAGON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KISUDRAGON.getDF();
    }
