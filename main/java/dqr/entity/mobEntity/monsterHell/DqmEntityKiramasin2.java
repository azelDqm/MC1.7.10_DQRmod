...
public class DqmEntityKiramasin2 extends DqmMobBaseHell
{

	public DqmEntityKiramasin2(World world)
	{
		super(world, EnumDqmMonster.KIRAMASIN2 );

		//this.monsterType = EnumDqmMonster.KIRAMASIN2;
	...
	{
		return EnumDqmMonster.KIRAMASIN2.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRAMASIN2.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRAMASIN2.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRAMASIN2.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRAMASIN2.getDF();
    }
