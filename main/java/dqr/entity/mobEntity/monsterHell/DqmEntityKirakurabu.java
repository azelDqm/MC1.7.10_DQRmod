...
public class DqmEntityKirakurabu extends DqmMobBaseHell
{

	public DqmEntityKirakurabu(World world)
	{
		super(world, EnumDqmMonster.KIRAKURABU );

		//this.monsterType = EnumDqmMonster.KIRAKURABU;
	...
	{
		return EnumDqmMonster.KIRAKURABU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRAKURABU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRAKURABU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRAKURABU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRAKURABU.getDF();
    }
