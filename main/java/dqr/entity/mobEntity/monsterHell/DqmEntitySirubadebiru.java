...
public class DqmEntitySirubadebiru extends DqmMobBaseHell
{

	public DqmEntitySirubadebiru(World world)
	{
		super(world, EnumDqmMonster.SIRUBADEBIRU );

		//this.monsterType = EnumDqmMonster.SIRUBADEBIRU;
	...
	{
		return EnumDqmMonster.SIRUBADEBIRU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIRUBADEBIRU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIRUBADEBIRU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIRUBADEBIRU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIRUBADEBIRU.getDF();
    }
