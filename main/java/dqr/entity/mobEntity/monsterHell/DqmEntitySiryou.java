...
public class DqmEntitySiryou extends DqmMobBaseHell
{

	public DqmEntitySiryou(World world)
	{
		super(world, EnumDqmMonster.SIRYOU );

		//this.monsterType = EnumDqmMonster.SIRYOU;
	...
	{
		return EnumDqmMonster.SIRYOU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIRYOU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIRYOU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIRYOU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIRYOU.getDF();
    }
