...
public class DqmEntityPikusi extends DqmMobBaseHell
{

	public DqmEntityPikusi(World world)
	{
		super(world, EnumDqmMonster.PIKUSI );

		//this.monsterType = EnumDqmMonster.PIKUSI;
	...
	{
		return EnumDqmMonster.PIKUSI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PIKUSI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PIKUSI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PIKUSI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PIKUSI.getDF();
    }
