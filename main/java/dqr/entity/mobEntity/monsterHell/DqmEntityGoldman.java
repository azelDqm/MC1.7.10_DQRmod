...
public class DqmEntityGoldman extends DqmMobBaseHell
{

	public DqmEntityGoldman(World world)
	{
		super(world, EnumDqmMonster.GOLDMAN );

		//this.monsterType = EnumDqmMonster.GOLDMAN;
	...
	{
		return EnumDqmMonster.GOLDMAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GOLDMAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GOLDMAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GOLDMAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GOLDMAN.getDF();
    }
