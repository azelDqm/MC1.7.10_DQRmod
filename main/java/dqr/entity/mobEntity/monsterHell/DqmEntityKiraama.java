...
public class DqmEntityKiraama extends DqmMobBaseHell
{

	public DqmEntityKiraama(World world)
	{
		super(world, EnumDqmMonster.KIRAAMA );

		//this.monsterType = EnumDqmMonster.KIRAAMA;
	...
	{
		return EnumDqmMonster.KIRAAMA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIRAAMA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIRAAMA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIRAAMA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIRAAMA.getDF();
    }
