...
public class DqmEntityDarkdoriado extends DqmMobBaseHell
{

	public DqmEntityDarkdoriado(World world)
	{
		super(world, EnumDqmMonster.DARKDORIADO );

		//this.monsterType = EnumDqmMonster.DARKDORIADO;
	...
	{
		return EnumDqmMonster.DARKDORIADO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DARKDORIADO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DARKDORIADO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DARKDORIADO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DARKDORIADO.getDF();
    }
