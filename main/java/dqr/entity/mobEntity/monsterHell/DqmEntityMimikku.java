...
public class DqmEntityMimikku extends DqmMobBaseHell
{

	public DqmEntityMimikku(World world)
	{
		super(world, EnumDqmMonster.MIMIKKU );

		//this.monsterType = EnumDqmMonster.MIMIKKU;
	...
	{
		return EnumDqmMonster.MIMIKKU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MIMIKKU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MIMIKKU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MIMIKKU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MIMIKKU.getDF();
    }
