...
public class DqmEntityMagemomonja extends DqmMobBaseHell
{

	public DqmEntityMagemomonja(World world)
	{
		super(world, EnumDqmMonster.MAGEMOMONJA );

		//this.monsterType = EnumDqmMonster.MAGEMOMONJA;
	...
	{
		return EnumDqmMonster.MAGEMOMONJA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MAGEMOMONJA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MAGEMOMONJA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MAGEMOMONJA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MAGEMOMONJA.getDF();
    }
