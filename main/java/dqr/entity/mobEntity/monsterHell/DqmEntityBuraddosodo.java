...
public class DqmEntityBuraddosodo extends DqmMobBaseHell
{

	public DqmEntityBuraddosodo(World world)
	{
		super(world, EnumDqmMonster.BURADDOSODO );

		//this.monsterType = EnumDqmMonster.BURADDOSODO;
	...
	{
		return EnumDqmMonster.BURADDOSODO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BURADDOSODO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BURADDOSODO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BURADDOSODO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BURADDOSODO.getDF();
    }
