...
public class DqmEntityRedsaikuron extends DqmMobBaseHell
{

	public DqmEntityRedsaikuron(World world)
	{
		super(world, EnumDqmMonster.REDSAIKURON );

		//this.monsterType = EnumDqmMonster.REDSAIKURON;
	...
	{
		return EnumDqmMonster.REDSAIKURON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.REDSAIKURON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.REDSAIKURON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.REDSAIKURON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.REDSAIKURON.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQAccessories.itemHayatenoring, 1);
        }
