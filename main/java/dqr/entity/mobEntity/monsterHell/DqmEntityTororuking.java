...
public class DqmEntityTororuking extends DqmMobBaseHell
{

	public DqmEntityTororuking(World world)
	{
		super(world, EnumDqmMonster.TORORUKING );

		//this.monsterType = EnumDqmMonster.TORORUKING;
	...
	{
		return EnumDqmMonster.TORORUKING.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.TORORUKING.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.TORORUKING.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.TORORUKING.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.TORORUKING.getDF();
    }
