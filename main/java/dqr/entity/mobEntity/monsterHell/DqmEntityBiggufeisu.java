...
public class DqmEntityBiggufeisu extends DqmMobBaseHell
{

	public DqmEntityBiggufeisu(World world)
	{
		super(world, EnumDqmMonster.BIGGUFEISU );

		//this.monsterType = EnumDqmMonster.BIGGUFEISU;
	...
	{
		return EnumDqmMonster.BIGGUFEISU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BIGGUFEISU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BIGGUFEISU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BIGGUFEISU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BIGGUFEISU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQAccessories.itemHaganenotate, 1);
        }
