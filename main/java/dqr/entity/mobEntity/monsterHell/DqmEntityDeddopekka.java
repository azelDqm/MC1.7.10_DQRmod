...
public class DqmEntityDeddopekka extends DqmMobBaseHell
{

	public DqmEntityDeddopekka(World world)
	{
		super(world, EnumDqmMonster.DEDDOPEKKA );

		//this.monsterType = EnumDqmMonster.DEDDOPEKKA;
	...
	{
		return EnumDqmMonster.DEDDOPEKKA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DEDDOPEKKA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DEDDOPEKKA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DEDDOPEKKA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DEDDOPEKKA.getDF();
    }
