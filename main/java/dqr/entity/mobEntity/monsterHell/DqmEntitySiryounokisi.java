...
public class DqmEntitySiryounokisi extends DqmMobBaseHell
{

	public DqmEntitySiryounokisi(World world)
	{
		super(world, EnumDqmMonster.SIRYOUNOKISI );

		//this.monsterType = EnumDqmMonster.SIRYOUNOKISI;
	...
	{
		return EnumDqmMonster.SIRYOUNOKISI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SIRYOUNOKISI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SIRYOUNOKISI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SIRYOUNOKISI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SIRYOUNOKISI.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemYogoretahoutai, 1);
        }
        ...
        {
            this.dropItem(DQMiscs.itemMajuunotuno, 1);
        }
