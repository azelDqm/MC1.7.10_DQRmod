...
public class DqmEntityAroinpu extends DqmMobBaseHell
{

	public DqmEntityAroinpu(World world)
	{
		super(world, EnumDqmMonster.AROINPU );

		//this.monsterType = EnumDqmMonster.AROINPU;
	...
	{
		return EnumDqmMonster.AROINPU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.AROINPU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.AROINPU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.AROINPU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.AROINPU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemSefiramunoyumi, 1);
        }
