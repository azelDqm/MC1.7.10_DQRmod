...
public class DqmEntitySuraimuhaitawa extends DqmMobBaseHell
{

	public DqmEntitySuraimuhaitawa(World world)
	{
		super(world, EnumDqmMonster.SURAIMUHAITAWA );

		//this.monsterType = EnumDqmMonster.SURAIMUHAITAWA;
	...
	{
		return EnumDqmMonster.SURAIMUHAITAWA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUHAITAWA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUHAITAWA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUHAITAWA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUHAITAWA.getDF();
    }
