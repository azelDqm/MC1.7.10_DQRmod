...
public class DqmEntityMetaruhanta extends DqmMobBaseHell
{

	public DqmEntityMetaruhanta(World world)
	{
		super(world, EnumDqmMonster.METARUHANTA );

		//this.monsterType = EnumDqmMonster.METARUHANTA;
	...
	{
		return EnumDqmMonster.METARUHANTA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.METARUHANTA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.METARUHANTA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.METARUHANTA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.METARUHANTA.getDF();
    }
