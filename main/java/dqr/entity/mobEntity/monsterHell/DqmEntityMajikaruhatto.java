...
public class DqmEntityMajikaruhatto extends DqmMobBaseHell
{

	public DqmEntityMajikaruhatto(World world)
	{
		super(world, EnumDqmMonster.MAJIKARUHATTO );

		//this.monsterType = EnumDqmMonster.MAJIKARUHATTO;
	...
	{
		return EnumDqmMonster.MAJIKARUHATTO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MAJIKARUHATTO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MAJIKARUHATTO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MAJIKARUHATTO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MAJIKARUHATTO.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemMaryokunotuti, 1);
        }
        if (DQR.funcMob.getCalcDROP(300, 1))
        {
            this.dropItem(DQArmors.itemKenjanobousi, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
            this.dropItem(DQIngots.itemKoorinokessyou, 1);
        }
