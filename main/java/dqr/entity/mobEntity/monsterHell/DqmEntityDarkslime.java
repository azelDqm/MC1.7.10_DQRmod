...
public class DqmEntityDarkslime extends DqmMobBaseHell
{

	public DqmEntityDarkslime(World world)
	{
		super(world, EnumDqmMonster.DARKSLIME );

		//this.monsterType = EnumDqmMonster.DARKSLIME;
	...
	{
		return EnumDqmMonster.DARKSLIME.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DARKSLIME.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DARKSLIME.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DARKSLIME.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DARKSLIME.getDF();
    }
