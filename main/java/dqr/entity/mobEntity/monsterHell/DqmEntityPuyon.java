...
public class DqmEntityPuyon extends DqmMobBaseHell
{

	public DqmEntityPuyon(World world)
	{
		super(world, EnumDqmMonster.PUYON );

		//this.monsterType = EnumDqmMonster.PUYON;
	...
	{
		return EnumDqmMonster.PUYON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.PUYON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.PUYON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.PUYON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.PUYON.getDF();
    }
