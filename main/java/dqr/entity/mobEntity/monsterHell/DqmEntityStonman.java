...
public class DqmEntityStonman extends DqmMobBaseHell
{

	public DqmEntityStonman(World world)
	{
		super(world, EnumDqmMonster.STONMAN );

		//this.monsterType = EnumDqmMonster.STONMAN;
	...
	{
		return EnumDqmMonster.STONMAN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.STONMAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.STONMAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.STONMAN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.STONMAN.getDF();
    }
