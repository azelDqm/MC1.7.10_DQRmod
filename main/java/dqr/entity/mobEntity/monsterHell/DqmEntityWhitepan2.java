...
public class DqmEntityWhitepan2 extends DqmMobBaseHell
{

	public DqmEntityWhitepan2(World world)
	{
		super(world, EnumDqmMonster.WHITEPAN2 );

		//this.monsterType = EnumDqmMonster.KIRAPAN;
	...
	{
		return EnumDqmMonster.WHITEPAN2.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.WHITEPAN2.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.WHITEPAN2.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.WHITEPAN2.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.WHITEPAN2.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQWeapons.itemPapasunoturugi, 1);
        }
        if (DQR.funcMob.getCalcDROP(4, 1))
        {
            this.dropItem(DQMiscs.itemKyodainakiba, 1);
        }
