...
public class DqmEntityBosutororu extends DqmMobBaseHell
{

	public DqmEntityBosutororu(World world)
	{
		super(world, EnumDqmMonster.BOSUTORORU );

		//this.monsterType = EnumDqmMonster.BOSUTORORU;
	...
	{
		return EnumDqmMonster.BOSUTORORU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BOSUTORORU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BOSUTORORU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BOSUTORORU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BOSUTORORU.getDF();
    }
