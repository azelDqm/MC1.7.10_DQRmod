...
public class DqmEntitySuraimumadyura extends DqmMobBaseHell
{

	public DqmEntitySuraimumadyura(World world)
	{
		super(world, EnumDqmMonster.SURAIMUMADYURA );

		//this.monsterType = EnumDqmMonster.SURAIMUMADYURA;
	...
	{
		return EnumDqmMonster.SURAIMUMADYURA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUMADYURA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUMADYURA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUMADYURA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUMADYURA.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQR.funcMob.getCalcDROP(2000, 1))
        {
