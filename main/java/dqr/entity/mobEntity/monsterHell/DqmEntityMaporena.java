...
public class DqmEntityMaporena extends DqmMobBaseHell
{

	public DqmEntityMaporena(World world)
	{
		super(world, EnumDqmMonster.MAPORENA );

		//this.monsterType = EnumDqmMonster.MAPORENA;
	...
	{
		return EnumDqmMonster.MAPORENA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MAPORENA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MAPORENA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MAPORENA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MAPORENA.getDF();
    }
