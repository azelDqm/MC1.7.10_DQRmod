...
public class DqmEntityBarakku extends DqmMobBaseHell
{

	public DqmEntityBarakku(World world)
	{
		super(world, EnumDqmMonster.BARAKKU );

		//this.monsterType = EnumDqmMonster.BARAKKU;
	...
	{
		return EnumDqmMonster.BARAKKU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BARAKKU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BARAKKU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BARAKKU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BARAKKU.getDF();
    }
