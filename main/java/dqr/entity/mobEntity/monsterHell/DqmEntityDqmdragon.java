...
public class DqmEntityDqmdragon extends DqmMobBaseHell
{

	public DqmEntityDqmdragon(World world)
	{
		super(world, EnumDqmMonster.DQMDRAGON );

		//this.monsterType = EnumDqmMonster.DQMDRAGON;
	...
	{
		return EnumDqmMonster.DQMDRAGON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DQMDRAGON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DQMDRAGON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DQMDRAGON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DQMDRAGON.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemHebinonukegara, 1);
        }
        ...
        {
            this.dropItem(DQAccessories.itemRyuunouroko, 1);
        }
