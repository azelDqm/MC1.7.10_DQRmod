...
public class DqmEntityGorudentotemu extends DqmMobBaseHell
{

	public DqmEntityGorudentotemu(World world)
	{
		super(world, EnumDqmMonster.GORUDENTOTEMU );

		//this.monsterType = EnumDqmMonster.GORUDENTOTEMU;
	...
	{
		return EnumDqmMonster.GORUDENTOTEMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.GORUDENTOTEMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.GORUDENTOTEMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.GORUDENTOTEMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.GORUDENTOTEMU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQIngots.itemMoon, 1);
        }
