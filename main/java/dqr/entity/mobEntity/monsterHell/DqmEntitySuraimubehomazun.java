...
public class DqmEntitySuraimubehomazun extends DqmMobBaseHell
{

	public DqmEntitySuraimubehomazun(World world)
	{
		super(world, EnumDqmMonster.SURAIMUBEHOMAZUN );

		//this.monsterType = EnumDqmMonster.SURAIMUBEHOMAZUN;
	...
	{
		return EnumDqmMonster.SURAIMUBEHOMAZUN.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUBEHOMAZUN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SURAIMUBEHOMAZUN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SURAIMUBEHOMAZUN.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SURAIMUBEHOMAZUN.getDF();
    }
