...
public class DqmEntityMagematango extends DqmMobBaseHell
{

	public DqmEntityMagematango(World world)
	{
		super(world, EnumDqmMonster.MAGEMATANGO );

		//this.monsterType = EnumDqmMonster.MAGEMATANGO;
	...
	{
		return EnumDqmMonster.MAGEMATANGO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MAGEMATANGO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MAGEMATANGO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MAGEMATANGO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MAGEMATANGO.getDF();
    }
