...
public class DqmEntityKimendousi extends DqmMobBaseHell
{

	public DqmEntityKimendousi(World world)
	{
		super(world, EnumDqmMonster.KIMENDOUSI );

		//this.monsterType = EnumDqmMonster.KIMENDOUSI;
	...
	{
		return EnumDqmMonster.KIMENDOUSI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.KIMENDOUSI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.KIMENDOUSI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.KIMENDOUSI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.KIMENDOUSI.getDF();
    }
