...
public class DqmEntitySaikuropusu extends DqmMobBaseHell
{

	public DqmEntitySaikuropusu(World world)
	{
		super(world, EnumDqmMonster.SAIKUROPUSU );

		//this.monsterType = EnumDqmMonster.SAIKUROPUSU;
	...
	{
		return EnumDqmMonster.SAIKUROPUSU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.SAIKUROPUSU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.SAIKUROPUSU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.SAIKUROPUSU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.SAIKUROPUSU.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemBudouekisu, 1);
        }
