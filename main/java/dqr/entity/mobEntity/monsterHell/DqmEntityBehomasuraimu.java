...
public class DqmEntityBehomasuraimu extends DqmMobBaseHell
{

	public DqmEntityBehomasuraimu(World world)
	{
		super(world, EnumDqmMonster.BEHOMASURAIMU );

		//this.monsterType = EnumDqmMonster.BEHOMASURAIMU;
	...
	{
		return EnumDqmMonster.BEHOMASURAIMU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.BEHOMASURAIMU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.BEHOMASURAIMU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.BEHOMASURAIMU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.BEHOMASURAIMU.getDF();
    }
