...
public class DqmEntityPombom extends DqmMobBaseHell
{

	public DqmEntityPombom(World world)
	{
		super(world, EnumDqmMonster.POMBOM );

		//this.monsterType = EnumDqmMonster.POMBOM;
	...
	{
		return EnumDqmMonster.POMBOM.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.POMBOM.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.POMBOM.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.POMBOM.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.POMBOM.getDF();
    }
