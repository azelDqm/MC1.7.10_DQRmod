...
public class DqmEntityUmibouzu extends DqmMobBaseHell
{

	public DqmEntityUmibouzu(World world)
	{
		super(world, EnumDqmMonster.UMIBOUZU );

		//this.monsterType = EnumDqmMonster.UMIBOUZU;
	...
	{
		return EnumDqmMonster.UMIBOUZU.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.UMIBOUZU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.UMIBOUZU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.UMIBOUZU.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.UMIBOUZU.getDF();
    }
