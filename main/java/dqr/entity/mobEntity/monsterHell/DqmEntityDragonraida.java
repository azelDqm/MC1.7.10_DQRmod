...
public class DqmEntityDragonraida extends DqmMobBaseHell
{

	public DqmEntityDragonraida(World world)
	{
		super(world, EnumDqmMonster.DRAGONRAIDA );

		//this.monsterType = EnumDqmMonster.DRAGONRAIDA;
	...
	{
		return EnumDqmMonster.DRAGONRAIDA.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DRAGONRAIDA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DRAGONRAIDA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DRAGONRAIDA.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DRAGONRAIDA.getDF();
    }
