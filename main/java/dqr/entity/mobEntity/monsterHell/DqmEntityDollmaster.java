...
public class DqmEntityDollmaster extends DqmMobBaseHell
{

	public DqmEntityDollmaster(World world)
	{
		super(world, EnumDqmMonster.DOLLMASTER );

		//this.monsterType = EnumDqmMonster.DOLLMASTER;
	...
	{
		return EnumDqmMonster.DOLLMASTER.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DOLLMASTER.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DOLLMASTER.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DOLLMASTER.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DOLLMASTER.getDF();
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQMiscs.itemTukinomegumi, 1);
        }
