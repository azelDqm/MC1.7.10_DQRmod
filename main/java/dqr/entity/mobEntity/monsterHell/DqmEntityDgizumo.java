...
public class DqmEntityDgizumo extends DqmMobBaseHell
{

	public DqmEntityDgizumo(World world)
	{
		super(world, EnumDqmMonster.DGIZUMO );

		//this.monsterType = EnumDqmMonster.DGIZUMO;
	...
	{
		return EnumDqmMonster.DGIZUMO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DGIZUMO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DGIZUMO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DGIZUMO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DGIZUMO.getDF();
    }
