...
public class DqmEntityDragonnaito extends DqmMobBaseHell
{

	public DqmEntityDragonnaito(World world)
	{
		super(world, EnumDqmMonster.DRAGONNAITO );

		//this.monsterType = EnumDqmMonster.DRAGONNAITO;
	...
	{
		return EnumDqmMonster.DRAGONNAITO.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.DRAGONNAITO.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.DRAGONNAITO.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.DRAGONNAITO.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.DRAGONNAITO.getDF();
    }
