...
public class DqmEntityHotatewarabi extends DqmMobBaseHell
{

	public DqmEntityHotatewarabi(World world)
	{
		super(world, EnumDqmMonster.HOTATEWARABI );

		//this.monsterType = EnumDqmMonster.HOTATEWARABI;
	...
	{
		return EnumDqmMonster.HOTATEWARABI.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.HOTATEWARABI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.HOTATEWARABI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.HOTATEWARABI.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.HOTATEWARABI.getDF();
    }
