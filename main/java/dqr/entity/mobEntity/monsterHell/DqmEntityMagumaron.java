...
public class DqmEntityMagumaron extends DqmMobBaseHell
{

	public DqmEntityMagumaron(World world)
	{
		super(world, EnumDqmMonster.MAGUMARON );

		//this.monsterType = EnumDqmMonster.MAGUMARON;
	...
	{
		return EnumDqmMonster.MAGUMARON.isCAI();
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQR.funcMob.getCalcSPEED(EnumDqmMonster.MAGUMARON.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQR.funcMob.getCalcHP(EnumDqmMonster.MAGUMARON.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQR.funcMob.getCalcPW(EnumDqmMonster.MAGUMARON.getPW()));
	}

	@Override
    public int getTotalArmorValue()
    {
        return EnumDqmMonster.MAGUMARON.getDF();
    }
