    ...
    */
    ...
    public boolean interact(EntityPlayer ep)
    {
    	if(!ep.worldObj.isRemote)
    	{
    		...
    		{
    			ep.addChatMessage(new ChatComponentTranslation("msg.shopKaitori.messages.0.txt",new Object[] {}));
...
//    			System.out.println(ep.inventory.getCurrentItem().getDisplayName());
    			...
    			if(syuuriPrice >= 0)
    			{
    				if(!ep.isSneaking())
    				{
	    				ep.addChatMessage(new ChatComponentTranslation("msg.shopKaitori.messages.3.txt",new Object[] {syuuriPrice}));
	    				ep.addChatMessage(new ChatComponentTranslation("msg.shopKaitori.messages.4.txt",new Object[] {}));
	    				ep.worldObj.playSoundAtEntity(ep, "dqr:player.pi", 1.0F, 1.0F);
    				}else
    				{
    					int epGold = ExtendedPlayerProperties.get(ep).getGold();
	    				ep.addChatMessage(new ChatComponentTranslation("msg.shopKaitori.messages.2.txt",new Object[] {syuuriPrice}));
	    				ep.worldObj.playSoundAtEntity(ep, "dqr:player.pi", 1.0F, 1.0F);
    			...
    			{
    				ep.addChatMessage(new ChatComponentTranslation("msg.shopKaitori.messages.1.txt",new Object[] {}));
    				ep.worldObj.playSoundAtEntity(ep, "dqr:player.pi", 1.0F, 1.0F);
    			}
    			ExtendedPlayerProperties.get(ep).setNpcTalk(EnumDqmNpcTalk.KAITORI.getId(), 1);
    		}
