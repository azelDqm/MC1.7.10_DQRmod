...
public class DqmEntityNPCMedalking extends DqmNPCBase
{
    ...
    public DqmEntityNPCMedalking(World par1World)
    {
        super(par1World);
        setSize(0.8F, 1.5F);
        moveSpeed = SP;
    ...
    public boolean interact(EntityPlayer ep)
    {
		if(!ep.worldObj.isRemote)
		{
			...
			if(flg == 0)
			{
				DQR.func.doAddChatMessageFix(ep, new ChatComponentTranslation("msg.medalking.talk.1.txt" ,new Object[] {}));
				ep.worldObj.playSoundAtEntity(ep, "dqr:player.pi", 1.0F, 1.0F);
				ExtendedPlayerProperties.get(ep).setNpcTalk(EnumDqmNpcTalk.MEDALKING.getId(), 1);
			}else if(flg == 1)
			{
				DQR.func.doAddChatMessageFix(ep, new ChatComponentTranslation("msg.medalking.talk.2.txt" ,new Object[] {}));
				ep.worldObj.playSoundAtEntity(ep, "dqr:player.pi", 1.0F, 1.0F);
				ExtendedPlayerProperties.get(ep).setNpcTalk(EnumDqmNpcTalk.MEDALKING.getId(), 2);
			}else if(flg == 2 || flg == 4)
			{
				DQR.func.doAddChatMessageFix(ep, new ChatComponentTranslation("msg.medalking.talk.3.txt" ,new Object[] {}));
				ep.worldObj.playSoundAtEntity(ep, "dqr:player.pi", 1.0F, 1.0F);

				ExtendedPlayerProperties.get(ep).setNpcTalk(EnumDqmNpcTalk.MEDALKING.getId(), 4);
				ep.openGui(DQR.instance, DQR.conf.GuiID_MKWeapon, ep.worldObj, (int)ep.posX, (int)ep.posY, (int)ep.posZ);
