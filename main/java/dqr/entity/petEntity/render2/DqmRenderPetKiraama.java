...
public class DqmRenderPetKiraama extends RenderLiving
{
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/KiraamaPetzzz.png");

	public DqmRenderPetKiraama()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
