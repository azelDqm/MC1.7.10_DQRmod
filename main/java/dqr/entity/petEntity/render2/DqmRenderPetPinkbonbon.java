...
public class DqmRenderPetPinkbonbon extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Pinkbonbon.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/PinkbonbonPetzzz.png");

	public DqmRenderPetPinkbonbon()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
