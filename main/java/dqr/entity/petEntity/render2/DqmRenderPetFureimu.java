...
public class DqmRenderPetFureimu extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/FureimuPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetFureimu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
