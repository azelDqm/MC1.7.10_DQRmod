...
public class DqmRenderPetTororubakkosu extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Tororubakkosu.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/TororubakkosuPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetTororubakkosu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
