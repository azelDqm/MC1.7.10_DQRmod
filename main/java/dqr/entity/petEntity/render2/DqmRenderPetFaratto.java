...
public class DqmRenderPetFaratto extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Faratto.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/FarattoPetzzz.png");

	public DqmRenderPetFaratto()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
