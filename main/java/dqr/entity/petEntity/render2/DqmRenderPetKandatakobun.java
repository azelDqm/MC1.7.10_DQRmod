...
public class DqmRenderPetKandatakobun extends RenderLiving
{
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/KandatakobunPetzzz.png");

	public DqmRenderPetKandatakobun()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
