...
public class DqmRenderPetSamayouyoroi extends RenderLiving
{
	private float scale = 1.8F;
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Samayouyoroi.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/SamayouyoroiPetzzz.png");

	public DqmRenderPetSamayouyoroi()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
