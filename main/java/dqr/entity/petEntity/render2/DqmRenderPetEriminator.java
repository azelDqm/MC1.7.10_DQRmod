...
public class DqmRenderPetEriminator extends RenderLiving
{
	...
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Eriminator.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/EriminatorPetzzz.png");

	public DqmRenderPetEriminator()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
