...
public class DqmRenderPetPapettoman extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/PapettomanPetzzz.png");

	public DqmRenderPetPapettoman()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
