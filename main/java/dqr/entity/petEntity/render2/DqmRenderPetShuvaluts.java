...
public class DqmRenderPetShuvaluts extends RenderLiving
{
	private float scale = 1.8F;
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Shuvaluts.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/ShuvalutsPetzzz.png");

	public DqmRenderPetShuvaluts()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
