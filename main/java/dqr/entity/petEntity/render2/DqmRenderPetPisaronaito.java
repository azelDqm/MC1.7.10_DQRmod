...
public class DqmRenderPetPisaronaito extends RenderLiving
{
	private float scale = 1.8F;
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Pisaronaito.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/PisaronaitoPetzzz.png");

	public DqmRenderPetPisaronaito()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
