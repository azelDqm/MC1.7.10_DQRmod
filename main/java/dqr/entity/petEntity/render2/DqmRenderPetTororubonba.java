...
public class DqmRenderPetTororubonba extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Tororubonba.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/TororubonbaPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetTororubonba()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
