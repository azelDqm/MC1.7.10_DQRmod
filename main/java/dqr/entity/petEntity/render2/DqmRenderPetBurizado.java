...
public class DqmRenderPetBurizado extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/BurizadoPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetBurizado()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
