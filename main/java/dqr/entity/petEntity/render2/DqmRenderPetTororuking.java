...
public class DqmRenderPetTororuking extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Tororuking.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/TororukingPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetTororuking()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
