...
public class DqmRenderPetAxedoragon extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Axedoragon.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/AxedoragonPetzzz.png");

	public DqmRenderPetAxedoragon()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
