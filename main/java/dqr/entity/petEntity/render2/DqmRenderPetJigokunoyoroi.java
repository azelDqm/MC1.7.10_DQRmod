...
public class DqmRenderPetJigokunoyoroi extends RenderLiving
{
	private float scale = 1.8F;
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Jigokunoyoroi.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/JigokunoyoroiPetzzz.png");
	public DqmRenderPetJigokunoyoroi()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
		 * (このRenderと紐付けするModel, このRenderを使うEntityの足元の影の大きさ)
		 */
		super(new DqmModelSamayouyoroi(), 0.5F);
