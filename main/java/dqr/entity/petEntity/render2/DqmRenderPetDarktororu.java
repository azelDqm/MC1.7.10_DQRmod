...
public class DqmRenderPetDarktororu extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Darktororu.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/DarktororuPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetDarktororu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
