...
public class DqmRenderPetTororu extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Tororu.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/TororuPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetTororu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
