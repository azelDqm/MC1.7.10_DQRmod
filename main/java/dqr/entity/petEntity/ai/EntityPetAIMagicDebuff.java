...
public class EntityPetAIMagicDebuff extends EntityAIBase
{
    ...
    public EntityPetAIMagicDebuff(DqmPetBase p_i45314_1_, EnumDqmMagic enumMagic, Potion pot)
    {
