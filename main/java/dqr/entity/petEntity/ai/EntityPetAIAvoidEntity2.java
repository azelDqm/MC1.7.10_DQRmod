...
public class EntityPetAIAvoidEntity2 extends EntityAIBase
{
    public final IEntitySelector field_98218_a = new IEntitySelector()
    {
        ...
        {
            return p_82704_1_.isEntityAlive() && EntityPetAIAvoidEntity2.this.theEntity.getEntitySenses().canSee(p_82704_1_);
        }
    };
    ...
    public EntityPetAIAvoidEntity2(DqmPetBase p_i1616_1_, Class p_i1616_2_, float p_i1616_3_, double p_i1616_4_, double p_i1616_6_)
    {
    ...
    public boolean shouldExecute()
    {
    	...
    	if (this.targetEntityClass == DqmMobBase.class)
        {
        	/*
    	...
    	else if (this.targetEntityClass == EntityPlayer.class)
        {
        	/*
            if (this.theEntity instanceof EntityTameable && ((EntityTameable)this.theEntity).isTamed())
            {
