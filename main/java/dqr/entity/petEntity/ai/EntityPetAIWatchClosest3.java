...
public class EntityPetAIWatchClosest3 extends EntityAIBase
{
    ...
    public EntityPetAIWatchClosest3(EntityLiving p_i1631_1_, Class p_i1631_2_, float p_i1631_3_)
    {
    ...
    public EntityPetAIWatchClosest3(EntityLiving p_i1632_1_, Class p_i1632_2_, float p_i1632_3_, float p_i1632_4_)
    {
    ...
    {
    	if(this.closestEntity instanceof DqmPetBase)
    	{
    		DqmPetBase pet = (DqmPetBase)this.closestEntity;
    		return pet.getIsDeath() ? false : (this.theWatcher.getDistanceSqToEntity(this.closestEntity) > (double)(this.maxDistanceForPlayer * this.maxDistanceForPlayer) ? false : this.lookTime > 0);
    	}else
    	{
