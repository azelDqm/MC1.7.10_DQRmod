...
public class EntityPetAIMagicAttack4 extends EntityAIBase
{
	private final DqmPetBase entityHost;
	private final DqmPetBase parentEntity;
    ...
    public final DqmPetBase rangedAttackEntityHost;
    public EntityLivingBase attackTarget;

    private int rangedAttackTime;

    public EntityPetAIMagicAttack4(DqmPetBase ghast)
    {
    	entityHost = ghast;
    ...
    public EntityPetAIMagicAttack4(DqmPetBase p_i1649_1_, double p_i1649_2_, int p_i1649_4_, float p_i1649_5_)
    {
        this(p_i1649_1_, p_i1649_2_, p_i1649_4_, p_i1649_4_, p_i1649_5_, null);
    }

    public EntityPetAIMagicAttack4(DqmPetBase p_i1649_1_, double p_i1649_2_, int p_i1649_4_, float p_i1649_5_, EnumDqmMagic enumMagic)
    {
        this(p_i1649_1_, p_i1649_2_, p_i1649_4_, p_i1649_4_, p_i1649_5_, enumMagic);
    }

    public EntityPetAIMagicAttack4(DqmPetBase p_i1650_1_, double p_i1650_2_, int p_i1650_4_, int p_i1650_5_, float p_i1650_6_, EnumDqmMagic enumMagic)
    {
    ...
    */
    ...
    public boolean shouldExecute()
    {
        ...
        if(enumMagic == null || this.entityHost.getMP() < enumMagic.getMP())
        {
        	return false;
        }
