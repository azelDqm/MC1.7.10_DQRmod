...
public class DqmRenderPetMetasura extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Metasura.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/MetasuraPetzzz.png");

	public DqmRenderPetMetasura()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
