...
public class DqmRenderPetMagumaron extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Magumaron.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/MagumaronPetzzz.png");

	public DqmRenderPetMagumaron()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
