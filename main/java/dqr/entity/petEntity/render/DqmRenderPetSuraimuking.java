...
public class DqmRenderPetSuraimuking extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/SuraimukingPetzzz.png");

	public DqmRenderPetSuraimuking()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
