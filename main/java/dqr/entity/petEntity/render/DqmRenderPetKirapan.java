...
public class DqmRenderPetKirapan extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Kirapan.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/KirapanPetzzz.png");

	public DqmRenderPetKirapan()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
