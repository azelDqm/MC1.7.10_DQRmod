...
public class DqmRenderPetTyokonuba extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Tyokonuba.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/TyokonubaPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetTyokonuba()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
