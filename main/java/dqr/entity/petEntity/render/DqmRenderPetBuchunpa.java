...
public class DqmRenderPetBuchunpa extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Buchunpa.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/BuchunpaPetzzz.png");

	public DqmRenderPetBuchunpa()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
