...
public class DqmRenderPetGanirasu extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/GanirasuPetzzz.png");

	public DqmRenderPetGanirasu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
