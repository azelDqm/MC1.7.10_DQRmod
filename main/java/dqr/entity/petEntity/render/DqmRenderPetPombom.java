...
public class DqmRenderPetPombom extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Pombom.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/PombomPetzzz.png");

	public DqmRenderPetPombom()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
