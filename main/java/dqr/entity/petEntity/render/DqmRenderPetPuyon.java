...
public class DqmRenderPetPuyon extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/PuyonPetzzz.png");

	public DqmRenderPetPuyon()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
