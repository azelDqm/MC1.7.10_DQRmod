...
public class DqmRenderPetBurakkubejita extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/BurakkubejitaPetzzz.png");

	public DqmRenderPetBurakkubejita()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
