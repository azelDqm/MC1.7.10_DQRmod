...
public class DqmRenderPetDgizumo extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Dgizumo.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/DgizumoPetzzz.png");

	public DqmRenderPetDgizumo()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
