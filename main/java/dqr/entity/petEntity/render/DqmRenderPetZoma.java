...
public class DqmRenderPetZoma extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/ZomaPetzzz.png");
	private float scale = 1.7F;
	public DqmRenderPetZoma()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
