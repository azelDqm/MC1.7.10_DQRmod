...
public class DqmRenderPetSirudokozou extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Sirudokozou.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/SirudokozouPetzzz.png");
	private float scale = 0.7F;
	public DqmRenderPetSirudokozou()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
