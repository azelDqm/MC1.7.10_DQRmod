...
public class DqmRenderPetPuratinaking extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Puratinaking.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/PuratinakingPetzzz.png");

	public DqmRenderPetPuratinaking()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
