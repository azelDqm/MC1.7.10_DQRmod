...
public class DqmRenderPetAyasiikage extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/AyasiikagePetzzz.png");

	public DqmRenderPetAyasiikage()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
