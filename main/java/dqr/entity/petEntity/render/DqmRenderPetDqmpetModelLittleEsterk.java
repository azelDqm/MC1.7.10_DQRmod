...
public class DqmRenderPetDqmpetModelLittleEsterk extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/LittleEsterkPetzzz.png");

	public DqmRenderPetDqmpetModelLittleEsterk()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
