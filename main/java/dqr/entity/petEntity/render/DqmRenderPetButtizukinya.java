...
public class DqmRenderPetButtizukinya extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/ButtizukinyaPetzzz.png");

	public DqmRenderPetButtizukinya()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
