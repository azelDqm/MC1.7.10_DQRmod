...
public class DqmRenderPetDakuhobitto extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Dakuhobitto.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/DakuhobittoPetzzz.png");
	private float scale = 0.7F;

	public DqmRenderPetDakuhobitto()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
