...
public class DqmRenderPetUmibouzu extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Umibouzu.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/UmibouzuPetzzz.png");

	public DqmRenderPetUmibouzu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
