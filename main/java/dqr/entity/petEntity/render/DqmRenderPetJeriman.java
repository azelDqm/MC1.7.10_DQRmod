...
public class DqmRenderPetJeriman extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/JerimanPetzzz.png");

	public DqmRenderPetJeriman()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
