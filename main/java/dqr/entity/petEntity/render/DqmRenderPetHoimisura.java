...
public class DqmRenderPetHoimisura extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/HoimisuraPetzzz.png");

	public DqmRenderPetHoimisura()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
