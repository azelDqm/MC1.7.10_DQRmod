...
public class DqmRenderPetMrippusu extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Mrippusu.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/MrippusuPetzzz.png");

	public DqmRenderPetMrippusu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
