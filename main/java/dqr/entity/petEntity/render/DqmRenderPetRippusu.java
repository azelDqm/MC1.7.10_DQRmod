...
public class DqmRenderPetRippusu extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Rippusu.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/RippusuPetzzz.png");

	public DqmRenderPetRippusu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
