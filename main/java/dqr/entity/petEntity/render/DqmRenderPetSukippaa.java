...
public class DqmRenderPetSukippaa extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Sukippaa.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/SukippaaPetzzz.png");

	public DqmRenderPetSukippaa()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
