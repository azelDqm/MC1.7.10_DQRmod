...
public class DqmRenderPetRedsaikuron extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/RedsaikuronPetzzz.png");

	public DqmRenderPetRedsaikuron()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
