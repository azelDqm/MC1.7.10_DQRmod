...
public class DqmRenderPetAkumanotubo extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/Akumanotubo2Petzzz.png");
	private float scale = 0.7F;

	public DqmRenderPetAkumanotubo()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
