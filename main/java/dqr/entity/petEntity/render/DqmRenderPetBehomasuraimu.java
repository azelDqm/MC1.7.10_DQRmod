...
public class DqmRenderPetBehomasuraimu extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/BehomasuraimuPetzzz.png");

	public DqmRenderPetBehomasuraimu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
