...
public class DqmRenderPetMashougumo extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Mashougumo.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/MashougumoPetzzz.png");
	private float scale = 3.0F;
	public DqmRenderPetMashougumo()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
