...
public class DqmRenderPetKemunkurusu extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Kemunkurusu.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/KemunkurusuPetzzz.png");

	public DqmRenderPetKemunkurusu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
