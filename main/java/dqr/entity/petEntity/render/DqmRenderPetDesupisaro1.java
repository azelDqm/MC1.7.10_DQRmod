...
import dqr.entity.mobEntity.model.DqmModelDesupisaro1;

public class DqmRenderPetDesupisaro1 extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/DesupisaroPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetDesupisaro1()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
		 * (このRenderと紐付けするModel, このRenderを使うEntityの足元の影の大きさ)
		 */
		super(new DqmModelDesupisaro1(), 0.5F);
