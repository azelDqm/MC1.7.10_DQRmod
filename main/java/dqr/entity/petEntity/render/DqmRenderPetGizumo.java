...
public class DqmRenderPetGizumo extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Gizumo.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/GizumoPetzzz.png");

	public DqmRenderPetGizumo()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
