...
public class DqmRenderPetKirapan2 extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Kirapan2.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/Kirapan2Petzzz.png");
	private float scale = 1.8F;
	public DqmRenderPetKirapan2()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
