...
public class DqmRenderPetMoonkimera extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Moonkimera.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/MoonkimeraPetzzz.png");
	private float scale = 1.5F;
	public DqmRenderPetMoonkimera()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
