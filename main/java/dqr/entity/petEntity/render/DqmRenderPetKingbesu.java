...
public class DqmRenderPetKingbesu extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Suraimubesu.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/SuraimubesuPetzzz.png");

	public DqmRenderPetKingbesu()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
