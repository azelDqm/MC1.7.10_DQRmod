...
public class DqmRenderPetShadopan2 extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Shadopan2.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/Shadopan2Petzzz.png");
	private float scale = 1.8F;
	public DqmRenderPetShadopan2()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
