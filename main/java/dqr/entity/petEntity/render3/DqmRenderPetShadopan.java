...
public class DqmRenderPetShadopan extends RenderLiving
{
	/*
	 * テクスチャへのResourceLocationを設定する.
	 */
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Shadopan.png");
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/ShadopanPetzzz.png");

	public DqmRenderPetShadopan()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
