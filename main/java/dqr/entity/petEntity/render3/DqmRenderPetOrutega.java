...
public class DqmRenderPetOrutega extends RenderLiving
{
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/OrutegaPetzzz.png");

	public DqmRenderPetOrutega()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
