...
public class DqmRenderPetSuraimuemperor extends RenderLiving
{
	/*
	...
	private static final ResourceLocation DqmMobSleepTexture = new ResourceLocation("dqr:textures/entity/mobSleep/SuraimuemperorPetzzz.png");

	public DqmRenderPetSuraimuemperor()
	{
		/*
		 * スーパークラスのコンストラクタの引数は
