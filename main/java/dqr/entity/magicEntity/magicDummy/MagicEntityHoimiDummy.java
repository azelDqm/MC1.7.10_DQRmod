 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityHoimiDummy extends MagicEntity implements IProjectile{
    ...
    public MagicEntityHoimiDummy(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityHoimiDummy(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
