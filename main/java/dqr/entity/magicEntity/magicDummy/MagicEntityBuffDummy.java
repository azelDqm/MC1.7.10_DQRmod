 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityBuffDummy extends MagicEntity implements IProjectile{
    ...
    //追加パラメータ
    protected int maxTicksRange = 20;
    ...
    public MagicEntityBuffDummy(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityBuffDummy(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
    ...
    public void onUpdate()
    {
        ...
        else//埋まってない時。速度の更新。
        {
            ...
            {
            	//Block blc = this.worldObj.getBlock((int)this.posX, (int)this.posY, (int)this.posZ);
