...
public class MagicRenderKiari extends Render
{
    ...
    public MagicRenderKiari(ModelBase par1ModelBase) {
		super();
		this.modelBullet = par1ModelBase;
		this.shadowSize = 0.0F;
	}

	public void renderArrow(MagicEntityKiari par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation getArrowTextures(MagicEntityKiari par1EntityArrow)
    {
    ...
    {
        return this.getArrowTextures((MagicEntityKiari)par1Entity);
    }

    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderArrow((MagicEntityKiari)par1Entity, par2, par4, par6, par8, par9);
    }
}
