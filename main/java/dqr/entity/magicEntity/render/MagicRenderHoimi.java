...
public class MagicRenderHoimi extends Render
{
    private static final ResourceLocation textureLocation = new ResourceLocation("dqr:textures/entity/magic/hoimi.png");

    protected ModelBase modelBullet;

    public MagicRenderHoimi(ModelBase par1ModelBase) {
		super();
