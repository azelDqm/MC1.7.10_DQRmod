...
public class MagicEntityRender extends Render
{
    private static final ResourceLocation textureLocation = new ResourceLocation("dqr:textures/entity/magic/magic1.png");

    protected ModelBase modelBullet;

    public MagicEntityRender(ModelBase par1ModelBase) {
		super();
