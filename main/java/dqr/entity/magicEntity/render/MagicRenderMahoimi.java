...
public class MagicRenderMahoimi extends Render
{
    private static final ResourceLocation textureLocation = new ResourceLocation("dqr:textures/entity/magic/mahoimi.png");

    protected ModelBase modelBullet;

    public MagicRenderMahoimi(ModelBase par1ModelBase) {
		super();
		this.modelBullet = par1ModelBase;
		this.shadowSize = 0.0F;
	}

	public void renderArrow(MagicEntityMahoimi par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation getArrowTextures(MagicEntityMahoimi par1EntityArrow)
    {
    ...
    {
        return this.getArrowTextures((MagicEntityMahoimi)par1Entity);
    }

    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderArrow((MagicEntityMahoimi)par1Entity, par2, par4, par6, par8, par9);
    }
}
