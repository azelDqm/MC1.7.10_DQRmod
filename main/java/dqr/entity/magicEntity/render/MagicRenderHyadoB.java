...
public class MagicRenderHyadoB extends Render
{
    private static final ResourceLocation textureLocation = new ResourceLocation("dqr:textures/entity/magic/hyado.png");

    protected ModelBase modelBullet;

    public MagicRenderHyadoB(ModelBase par1ModelBase) {
		super();
		this.modelBullet = par1ModelBase;
		this.shadowSize = 0.0F;
	}

	public void renderArrow(MagicEntityHyadoB par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation getArrowTextures(MagicEntityHyadoB par1EntityArrow)
    {
    ...
    {
        return this.getArrowTextures((MagicEntityHyadoB)par1Entity);
    }

    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderArrow((MagicEntityHyadoB)par1Entity, par2, par4, par6, par8, par9);
    }
}
