...
public class MagicRenderHyado extends Render
{
    ...
    public MagicRenderHyado(ModelBase par1ModelBase) {
		super();
		this.modelBullet = par1ModelBase;
		this.shadowSize = 0.0F;
	}

	public void renderArrow(MagicEntityHyado par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    protected ResourceLocation getArrowTextures(MagicEntityHyado par1EntityArrow)
    {
    ...
    {
        return this.getArrowTextures((MagicEntityHyado)par1Entity);
    }

    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        this.renderArrow((MagicEntityHyado)par1Entity, par2, par4, par6, par8, par9);
    }
}
