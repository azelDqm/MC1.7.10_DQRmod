 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityArrow extends MagicEntity implements IProjectile{
   ...
   //public Entity shootingEntity;
    ...
    public MagicEntityArrow(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityArrow(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
            		...
            		}else
            		{
	            		...
	            		}else if(this.shootingEntity instanceof DqmPetBase)
	            		{
	        				...
	        				}else if (target instanceof EntityPlayer)
		                    {
		                    	...
		                    	{
		                    		System.out.println("Line2 : " + entityplayer.capabilities.disableDamage);
		                    		System.out.println("Line3 : " + !owner.canAttackPlayer(entityplayer));
		                    		System.out.println("Line4 : " + (target == owner));
		                    		System.out.println("Line4 : " + target.getCommandSenderName());
		                    		System.out.println("Line4 : " + owner.getCommandSenderName());
		                    	}
