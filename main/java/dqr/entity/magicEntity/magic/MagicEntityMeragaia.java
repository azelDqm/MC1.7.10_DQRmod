 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityMeragaia extends MagicEntity implements IProjectile{
    ...
    public MagicEntityMeragaia(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityMeragaia(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
