 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityMerazoma extends MagicEntity implements IProjectile{
    ...
    public MagicEntityMerazoma(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityMerazoma(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
