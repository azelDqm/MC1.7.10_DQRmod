 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityBuff extends MagicEntity implements IProjectile{
    ...
    public MagicEntityBuff(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityBuff(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
