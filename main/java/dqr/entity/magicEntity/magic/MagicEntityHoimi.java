 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityHoimi extends MagicEntity implements IProjectile{
    ...
    public MagicEntityHoimi(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityHoimi(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
