 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityMeramiB extends MagicEntity implements IProjectile{
    ...
    public MagicEntityMeramiB(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityMeramiB(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
