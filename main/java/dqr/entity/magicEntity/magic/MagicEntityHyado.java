 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityHyado extends MagicEntity implements IProjectile{
    ...
    public MagicEntityHyado(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityHyado(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
