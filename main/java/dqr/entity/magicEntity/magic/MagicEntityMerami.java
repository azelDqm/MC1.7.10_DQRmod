 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityMerami extends MagicEntity implements IProjectile{
    ...
    public MagicEntityMerami(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityMerami(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
