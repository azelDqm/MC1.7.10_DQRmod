 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityBegirama extends MagicEntity implements IProjectile{
    ...
    public MagicEntityBegirama(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityBegirama(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
