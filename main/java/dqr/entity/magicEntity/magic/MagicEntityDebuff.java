 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityDebuff extends MagicEntity implements IProjectile{
    ...
    public MagicEntityDebuff(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityDebuff(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
        ...
        else//埋まってない時。速度の更新。
        {
            ...
            if (entityList != null && !entityList.isEmpty())
            {
            	for (int n = 0 ; n < entityList.size() ; n++)
            	{
            		...
            		if(this.shootingEntity != null && this.shootingEntity instanceof DqmMobBase)
            		{
            		...
            		if (target != null && target.entityHit != null)
            		{
                		...
                		if(pe != null && this.shootingEntity != null && this.shootingEntity instanceof EntityLiving)
                		{
                            ...
                            if (elv instanceof EntityLivingBase)
                            {
                            	...
                            	if(this.potEff != null && rand.nextInt(100) < this.rate)
                            	{
                            		if (eb instanceof EntityPlayer && ((EntityPlayer)eb).capabilities.isCreativeMode)
                            		{
                            			;
                            		}else
                            		{
