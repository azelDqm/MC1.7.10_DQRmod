 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityMahoimi extends MagicEntity implements IProjectile{
    ...
    public MagicEntityMahoimi(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityMahoimi(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
