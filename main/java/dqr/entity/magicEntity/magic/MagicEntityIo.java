 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityIo extends MagicEntity implements IProjectile{
    ...
    public MagicEntityIo(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityIo(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
