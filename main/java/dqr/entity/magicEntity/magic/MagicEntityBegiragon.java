 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityBegiragon extends MagicEntity implements IProjectile{
    ...
    public MagicEntityBegiragon(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityBegiragon(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
            		...
            		}else
            		{
	            		...
	            		if(this.shootingEntity instanceof EntityPlayer)
	            		{
		                                 ...
		                                 target instanceof EntityHorse)
		                    {
		                    	...
		                    	entityList.remove(n);
		                    }else if (target instanceof EntityDragon || target instanceof EntityDragonPart ||
		                    		  target instanceof EntityEnderCrystal)
		                    {
		                    	entityList.remove(n);
		                    }
