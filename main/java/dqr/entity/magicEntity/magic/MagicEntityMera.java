 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityMera extends MagicEntity implements IProjectile{
    ...
    public MagicEntityMera(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityMera(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
