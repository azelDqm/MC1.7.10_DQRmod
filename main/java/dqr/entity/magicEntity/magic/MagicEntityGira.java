 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityGira extends MagicEntity implements IProjectile{
   ...
   //public Entity shootingEntity;
    ...
    public MagicEntityGira(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityGira(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
