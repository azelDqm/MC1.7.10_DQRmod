 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityGiragureido extends MagicEntity implements IProjectile{
    ...
    public MagicEntityGiragureido(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityGiragureido(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
