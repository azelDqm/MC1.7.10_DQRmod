 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntityMeraB extends MagicEntity implements IProjectile{
    ...
    public MagicEntityMeraB(World par1World)
    {
        super(par1World);
    ...
    public MagicEntityMeraB(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
