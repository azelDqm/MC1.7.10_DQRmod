 ...
 * 発射されるエンティティのクラス。
 * */
public class MagicEntity extends Entity implements IProjectile{
    ...
    public MagicEntity(World par1World, EntityLivingBase par2EntityLivingBase, float speed, float speed2,
    ...
    public boolean isDoSetDead(MagicEntity magic, Entity shooter )
    {
