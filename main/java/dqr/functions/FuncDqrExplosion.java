...
public class FuncDqrExplosion extends Explosion
{
    ...
    public static final String __OBFID = "CL_00000134";

    public FuncDqrExplosion(World p_i1948_1_, Entity p_i1948_2_, double p_i1948_3_, double p_i1948_5_, double p_i1948_7_, float p_i1948_9_)
    {
    ...
    public void doExplosionB(boolean p_77279_1_)
    {
        ...
        if (this.isSmoking)
        {
			...
			//ThreadExplosion builderThread = new ThreadExplosion(this, true);
            //builderThread.start();
        }
