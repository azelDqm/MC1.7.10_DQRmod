...
public class ComponentVillageKaitoriyaHouse extends StructureVillagePieces.Village {

	private boolean field_143014_b;
	private StructureVillagePieces.Start startPiece;

	public ComponentVillageKaitoriyaHouse(){}

	public ComponentVillageKaitoriyaHouse(StructureVillagePieces.Start p_i2107_1_, int p_i2107_2_)
    {
    ...
    public ComponentVillageKaitoriyaHouse(StructureVillagePieces.Start p_i2102_1_, int p_i2102_2_, Random p_i2102_3_, StructureBoundingBox p_i2102_4_, int p_i2102_5_)
    {
	...
	public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        this.placeBlockAtCurrentPosition(p_74875_1_, DQDecorates.DqmBlockDouguya, this.coordBaseMode, 2, 2, 0, p_74875_3_);
        this.placeBlockAtCurrentPosition(p_74875_1_, DQDecorates.DqmBlockDouguya, this.coordBaseMode, 6, 2, 0, p_74875_3_);
    ...
    public static Object buildComponent(StructureVillagePieces.Start p_74919_0_, List p_74919_1_, Random p_74919_2_, int p_74919_3_, int p_74919_4_, int p_74919_5_, int p_74919_6_, int p_74919_7_)
    {
        ...
        return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_74919_1_, structureboundingbox) == null ? new ComponentVillageKaitoriyaHouse(p_74919_0_, p_74919_7_, p_74919_2_, structureboundingbox, p_74919_6_) : null;
    }
    ...
    public void spawnVillagers2(World p_74893_1_, StructureBoundingBox p_74893_2_, int p_74893_3_, int p_74893_4_, int p_74893_5_, int p_74893_6_)
    {
        ...
        //{
            ...
            //{
                ...
                DqmEntityNPCKaitoriya entityvillager = new DqmEntityNPCKaitoriya(p_74893_1_);
