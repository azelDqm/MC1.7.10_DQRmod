...
public class VillageCreationHandleKaitoriya implements IVillageCreationHandler {
	@Override
	public StructureVillagePieces.PieceWeight getVillagePieceWeight(Random random, int i) {
		/*
		 * 詳細不明ですが構造物生成の重み付けをしているようです
		 */
		return new StructureVillagePieces.PieceWeight(getComponentClass(), 18, MathHelper.getRandomIntegerInRange(random, i, i+1));
	}
	...
	public Object buildComponent(StructureVillagePieces.PieceWeight villagePiece,
		 ...
		 */
		return ComponentVillageKaitoriyaHouse.buildComponent(startPiece, pieces, random, p1, p2, p3, p4, p5);
	}
}
