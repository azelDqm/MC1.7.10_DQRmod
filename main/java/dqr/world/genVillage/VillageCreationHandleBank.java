...
public class VillageCreationHandleBank implements IVillageCreationHandler {
	@Override
	...
	public Class<?> getComponentClass() {
		 ...
		 */
		return ComponentVillageBankHouse.class;
	}
	...
	public Object buildComponent(StructureVillagePieces.PieceWeight villagePiece,
		 ...
		 */
		return ComponentVillageBankHouse.buildComponent(startPiece, pieces, random, p1, p2, p3, p4, p5);
	}
}
