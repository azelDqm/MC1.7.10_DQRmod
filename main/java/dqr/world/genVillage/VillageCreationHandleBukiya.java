...
public class VillageCreationHandleBukiya implements IVillageCreationHandler {
	@Override
	...
	public Class<?> getComponentClass() {
		 ...
		 */
		return ComponentVillageBukiyaHouse.class;
	}
	...
	public Object buildComponent(StructureVillagePieces.PieceWeight villagePiece,
		 ...
		 */
		return ComponentVillageBukiyaHouse.buildComponent(startPiece, pieces, random, p1, p2, p3, p4, p5);
	}
}
