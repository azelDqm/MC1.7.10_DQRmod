...
public class StructureSpawnerRoomOverStart extends StructureStart {

	public StructureSpawnerRoomOverStart() {}

	public StructureSpawnerRoomOverStart(World par1World, Random par2Random, int par3, int par4) {
		super(par3, par4);

		// 構造物の構成パーツを決定する
		// 基点はComponentSampleDungeon1
		ComponentSpawnerRoomOver componentDungeon1 = new ComponentSpawnerRoomOver(0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2);
