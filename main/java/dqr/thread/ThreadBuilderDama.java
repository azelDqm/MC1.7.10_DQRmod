...
public class ThreadBuilderDama extends Thread{
	...
	public ThreadBuilderDama(World par1, int size, int height, int under, ItemStack ist, int mode)
	{
		this.par3World = par1;
    	this.size = size;
    	this.height = height;
        ...
        if(this.Hougaku == 0 || this.Hougaku == 2)
        {
	        ...
	        for (int x = -20; x <= 20; ++x)
	        {
	            ...
	            for (int z = -20; z <= 20; ++z)
	            {
	                for (int y = 0; y <= 13; ++y)
	                {
	                    par3World.setBlock(xxx + x, yyy + y + takasa, zzz + (z * byVal), Blocks.quartz_block, 0, 2);
	                }
	            }
	        }
	        ...
	        for (int z = -21; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx - 7, yyy + 0 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	        }
	        ...
	        for (int z = -21; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 7, yyy + 0 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int x = -21; x <= -7; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 0 + takasa, zzz - (21 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }
	        ...
	        for (int x = -21; x <= 21; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 0 + takasa, zzz + (21 * byVal), Blocks.quartz_stairs, metaV2, 2);
	        }
	        ...
	        for (int z = -21; z <= 21; ++z)
	        {
	            par3World.setBlock(xxx + 21, yyy + 0 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	        }
	        ...
	        for (int z = -21; z <= 21; ++z)
	        {
	            par3World.setBlock(xxx - 21, yyy + 0 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int x = -20; x <= 20; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 13 + takasa, zzz + (20 * byVal), Blocks.quartz_stairs, metaV2, 2);
	        }
	        ...
	        for (int z = -20; z <= 20; ++z)
	        {
	            par3World.setBlock(xxx + 20, yyy + 13 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 20, yyy + 13 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int z = -20; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 11, yyy + 14 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 11, yyy + 14 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int z = -20; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 8, yyy + 15 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 8, yyy + 15 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int z = -20; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 5, yyy + 16 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 5, yyy + 16 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int z = -20; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 2, yyy + 17 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 2, yyy + 17 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int z = -20; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 1, yyy + 18 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 1, yyy + 18 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int z = -20; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 1, yyy + 15 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 4, 2);
	            par3World.setBlock(xxx - 1, yyy + 15 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 5, 2);
	        }
	        ...
	        for (int z = -20; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 4, yyy + 14 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 4, 2);
	            par3World.setBlock(xxx - 4, yyy + 14 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 5, 2);
	        }
	        ...
	        for (int z = -20; z <= -18; ++z)
	        {
	            par3World.setBlock(xxx + 7, yyy + 13 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 4, 2);
	            par3World.setBlock(xxx - 7, yyy + 13 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 5, 2);
	        }
	        ...
	        //階段
	        par3World.setBlock(xxx + 3, yyy + 3 + takasa, zzz - (11 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy + 3 + takasa, zzz - (11 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 3, yyy + 3 + takasa, zzz - (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy + 3 + takasa, zzz - (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 3, yyy + 2 + takasa, zzz - (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy + 2 + takasa, zzz - (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 3, yyy + 2 + takasa, zzz - (13 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy + 2 + takasa, zzz - (13 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 3, yyy + 1 + takasa, zzz - (13 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy + 1 + takasa, zzz - (13 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 3, yyy + 1 + takasa, zzz - (14 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy + 1 + takasa, zzz - (14 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 3, yyy + 0 + takasa, zzz - (14 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy + 0 + takasa, zzz - (14 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 3, yyy + 0 + takasa, zzz - (15 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy + 0 + takasa, zzz - (15 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 3, yyy - 1 + takasa, zzz - (15 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 3, yyy - 1 + takasa, zzz - (15 * byVal), Blocks.quartz_block, 0, 2);

	        for (int x = -2; x <= 2; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 3 + takasa, zzz - (11 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int x = -2; x <= 2; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 2 + takasa, zzz - (12 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int x = -2; x <= 2; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 1 + takasa, zzz - (13 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int x = -2; x <= 2; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 0 + takasa, zzz - (14 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }
	        ...
	        for (int z = -21; z <= -16; ++z)
	        {
	            par3World.setBlock(xxx + 3, yyy + 0 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 3, yyy + 0 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }
	        ...
	        for (int x = -6; x <= 6; ++x)
	        {
	            ...
	            for (int z = -1; z <= -1; ++z)
	            {
	                for (int y = 4; y <= 4; ++y)
	                {
	                    par3World.setBlock(xxx + x, yyy + y + takasa, zzz + (z * byVal), Blocks.quartz_stairs, metaV1, 2);
	                }
	            }
	        }
	        ...
	        for (int x = -6; x <= 6; ++x)
	        {
	            ...
	            for (int z = 10; z <= 10; ++z)
	            {
	                for (int y = 4; y <= 4; ++y)
	                {
	                    par3World.setBlock(xxx + x, yyy + y + takasa, zzz + (z * byVal), Blocks.quartz_stairs, metaV2, 2);
	                }
	            }
	        }
	        ...
	        for (int x = 6; x <= 6; ++x)
	        {
	            ...
	            for (int z = -1; z <= 10; ++z)
	            {
	                for (int y = 4; y <= 4; ++y)
	                {
	                    par3World.setBlock(xxx + x, yyy + y + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	                }
	            }
	        }
	        ...
	        for (int x = -6; x <= -6; ++x)
	        {
	            ...
	            for (int z = -1; z <= 10; ++z)
	            {
	                for (int y = 4; y <= 4; ++y)
	                {
	                    par3World.setBlock(xxx + x, yyy + y + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	                }
	            }
	        }
	        ...
	        par3World.setBlock(xxx + 5, yyy + 4 + takasa, zzz + 0,Blocks.quartz_block, 2, 2);
	        par3World.setBlock(xxx - 5, yyy + 4 + takasa, zzz + 0, Blocks.quartz_block, 2, 2);
	        par3World.setBlock(xxx + 2, yyy + 4 + takasa, zzz + 0, Blocks.quartz_block, 2, 2);
	        par3World.setBlock(xxx - 2, yyy + 4 + takasa, zzz + 0, Blocks.quartz_block, 2, 2);

	        for (int x = -1; x <= 1; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 4 + takasa, zzz + 0, Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int x = -1; x <= 1; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 5 + takasa, zzz + (1 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int x = -1; x <= 1; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 6 + takasa, zzz + (2 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int x = -1; x <= 1; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 7 + takasa, zzz + (3 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int x = -1; x <= 1; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 8 + takasa, zzz + (4 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }
	        ...
	        for (int z = -8; z <= -1; ++z)
	        {
	            par3World.setBlock(xxx + 6, yyy + 10 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 6, yyy + 10 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }

	        for (int z = -6; z <= 0; ++z)
	        {
	            par3World.setBlock(xxx + 2, yyy + 13 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 2, yyy + 13 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }

	        par3World.setBlock(xxx + 1, yyy + 13 + takasa, zzz - (7 * byVal), Blocks.quartz_stairs, 1, 2);
	        par3World.setBlock(xxx - 1, yyy + 13 + takasa, zzz - (7 * byVal), Blocks.quartz_stairs, 0, 2);
	        par3World.setBlock(xxx, yyy + 13 + takasa, zzz - (8 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        par3World.setBlock(xxx + 1, yyy + 13 + takasa, zzz - (8 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        par3World.setBlock(xxx - 1, yyy + 13 + takasa, zzz - (8 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        par3World.setBlock(xxx + 3, yyy + 12 + takasa, zzz - (8 * byVal), Blocks.quartz_stairs, 1, 2);
	        par3World.setBlock(xxx - 3, yyy + 12 + takasa, zzz - (8 * byVal), Blocks.quartz_stairs, 0, 2);
	        ...
	        par3World.setBlock(xxx - 3, yyy + 10 + takasa, zzz - (8 * byVal), Blocks.air, 0, 2);
	        par3World.setBlock(xxx, yyy + 10 + takasa, zzz - (8 * byVal), Blocks.quartz_stairs, metaV3, 2);
	        par3World.setBlock(xxx + 2, yyy + 10 + takasa, zzz - (8 * byVal), Blocks.quartz_stairs, metaV3, 2);
	        par3World.setBlock(xxx - 2, yyy + 10 + takasa, zzz - (8 * byVal), Blocks.quartz_stairs, metaV3, 2);
	        par3World.setBlock(xxx, yyy + 15 + takasa, zzz, Blocks.quartz_stairs, metaV1, 2);
	        par3World.setBlock(xxx, yyy + 15 + takasa, zzz + (4 * byVal), Blocks.quartz_stairs, metaV2, 2);
	        ...
	        for (int z = 2; z <= 4; ++z)
	        {
	            par3World.setBlock(xxx + 1, yyy + 15 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 1, yyy + 15 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }

	        for (int z = -6; z <= 0; ++z)
	        {
	            par3World.setBlock(xxx + 1, yyy + 14 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 1, yyy + 14 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }

	        for (int x = 6; x <= 10; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 10 + takasa, zzz - (1 * byVal), Blocks.quartz_stairs, metaV1, 2);
	        }
	        ...
	        for (int z = -1; z <= 10; ++z)
	        {
	            par3World.setBlock(xxx + 10, yyy + 10 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 1, 2);
	            par3World.setBlock(xxx - 10, yyy + 10 + takasa, zzz + (z * byVal), Blocks.quartz_stairs, 0, 2);
	        }

	        for (int x = -10; x <= 10; ++x)
	        {
	            par3World.setBlock(xxx + x, yyy + 10 + takasa, zzz + (10 * byVal), Blocks.quartz_stairs, metaV2, 2);
	        }
	        ...
	        par3World.setBlock(xxx - 1, yyy + 9 + takasa, zzz + (5 * byVal), Blocks.air, 0, 2);
	        par3World.setBlock(xxx, yyy + 10 + takasa, zzz + (7 * byVal), Blocks.quartz_stairs, metaV2, 2);
	        par3World.setBlock(xxx + 1, yyy + 10 + takasa, zzz + (6 * byVal), Blocks.quartz_stairs, 1, 2);
	        par3World.setBlock(xxx - 1, yyy + 10 + takasa, zzz + (6 * byVal), Blocks.quartz_stairs, 0, 2);
	        par3World.setBlock(xxx, yyy + 9 + takasa, zzz +(5 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 1, yyy + 9 + takasa, zzz + (5 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 1, yyy + 9 + takasa, zzz + (5 * byVal), Blocks.quartz_block, 0, 2);
	        ...
	        //裏の隠し扉
	        par3World.setBlock(xxx, yyy + 0 + takasa, zzz + (14 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 1, yyy + 0 + takasa, zzz + (14 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 1, yyy + 0 + takasa, zzz + (14 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 1, yyy + 1 + takasa, zzz + (13 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 1, yyy + 1 + takasa, zzz + (13 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 1, yyy + 2 + takasa, zzz + (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 1, yyy + 2 + takasa, zzz + (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 2, yyy + 2 + takasa, zzz + (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 2, yyy + 2 + takasa, zzz + (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 1, yyy + 3 + takasa, zzz + (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 1, yyy + 3 + takasa, zzz + (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 1, yyy + 3 + takasa, zzz + (11 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - 1, yyy + 3 + takasa, zzz + (11 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx, yyy + 3 + takasa, zzz + (12 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx, yyy + 3 + takasa, zzz + (11 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx, yyy + 4 + takasa, zzz + (11 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx, yyy + 4 + takasa, zzz + (10 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + 1, yyy + 4 + takasa, zzz + (11 * byVal), Blocks.quartz_stairs, 1, 2);
	        par3World.setBlock(xxx - 1, yyy + 4 + takasa, zzz + (11 * byVal), Blocks.quartz_stairs, 0, 2);
	        par3World.setBlock(xxx + 1, yyy + 4 + takasa, zzz + (12 * byVal), Blocks.quartz_stairs, metaV2, 2);
	        par3World.setBlock(xxx - 1, yyy + 4 + takasa, zzz + (12 * byVal), Blocks.quartz_stairs, metaV2, 2);
	        par3World.setBlock(xxx, yyy + 4 + takasa, zzz + (12 * byVal), Blocks.quartz_stairs, metaV2, 2);
	        par3World.setBlock(xxx, yyy + 3 + takasa, zzz + (13 * byVal), Blocks.quartz_stairs, metaV2, 2);
        ...
        }else
        {
	        ...
	        for (int z = -20; z <= 20; ++z)
	        {
	            ...
	            for (int x = -20; x <= 20; ++x)
	            {
	                for (int y = 0; y <= 13; ++y)
	                {
	                    par3World.setBlock(xxx + (x * byVal), yyy + y + takasa, zzz + z, Blocks.quartz_block, 0, 2);
	                }
	            }
	        }
	        ...
	        for (int x = -21; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 0 + takasa, zzz - 7, Blocks.quartz_stairs, 3, 2);
	        }

	        for (int x = -21; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 0 + takasa, zzz + 7, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int z = -21; z <= -7; ++z)
	        {
	            par3World.setBlock(xxx - (21 * byVal), yyy + 0 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }
	        ...
	        for (int z = -21; z <= 21; ++z)
	        {
	            par3World.setBlock(xxx + (21 * byVal), yyy + 0 + takasa, zzz + z, Blocks.quartz_stairs, metaV2, 2);
	        }

	        for (int x = -21; x <= 21; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 0 + takasa, zzz + 21, Blocks.quartz_stairs, 3, 2);
	        }

	        for (int x = -21; x <= 21; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 0 + takasa, zzz - 21, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int z = -20; z <= 20; ++z)
	        {
	            par3World.setBlock(xxx + (20 * byVal), yyy + 13 + takasa, zzz + z, Blocks.quartz_stairs, metaV2, 2);
	        }
	        ...
	        for (int x = -20; x <= 20; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 13 + takasa, zzz + 20, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 13 + takasa, zzz - 20, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int x = -20; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 14 + takasa, zzz + 11, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 14 + takasa, zzz - 11, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int x = -20; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 15 + takasa, zzz + 8, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 15 + takasa, zzz - 8, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int x = -20; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 16 + takasa, zzz + 5, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 16 + takasa, zzz - 5, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int x = -20; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 17 + takasa, zzz + 2, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 17 + takasa, zzz - 2, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int x = -20; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 18 + takasa, zzz + 1, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 18 + takasa, zzz - 1, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int x = -20; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 15 + takasa, zzz + 1, Blocks.quartz_stairs, 6, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 15 + takasa, zzz - 1, Blocks.quartz_stairs, 7, 2);
	        }

	        for (int x = -20; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 14 + takasa, zzz + 4, Blocks.quartz_stairs, 6, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 14 + takasa, zzz - 4, Blocks.quartz_stairs, 7, 2);
	        }

	        for (int x = -20; x <= -18; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 13 + takasa, zzz + 7, Blocks.quartz_stairs, 6, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 13 + takasa, zzz - 7, Blocks.quartz_stairs, 7, 2);
	        }
	        ...
	        //階段
	        par3World.setBlock(xxx - (11 * byVal), yyy + 3 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (11 * byVal), yyy + 3 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (12 * byVal), yyy + 3 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (12 * byVal), yyy + 3 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (12 * byVal), yyy + 2 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (12 * byVal), yyy + 2 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (13 * byVal), yyy + 2 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (13 * byVal), yyy + 2 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (13 * byVal), yyy + 1 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (13 * byVal), yyy + 1 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (14 * byVal), yyy + 1 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (14 * byVal), yyy + 1 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (14 * byVal), yyy + 0 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (14 * byVal), yyy + 0 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (15 * byVal), yyy + 0 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (15 * byVal), yyy + 0 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (15 * byVal), yyy - 1 + takasa, zzz + 3, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx - (15 * byVal), yyy - 1 + takasa, zzz - 3, Blocks.quartz_block, 0, 2);

	        for (int z = -2; z <= 2; ++z)
	        {
	            par3World.setBlock(xxx - (11 * byVal), yyy + 3 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int z = -2; z <= 2; ++z)
	        {
	            par3World.setBlock(xxx - (12 * byVal), yyy + 2 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int z = -2; z <= 2; ++z)
	        {
	            par3World.setBlock(xxx - (13 * byVal), yyy + 1 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int z = -2; z <= 2; ++z)
	        {
	            par3World.setBlock(xxx - (14 * byVal), yyy + 0 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }
	        ...
	        for (int x = -21; x <= -16; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 0 + takasa, zzz + 3, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 0 + takasa, zzz - 3, Blocks.quartz_stairs, 2, 2);
	        }
	        ...
	        for (int z = -6; z <= 6; ++z)
	        {
	            ...
	            for (int x = -1; x <= -1; ++x)
	            {
	                for (int y = 4; y <= 4; ++y)
	                {
	                    par3World.setBlock(xxx + (x * byVal), yyy + y + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	                }
	            }
	        }
	        ...
	        for (int z = -6; z <= 6; ++z)
	        {
	            ...
	            for (int x = 10; x <= 10; ++x)
	            {
	                for (int y = 4; y <= 4; ++y)
	                {
	                    par3World.setBlock(xxx + (x * byVal), yyy + y + takasa, zzz + z, Blocks.quartz_stairs, metaV2, 2);
	                }
	            }
	        }
	        ...
	        for (int z = 6; z <= 6; ++z)
	        {
	            ...
	            for (int x = -1; x <= 10; ++x)
	            {
	                for (int y = 4; y <= 4; ++y)
	                {
	                    par3World.setBlock(xxx + (x * byVal), yyy + y + takasa, zzz + z, Blocks.quartz_stairs, 3, 2);
	                }
	            }
	        }
	        ...
	        for (int z = -6; z <= -6; ++z)
	        {
	            ...
	            for (int x = -1; x <= 10; ++x)
	            {
	                for (int y = 4; y <= 4; ++y)
	                {
	                    par3World.setBlock(xxx + (x * byVal), yyy + y + takasa, zzz + z, Blocks.quartz_stairs, 2, 2);
	                }
	            }
	        }

	        par3World.setBlock(xxx + 0, yyy + 4 + takasa, zzz + 5, Blocks.quartz_block, 2, 2);
	        par3World.setBlock(xxx - 0, yyy + 4 + takasa, zzz - 5, Blocks.quartz_block, 2, 2);
	        par3World.setBlock(xxx + 0, yyy + 4 + takasa, zzz + 2, Blocks.quartz_block, 2, 2);
	        par3World.setBlock(xxx - 0, yyy + 4 + takasa, zzz - 2, Blocks.quartz_block, 2, 2);
	        ...
	        for (int z = -1; z <= 1; ++z)
	        {
	            par3World.setBlock(xxx + 0, yyy + 4 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int z = -1; z <= 1; ++z)
	        {
	            par3World.setBlock(xxx + (1 * byVal), yyy + 5 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int z = -1; z <= 1; ++z)
	        {
	            par3World.setBlock(xxx + (2 * byVal), yyy + 6 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int z = -1; z <= 1; ++z)
	        {
	            par3World.setBlock(xxx + (3 * byVal), yyy + 7 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }

	        for (int z = -1; z <= 1; ++z)
	        {
	            par3World.setBlock(xxx + (4 * byVal), yyy + 8 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }
	        ...
	        for (int x = -8; x <= -1; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 10 + takasa, zzz + 6, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 10 + takasa, zzz - 6, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int x = -6; x <= 0; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 13 + takasa, zzz + 2, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 13 + takasa, zzz - 2, Blocks.quartz_stairs, 2, 2);
	        }

	        par3World.setBlock(xxx - (7 * byVal), yyy + 13 + takasa, zzz + 1, Blocks.quartz_stairs, 3, 2);
	        par3World.setBlock(xxx - (7 * byVal), yyy + 13 + takasa, zzz - 1, Blocks.quartz_stairs, 2, 2);
	        par3World.setBlock(xxx - (8 * byVal), yyy + 13 + takasa, zzz , Blocks.quartz_stairs, metaV1, 2);
	        par3World.setBlock(xxx - (8 * byVal), yyy + 13 + takasa, zzz + 1, Blocks.quartz_stairs, metaV1, 2);
	        par3World.setBlock(xxx - (8 * byVal), yyy + 13 + takasa, zzz - 1, Blocks.quartz_stairs, metaV1, 2);
	        par3World.setBlock(xxx - (8 * byVal), yyy + 12 + takasa, zzz + 3, Blocks.quartz_stairs, 3, 2);
	        par3World.setBlock(xxx - (8 * byVal), yyy + 12 + takasa, zzz - 3, Blocks.quartz_stairs, 2, 2);
	        ...
	        par3World.setBlock(xxx - (8 * byVal), yyy + 10 + takasa, zzz - 3, Blocks.air, 0, 2);
	        par3World.setBlock(xxx - (8 * byVal), yyy + 10 + takasa, zzz, Blocks.quartz_stairs, metaV3, 2);
	        par3World.setBlock(xxx - (8 * byVal), yyy + 10 + takasa, zzz + 2, Blocks.quartz_stairs, metaV3, 2);
	        par3World.setBlock(xxx - (8 * byVal), yyy + 10 + takasa, zzz - 2, Blocks.quartz_stairs, metaV3, 2);
	        par3World.setBlock(xxx, yyy + 15 + takasa, zzz, Blocks.quartz_stairs, metaV1, 2);
	        par3World.setBlock(xxx + (4 * byVal), yyy + 15 + takasa, zzz, Blocks.quartz_stairs, metaV2, 2);

	        for (int x = 2; x <= 4; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 15 + takasa, zzz + 1, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 15 + takasa, zzz - 1, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int x = -6; x <= 0; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 14 + takasa, zzz + 1, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 14 + takasa, zzz - 1, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int z = 6; z <= 10; ++z)
	        {
	            par3World.setBlock(xxx  - (1 * byVal), yyy + 10 + takasa, zzz + z, Blocks.quartz_stairs, metaV1, 2);
	        }
	        ...
	        for (int x = -1; x <= 10; ++x)
	        {
	            par3World.setBlock(xxx + (x * byVal), yyy + 10 + takasa, zzz + 10, Blocks.quartz_stairs, 3, 2);
	            par3World.setBlock(xxx + (x * byVal), yyy + 10 + takasa, zzz - 10, Blocks.quartz_stairs, 2, 2);
	        }

	        for (int z = -10; z <= 10; ++z)
	        {
	            par3World.setBlock(xxx + (10 * byVal), yyy + 10 + takasa, zzz + z, Blocks.quartz_stairs, metaV2, 2);
	        }
	        ...
	        par3World.setBlock(xxx + (5 * byVal), yyy + 9 + takasa, zzz  - 1, Blocks.air, 0, 2);
	        par3World.setBlock(xxx + (7 * byVal), yyy + 10 + takasa, zzz, Blocks.quartz_stairs, metaV2, 2);
	        par3World.setBlock(xxx + (6 * byVal), yyy + 10 + takasa, zzz + 1, Blocks.quartz_stairs, 3, 2);
	        par3World.setBlock(xxx + (6 * byVal), yyy + 10 + takasa, zzz - 1, Blocks.quartz_stairs, 2, 2);
	        par3World.setBlock(xxx + (5 * byVal), yyy + 9 + takasa, zzz, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (5 * byVal), yyy + 9 + takasa, zzz + 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (5 * byVal), yyy + 9 + takasa, zzz - 1, Blocks.quartz_block, 0, 2);
			try {
				this.sleep(DQR.conf.cfg_build_sleep);
			} catch (InterruptedException e) {
	        ...
	        par3World.spawnEntityInWorld(entitysilverfish);
	        //裏の隠し扉
	        par3World.setBlock(xxx + (14 * byVal), yyy + 0 + takasa, zzz + (14 * byVal), Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (14 * byVal), yyy + 0 + takasa, zzz + 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (14 * byVal), yyy + 0 + takasa, zzz - 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (13 * byVal), yyy + 1 + takasa, zzz + 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (13 * byVal), yyy + 1 + takasa, zzz - 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 2 + takasa, zzz + 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 2 + takasa, zzz - 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 2 + takasa, zzz + 2, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 2 + takasa, zzz - 2, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 3 + takasa, zzz + 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 3 + takasa, zzz - 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (11 * byVal), yyy + 3 + takasa, zzz + 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (11 * byVal), yyy + 3 + takasa, zzz - 1, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 3 + takasa, zzz, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (11 * byVal), yyy + 3 + takasa, zzz, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (11 * byVal), yyy + 4 + takasa, zzz, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (10 * byVal), yyy + 4 + takasa, zzz, Blocks.quartz_block, 0, 2);
	        par3World.setBlock(xxx + (11 * byVal), yyy + 4 + takasa, zzz + 1, Blocks.quartz_stairs, 3, 2);
	        par3World.setBlock(xxx + (11 * byVal), yyy + 4 + takasa, zzz - 1, Blocks.quartz_stairs, 2, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 4 + takasa, zzz + 1, Blocks.quartz_stairs, metaV2, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 4 + takasa, zzz - 1, Blocks.quartz_stairs, metaV2, 2);
	        par3World.setBlock(xxx + (12 * byVal), yyy + 4 + takasa, zzz , Blocks.quartz_stairs, metaV2, 2);
	        par3World.setBlock(xxx + (13 * byVal), yyy + 3 + takasa, zzz, Blocks.quartz_stairs, metaV2, 2);
