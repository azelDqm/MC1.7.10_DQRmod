...
public abstract class DqmMobSpawnerBaseLogic extends MobSpawnerBaseLogic
{
    ...
    public Entity func_98265_a(Entity p_98265_1_)
    {
        if (this.getRandomEntity() != null)
        {
        	//System.out.println("DEBUGLINE:5");
        ...
        else if (p_98265_1_ instanceof EntityLivingBase && p_98265_1_.worldObj != null)
        {
        	...
        	if(p_98265_1_ instanceof EntityCreeper)
        	{
        		if(p_98265_1_.posY < 30)
    ...
    private void resetTimer()
    {
        ...
        {
            this.setRandomEntity((DqmMobSpawnerBaseLogic.WeightedRandomMinecart)WeightedRandom.getRandomItem(this.getSpawnerWorld().rand, this.potentialEntitySpawns));
        }
    ...
    public void readFromNBT(NBTTagCompound p_98270_1_)
    {
        ...
        if (p_98270_1_.hasKey("SpawnPotentials", 9))
        {
            ...
            {
                this.potentialEntitySpawns.add(new DqmMobSpawnerBaseLogic.WeightedRandomMinecart(nbttaglist.getCompoundTagAt(i)));
            }
        }
        else
        {
        ...
        {
            this.setRandomEntity(new DqmMobSpawnerBaseLogic.WeightedRandomMinecart(p_98270_1_.getCompoundTag("SpawnData"), this.entityTypeName));
        }
        else
        {
            this.setRandomEntity((DqmMobSpawnerBaseLogic.WeightedRandomMinecart)null);
        }
    ...
    public void writeToNBT(NBTTagCompound p_98280_1_)
    {
        ...
        if (this.getRandomEntity() != null || this.potentialEntitySpawns != null && this.potentialEntitySpawns.size() > 0)
        {
            ...
            if (this.potentialEntitySpawns != null && this.potentialEntitySpawns.size() > 0)
            {
                ...
                while (iterator.hasNext())
                {
                    DqmMobSpawnerBaseLogic.WeightedRandomMinecart weightedrandomminecart = (DqmMobSpawnerBaseLogic.WeightedRandomMinecart)iterator.next();
    ...
    {
        if (this.field_98291_j == null && this.getEntityNameToSpawn() != null && this.getEntityNameToSpawn() != "")
        {
    ...
    /*
    public DqmMobSpawnerBaseLogic.WeightedRandomMinecart getRandomEntity()
    {
