...
public class DqmBlockYajirusiue extends BlockContainer
{
    public static String setmodel;
    private String model;

    public DqmBlockYajirusiue(Material var2)
    {
        super( var2);
    ...
    public DqmBlockYajirusiue setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:YajirusiueB");
    }
