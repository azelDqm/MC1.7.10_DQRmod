...
public class DqmBlockOokiihasirasita extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockOokiihasirasita(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:OokiihasitaB");
    }
    //モデル
    public DqmBlockOokiihasirasita setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        if (model == "Ookiihasirasita")
        {
            return new DqmTileEntityOokiihasirasita();
        }

        if (model == "OokiihasirasitaQ")
        {
            return new DqmTileEntityOokiihasirasitaQ();
        }

        if (model == "OokiihasirasitaS")
        {
            return new DqmTileEntityOokiihasirasitaS();
        }

        if (model == "OokiihasirasitaNB")
        {
            return new DqmTileEntityOokiihasirasitaNB();
        }
