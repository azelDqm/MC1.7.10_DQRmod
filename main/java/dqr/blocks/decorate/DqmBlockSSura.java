...
public class DqmBlockSSura extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockSSura(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:SSuraB");
    }
    //モデル
    public DqmBlockSSura setmodel(String m)
    {
        model = m;
        return this;
    }
