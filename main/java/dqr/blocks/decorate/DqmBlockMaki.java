...
public class DqmBlockMaki extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockMaki(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:MakiB");
    }
    //モデル
    public DqmBlockMaki setmodel(String m)
    {
        model = m;
        return this;
    }
