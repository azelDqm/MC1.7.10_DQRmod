...
public class DqmBlockIdo extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockIdo(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:IdoB");
    }
    //モデル
    public DqmBlockIdo setmodel(String m)
    {
        model = m;
        return this;
    }
