...
public class DqmBlockTubokku extends BlockContainer
{
    public static String setmodel;
    private String model;

    public DqmBlockTubokku(Material var2)
    {
        super( var2);
    ...
    public DqmBlockTubokku setmodel(String m)
    {
        model = m;
        return this;
    }
...
/*
    public int idDropped(int i, Random random, int j)
    {
        ...
        //if(x3>=-150 && x3<=-121){j=DqmItemList.Tubokku2.blockID;}
        //else{j=0;}
        return j;
    }
    */
