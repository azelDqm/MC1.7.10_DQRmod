...
public class DqmBlockYajirusimaru extends BlockContainer
{
    public static String setmodel;
    private String model;

    public DqmBlockYajirusimaru(Material var2)
    {
        super( var2);
    ...
    public DqmBlockYajirusimaru setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:YajirusimaruB");
    }
