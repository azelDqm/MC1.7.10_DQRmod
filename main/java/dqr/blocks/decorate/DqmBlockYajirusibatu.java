...
public class DqmBlockYajirusibatu extends BlockContainer
{
    public static String setmodel;
    private String model;

    public DqmBlockYajirusibatu(Material var2)
    {
        super( var2);
    ...
    public DqmBlockYajirusibatu setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:YajirusibatuB");
    }
