...
public class DqmBlockOokiiisizukue extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockOokiiisizukue(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:IsinotukueB");
    }
    //モデル
    public DqmBlockOokiiisizukue setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        return new DqmTileEntityOokiiisizukue();
    }
    //ランダム
