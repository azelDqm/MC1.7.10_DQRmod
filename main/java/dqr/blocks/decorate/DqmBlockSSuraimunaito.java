...
public class DqmBlockSSuraimunaito extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockSSuraimunaito(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:SSuraimunaitoB");
    }
    //モデル
    public DqmBlockSSuraimunaito setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    public TileEntity createNewTileEntity(World var1, int par2)
    {
        ...
        return new DqmTileEntitySSuraimunaito();
    }
    //ランダム
