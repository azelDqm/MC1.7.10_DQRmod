...
import dqr.blocks.decorate.tileEntity.DqmTileEntityBank;

public class DqmBlockBank extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockBank(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:BankB");
    }
    //モデル
    public DqmBlockBank setmodel(String m)
    {
        model = m;
        return this;
    }
