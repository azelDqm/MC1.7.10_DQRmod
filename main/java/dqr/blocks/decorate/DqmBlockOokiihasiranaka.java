...
public class DqmBlockOokiihasiranaka extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockOokiihasiranaka(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:OokiihanakaB");
    }
    //モデル
    public DqmBlockOokiihasiranaka setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        if (model == "Ookiihasiranaka")
        {
            return new DqmTileEntityOokiihasiranaka();
        }

        if (model == "OokiihasiranakaQ")
        {
            return new DqmTileEntityOokiihasiranakaQ();
        }

        if (model == "OokiihasiranakaS")
        {
            return new DqmTileEntityOokiihasiranakaS();
        }

        if (model == "OokiihasiranakaNB")
        {
            return new DqmTileEntityOokiihasiranakaNB();
        }
