...
public class DqmBlockOke extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockOke(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:OkeB");
    }
    //モデル
    public DqmBlockOke setmodel(String m)
    {
        model = m;
        return this;
    }
