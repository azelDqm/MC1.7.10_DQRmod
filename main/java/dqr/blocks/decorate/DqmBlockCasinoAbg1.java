...
public class DqmBlockCasinoAbg1 extends Block{

	IIcon field_149936_O;
	IIcon field_149935_N;
	public DqmBlockCasinoAbg1(Material arg0)
	{
		super(arg0);
    ...
    {
    	ep.openGui(DQR.instance, DQR.conf.GuiID_CSBBGame, par1World, (int)ep.posX, (int)ep.posY, (int)ep.posZ);
    	return true;
    }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        this.field_149936_O = p_149651_1_.registerIcon("dqr:KajinoB");
