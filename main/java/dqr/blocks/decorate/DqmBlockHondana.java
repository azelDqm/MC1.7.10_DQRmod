...
public class DqmBlockHondana extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockHondana(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:HondanaB");
    }
    //モデル
    public DqmBlockHondana setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        return new DqmTileEntityHondana();
    }
    //ランダム
