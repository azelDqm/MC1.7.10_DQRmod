...
public class DqmBlockIdooke extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockIdooke(Material var2)
    {
        super(var2);
        //光源
        //this.setLightValue(3.0F);
        //キューブサイズ
        //this.setBlockBounds(1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 1.0F);
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:IdookeB");
    }
    //モデル
    public DqmBlockIdooke setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        return new DqmTileEntityIdooke();
    }
    //ランダム
