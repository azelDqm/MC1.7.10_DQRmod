...
public class DqmBlockYadoya extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockYadoya(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:YadoyaB");
    }
    //モデル
    public DqmBlockYadoya setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    public TileEntity createNewTileEntity(World var1, int par1)
    {
        ...
        return new DqmTileEntityYadoya();
    }
    //ランダム
