...
public class DqmBlockOokiihasiraue extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockOokiihasiraue(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:OokiihaueB");
    }
    //モデル
    public DqmBlockOokiihasiraue setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        if (model == "Ookiihasiraue")
        {
            return new DqmTileEntityOokiihasiraue();
        }

        if (model == "OokiihasiraueQ")
        {
            return new DqmTileEntityOokiihasiraueQ();
        }

        if (model == "OokiihasiraueS")
        {
            return new DqmTileEntityOokiihasiraueS();
        }

        if (model == "OokiihasiraueNB")
        {
            return new DqmTileEntityOokiihasiraueNB();
        }
