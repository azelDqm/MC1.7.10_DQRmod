...
public class DqmTileEntityRenderYajirusikiiro extends TileEntitySpecialRenderer
{
    private DqmModelYajirusi model = new DqmModelYajirusi();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityYajirusikiiro var9 = (DqmTileEntityYajirusikiiro)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/Ykiiro.png"));
        GL11.glPushMatrix();
