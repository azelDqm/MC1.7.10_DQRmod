...
public class DqmTileEntityRenderDaizaIG extends TileEntitySpecialRenderer
{
    private DqmModelDaiza model = new DqmModelDaiza();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityDaizaIG var9 = (DqmTileEntityDaizaIG)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/DaizaIG.png"));
        GL11.glPushMatrix();
