...
public class DqmTileEntityRenderJuujika extends TileEntitySpecialRenderer
{
    private DqmModelJuujika model = new DqmModelJuujika();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityJuujika var9 = (DqmTileEntityJuujika)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/Juujika.png"));
        GL11.glPushMatrix();
