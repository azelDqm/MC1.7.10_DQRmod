...
public class DqmTileEntityRenderDaizaI extends TileEntitySpecialRenderer
{
    private DqmModelDaiza model = new DqmModelDaiza();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityDaizaI var9 = (DqmTileEntityDaizaI)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/DaizaI.png"));
        GL11.glPushMatrix();
