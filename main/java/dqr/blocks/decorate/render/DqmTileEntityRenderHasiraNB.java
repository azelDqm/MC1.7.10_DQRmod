...
import dqr.blocks.decorate.model.DqmModelHasira;
import dqr.blocks.decorate.tileEntity.DqmTileEntityHasiraNB;

@SideOnly(Side.CLIENT)
public class DqmTileEntityRenderHasiraNB extends TileEntitySpecialRenderer
{
    private DqmModelHasira model = new DqmModelHasira();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityHasiraNB var9 = (DqmTileEntityHasiraNB)var1;
        GL11.glPushMatrix();
