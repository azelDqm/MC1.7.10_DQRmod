...
public class DqmTileEntityRenderYajirusimurasaki extends TileEntitySpecialRenderer
{
    private DqmModelYajirusi model = new DqmModelYajirusi();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityYajirusimurasaki var9 = (DqmTileEntityYajirusimurasaki)var1;
        GL11.glPushMatrix();
