...
public class DqmTileEntityRenderYajirusipink2 extends TileEntitySpecialRenderer
{
    private DqmModelYajirusi2 model = new DqmModelYajirusi2();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityYajirusipink2 var9 = (DqmTileEntityYajirusipink2)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/Ypink.png"));
        GL11.glPushMatrix();
