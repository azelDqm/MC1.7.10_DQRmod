...
public class DqmTileEntityRenderEntotuO extends TileEntitySpecialRenderer
{
    private DqmModelEntotu model = new DqmModelEntotu();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityEntotuO var9 = (DqmTileEntityEntotuO)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/BlockBB.png"));
        GL11.glPushMatrix();
