...
public class DqmTileEntityRenderDaizaW extends TileEntitySpecialRenderer
{
    private DqmModelDaiza model = new DqmModelDaiza();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityDaizaW var9 = (DqmTileEntityDaizaW)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/DaizaW.png"));
        GL11.glPushMatrix();
