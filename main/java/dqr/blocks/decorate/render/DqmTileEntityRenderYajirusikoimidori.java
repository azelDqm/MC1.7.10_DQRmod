...
public class DqmTileEntityRenderYajirusikoimidori extends TileEntitySpecialRenderer
{
    private DqmModelYajirusi model = new DqmModelYajirusi();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityYajirusikoimidori var9 = (DqmTileEntityYajirusikoimidori)var1;
        GL11.glPushMatrix();
