...
public class DqmTileEntityRenderEntotuS extends TileEntitySpecialRenderer
{
    private DqmModelEntotu model = new DqmModelEntotu();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityEntotuS var9 = (DqmTileEntityEntotuS)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/BlockSB.png"));
        GL11.glPushMatrix();
