...
import dqr.blocks.decorate.model.DqmModelYajirusi2;
import dqr.blocks.decorate.tileEntity.DqmTileEntityYajirusikoimidori2;

@SideOnly(Side.CLIENT)
public class DqmTileEntityRenderYajirusikoimidori2 extends TileEntitySpecialRenderer
{
    private DqmModelYajirusi2 model = new DqmModelYajirusi2();

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        DqmTileEntityYajirusikoimidori2 var9 = (DqmTileEntityYajirusikoimidori2)var1;
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("dqr:textures/model/Ykoimidori.png"));
        GL11.glPushMatrix();
