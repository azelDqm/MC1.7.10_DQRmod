...
public class DqmBlockTaruK extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockTaruK(Material var2)
    {
        super(var2);
        //光源
    ...
    //モデル
    public DqmBlockTaruK setmodel(String m)
    {
        model = m;
        return this;
    }
