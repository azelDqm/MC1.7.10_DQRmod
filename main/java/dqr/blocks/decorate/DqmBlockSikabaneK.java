...
public class DqmBlockSikabaneK extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockSikabaneK(Material var2)
    {
        super(var2);
        //光源
    ...
    //モデル
    public DqmBlockSikabaneK setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    public TileEntity createNewTileEntity(World var1, int par2)
    {
        ...
        return new DqmTileEntitySikabaneK();
    }
    //ランダム
