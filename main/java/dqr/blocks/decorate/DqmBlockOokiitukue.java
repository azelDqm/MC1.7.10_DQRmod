...
public class DqmBlockOokiitukue extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockOokiitukue(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:OokiikinotukueB");
    }
    //モデル
    public DqmBlockOokiitukue setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        return new DqmTileEntityOokiitukue();
    }
    //ランダム
