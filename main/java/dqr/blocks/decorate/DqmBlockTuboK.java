...
public class DqmBlockTuboK extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockTuboK(Material var2)
    {
        super(var2);
        //光源
    ...
    //モデル
    public DqmBlockTuboK setmodel(String m)
    {
        model = m;
        return this;
    }
