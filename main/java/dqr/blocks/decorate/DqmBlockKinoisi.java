...
public class DqmBlockKinoisi extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockKinoisi(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:KinoisuB");
    }
    //モデル
    public DqmBlockKinoisi setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        return new DqmTileEntityKinoisi();
    }
    //ランダム
