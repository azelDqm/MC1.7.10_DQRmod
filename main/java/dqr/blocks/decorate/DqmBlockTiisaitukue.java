...
public class DqmBlockTiisaitukue extends BlockContainer
{
    public static String setmodel;
    private String model;
    private float rotationYaw;

    public DqmBlockTiisaitukue(Material var2)
    {
        super(var2);
        //光源
    ...
    {
        this.blockIcon = var1.registerIcon("dqr:TiisaikinotukueB");
    }
    //モデル
    public DqmBlockTiisaitukue setmodel(String m)
    {
        model = m;
        return this;
    }
    ...
    {
        return new DqmTileEntityTiisaitukue();
    }
    //ランダム
