...
public class DqmBlockEnderChest extends BlockContainer
{
    private static final String __OBFID = "CL_00000238";
    private int chestId;
    public DqmBlockEnderChest(int par1)
    {
        super(Material.rock);
    ...
    {
        InventoryDqmEnderChest inventoryenderchest = new InventoryDqmEnderChest(p_149727_5_);//p_149727_5_.getInventoryEnderChest();
        DqmTileEntityEnderChest tileentityenderchest = (DqmTileEntityEnderChest)p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_);

        ExtendedPlayerProperties2.get(p_149727_5_).setEnderChestEntity(tileentityenderchest);
        ExtendedPlayerProperties2.get(p_149727_5_).setSetlectEnderChestID(chestId);

        p_149727_5_.openGui(DQR.instance, DQR.conf.GuiID_DqrEnderchest, p_149727_1_, (int)p_149727_5_.posX, (int)p_149727_5_.posY, (int)p_149727_5_.posZ);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_)
    {
    	switch(this.chestId)
    	{
    		case 1: return new DqmTileEntityEnderChest1();
    		case 2: return new DqmTileEntityEnderChest2();
    		case 3: return new DqmTileEntityEnderChest3();
    		case 4: return new DqmTileEntityEnderChest4();
    		case 5: return new DqmTileEntityEnderChest5();
    	}
        return new DqmTileEntityEnderChest();
    }
