...
public class DqmTileEntityRenderEnderChest3 extends TileEntitySpecialRenderer
{
    //モデル
    private ModelChest model = new ModelChest();
    private DqmModelBebisatan model2 = new DqmModelBebisatan();
    ...
    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        {
            DqmTileEntityEnderChest3 var9 = (DqmTileEntityEnderChest3)var1;
            int i = 0;
        ...
        }
        {
            ...
            */
            ...
            //テクスチャー
            this.bindTexture(new ResourceLocation("dqr:textures/entity/mob/Bebisatan.png"));
            GL11.glPushMatrix();
