...
public class DqmTileEntityEnderChest5 extends DqmTileEntityEnderChest{
    ...
    public void updateEntity()
    {
        ...
        {
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, DQChests.DqmEnderChest5, 1, this.field_145973_j);
        }
