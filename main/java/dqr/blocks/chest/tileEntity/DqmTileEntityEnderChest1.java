...
public class DqmTileEntityEnderChest1 extends DqmTileEntityEnderChest{
    ...
    public void updateEntity()
    {
        ...
        {
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, DQChests.DqmEnderChest1, 1, this.field_145973_j);
        }
