...
public class DqmTileEntityEnderChest4 extends DqmTileEntityEnderChest{
    ...
    public void updateEntity()
    {
        ...
        {
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, DQChests.DqmEnderChest4, 1, this.field_145973_j);
        }
