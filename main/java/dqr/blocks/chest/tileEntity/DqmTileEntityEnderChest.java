...
public class DqmTileEntityEnderChest extends TileEntity
{
    public float field_145972_a;
    public float field_145975_i;
    public int field_145973_j;
    public int field_145974_k;
    ...
    public void updateEntity()
    {
        ...
        {
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, DQChests.DqmEnderChest2, 1, this.field_145973_j);
        }
