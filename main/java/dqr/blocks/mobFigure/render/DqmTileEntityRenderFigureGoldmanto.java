...
public class DqmTileEntityRenderFigureGoldmanto extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelGoldmanto model = new DqmModelGoldmanto();
    ...
    {
        //エンティティ
        DqmTileEntityFigureGoldmanto var9 = (DqmTileEntityFigureGoldmanto)var1;
        GL11.glPushMatrix();
