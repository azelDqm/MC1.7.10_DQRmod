...
public class DqmTileEntityRenderFigureDesufuratta extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelBigCrow model = new DqmModelBigCrow();
    ...
    {
        //エンティティ
        DqmTileEntityFigureDesufuratta var9 = (DqmTileEntityFigureDesufuratta)var1;
        GL11.glPushMatrix();
