...
public class DqmTileEntityRenderFigureGamegonrejendo extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelGamegon model = new DqmModelGamegon();
    ...
    {
        //エンティティ
        DqmTileEntityFigureGamegonrejendo var9 = (DqmTileEntityFigureGamegonrejendo)var1;
        GL11.glPushMatrix();
