...
public class DqmTileEntityRenderFigureButisuraimu extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelButisuraimu model = new DqmModelButisuraimu();
    ...
    {
        //エンティティ
        DqmTileEntityFigureButisuraimu var9 = (DqmTileEntityFigureButisuraimu)var1;
        GL11.glPushMatrix();
