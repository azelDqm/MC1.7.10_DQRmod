...
import dqr.entity.mobEntity.model.DqmModelRyuuou;

@SideOnly(Side.CLIENT)
public class DqmTileEntityRenderFigureRyuuou extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelRyuuou model = new DqmModelRyuuou();

    private float fixA = 0;
    private float fixB = 2.0F;
    private float fixC = 0;
    private float fixD = 2.0F;
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Ryuuou.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureRyuuou var9 = (DqmTileEntityFigureRyuuou)var1;
        GL11.glPushMatrix();
