...
public class DqmTileEntityRenderFigureKirasuko extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelItamogu model = new DqmModelItamogu();

    private float fixA = 0;
    private float fixB = 1.0F;
    private float fixC = 0;
    private float fixD = 1.0F;
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Kirasuko.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureKirasuko var9 = (DqmTileEntityFigureKirasuko)var1;
        GL11.glPushMatrix();
