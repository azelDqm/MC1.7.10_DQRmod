...
public class DqmTileEntityRenderFigureMashougumo extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelGizumoAZ model = new DqmModelGizumoAZ();
    ...
    {
        //エンティティ
        DqmTileEntityFigureMashougumo var9 = (DqmTileEntityFigureMashougumo)var1;
        GL11.glPushMatrix();
