...
public class DqmTileEntityRenderFigureDokuyazukin extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelRiripat model = new DqmModelRiripat();
    ...
    {
        //エンティティ
        DqmTileEntityFigureDokuyazukin var9 = (DqmTileEntityFigureDokuyazukin)var1;
        GL11.glPushMatrix();
