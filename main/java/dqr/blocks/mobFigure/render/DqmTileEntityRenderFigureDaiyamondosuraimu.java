...
public class DqmTileEntityRenderFigureDaiyamondosuraimu extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelDaiyamondosuraimu model = new DqmModelDaiyamondosuraimu();
    ...
    {
        //エンティティ
        DqmTileEntityFigureDaiyamondosuraimu var9 = (DqmTileEntityFigureDaiyamondosuraimu)var1;
        GL11.glPushMatrix();
