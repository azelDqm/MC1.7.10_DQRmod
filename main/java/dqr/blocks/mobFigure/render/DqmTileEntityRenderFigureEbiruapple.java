...
public class DqmTileEntityRenderFigureEbiruapple extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelGappurin model = new DqmModelGappurin();
    ...
    {
        //エンティティ
        DqmTileEntityFigureEbiruapple var9 = (DqmTileEntityFigureEbiruapple)var1;
        GL11.glPushMatrix();
