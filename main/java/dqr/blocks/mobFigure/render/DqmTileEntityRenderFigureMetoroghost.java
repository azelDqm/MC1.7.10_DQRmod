...
public class DqmTileEntityRenderFigureMetoroghost extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelGhost model = new DqmModelGhost();
    ...
    {
        //エンティティ
        DqmTileEntityFigureMetoroghost var9 = (DqmTileEntityFigureMetoroghost)var1;
        GL11.glPushMatrix();
