...
import dqr.entity.mobEntity.model.DqmModelMasterdoragon;

@SideOnly(Side.CLIENT)
public class DqmTileEntityRenderFigureMasterdoragon extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelMasterdoragon model = new DqmModelMasterdoragon();

    private float fixA = 0;
    private float fixB = 1.0F;
    private float fixC = 0;
    private float fixD = 1.0F;
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Masterdoragon.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureMasterdoragon var9 = (DqmTileEntityFigureMasterdoragon)var1;
        GL11.glPushMatrix();
