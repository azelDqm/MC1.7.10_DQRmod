...
public class DqmTileEntityRenderFigureZoma extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelZoma model = new DqmModelZoma();
    ...
    {
        //エンティティ
        DqmTileEntityFigureZoma var9 = (DqmTileEntityFigureZoma)var1;
        GL11.glPushMatrix();
