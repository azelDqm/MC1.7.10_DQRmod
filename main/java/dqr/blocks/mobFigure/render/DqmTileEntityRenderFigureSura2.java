...
public class DqmTileEntityRenderFigureSura2 extends TileEntitySpecialRenderer
{
    //モデル
	...
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Sura.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureSura2 var9 = (DqmTileEntityFigureSura2)var1;
        GL11.glPushMatrix();
