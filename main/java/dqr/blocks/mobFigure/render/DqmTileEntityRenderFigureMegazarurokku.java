...
public class DqmTileEntityRenderFigureMegazarurokku extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelBakudaniwa model = new DqmModelBakudaniwa();
    ...
    {
        //エンティティ
        DqmTileEntityFigureMegazarurokku var9 = (DqmTileEntityFigureMegazarurokku)var1;
        GL11.glPushMatrix();
