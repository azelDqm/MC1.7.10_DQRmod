...
public class DqmTileEntityRenderFigureFurosutogizumo extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelGizumo model = new DqmModelGizumo();
    ...
    {
        //エンティティ
        DqmTileEntityFigureFurosutogizumo var9 = (DqmTileEntityFigureFurosutogizumo)var1;
        GL11.glPushMatrix();
