...
public class DqmTileEntityRenderFigureGod extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelGod model = new DqmModelGod();
    ...
    {
        //エンティティ
        DqmTileEntityFigureGod var9 = (DqmTileEntityFigureGod)var1;
        GL11.glPushMatrix();
