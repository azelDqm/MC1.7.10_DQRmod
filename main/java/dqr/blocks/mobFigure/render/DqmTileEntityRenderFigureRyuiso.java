...
public class DqmTileEntityRenderFigureRyuiso extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelRyuiso model = new DqmModelRyuiso();
    ...
    {
        //エンティティ
        DqmTileEntityFigureRyuiso var9 = (DqmTileEntityFigureRyuiso)var1;
        GL11.glPushMatrix();
