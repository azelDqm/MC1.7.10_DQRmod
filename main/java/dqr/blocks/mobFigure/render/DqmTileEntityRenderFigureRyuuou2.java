...
import dqr.entity.mobEntity.model.DqmModelRyuuou2;

@SideOnly(Side.CLIENT)
public class DqmTileEntityRenderFigureRyuuou2 extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelRyuuou2 model = new DqmModelRyuuou2();

    private float fixA = 0;
    private float fixB = 2.5F;
    private float fixC = 0;
    private float fixD = 2.5F;
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Ryuuou2.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureRyuuou2 var9 = (DqmTileEntityFigureRyuuou2)var1;
        GL11.glPushMatrix();
