...
public class DqmTileEntityRenderFigureHagumeta extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelBubsura model = new DqmModelBubsura();
    ...
    {
        //エンティティ
        DqmTileEntityFigureHagumeta var9 = (DqmTileEntityFigureHagumeta)var1;
        GL11.glPushMatrix();
