...
public class DqmTileEntityRenderFigureKingbesu extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelSuraimuking model = new DqmModelSuraimuking();
    ...
    {
        //エンティティ
        DqmTileEntityFigureKingbesu var9 = (DqmTileEntityFigureKingbesu)var1;
        GL11.glPushMatrix();
