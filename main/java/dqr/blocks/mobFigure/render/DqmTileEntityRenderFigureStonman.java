...
public class DqmTileEntityRenderFigureStonman extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelGoremu model = new DqmModelGoremu();

    private float fixA = 0;
    private float fixB = 1.0F;
    private float fixC = 0;
    private float fixD = 1.0F;
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Stonman.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureStonman var9 = (DqmTileEntityFigureStonman)var1;
        GL11.glPushMatrix();
