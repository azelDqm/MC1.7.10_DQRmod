...
public class DqmTileEntityRenderFigureGodraida extends TileEntitySpecialRenderer
{
    //モデル
	...
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Godraida.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureGodraida var9 = (DqmTileEntityFigureGodraida)var1;
        GL11.glPushMatrix();
