...
public class DqmTileEntityRenderFigureEriminator extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelKandata model = new DqmModelKandata();

    private float fixA = 0;
    private float fixB = 0.35F;
    private float fixC = 0;
    private float fixD = 0.35F;
    ...
    {
        //エンティティ
        DqmTileEntityFigureEriminator var9 = (DqmTileEntityFigureEriminator)var1;
        GL11.glPushMatrix();
