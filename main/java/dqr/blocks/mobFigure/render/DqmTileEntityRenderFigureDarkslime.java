...
public class DqmTileEntityRenderFigureDarkslime extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelDarkslime model = new DqmModelDarkslime();
    ...
    {
        //エンティティ
        DqmTileEntityFigureDarkslime var9 = (DqmTileEntityFigureDarkslime)var1;
        GL11.glPushMatrix();
