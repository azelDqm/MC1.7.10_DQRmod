...
import dqr.entity.mobEntity.model.DqmModelKirapike;

@SideOnly(Side.CLIENT)
public class DqmTileEntityRenderFigureKirapike extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelKirapike model = new DqmModelKirapike();

    private float fixA = 0;
    private float fixB = 2.5F;
    private float fixC = 0;
    private float fixD = 2.5F;
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Kirapike.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureKirapike var9 = (DqmTileEntityFigureKirapike)var1;
        GL11.glPushMatrix();
