...
public class DqmTileEntityRenderFigureBlackchack extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelTogekonbou model = new DqmModelTogekonbou();
    ...
    {
        //エンティティ
        DqmTileEntityFigureBlackchack var9 = (DqmTileEntityFigureBlackchack)var1;
        GL11.glPushMatrix();
