...
public class DqmTileEntityRenderFigurePinkmomon extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelMomon model = new DqmModelMomon();
    ...
    {
        //エンティティ
        DqmTileEntityFigurePinkmomon var9 = (DqmTileEntityFigurePinkmomon)var1;
        GL11.glPushMatrix();
