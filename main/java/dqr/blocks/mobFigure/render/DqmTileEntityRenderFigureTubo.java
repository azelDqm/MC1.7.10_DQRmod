...
public class DqmTileEntityRenderFigureTubo extends TileEntitySpecialRenderer
{
    //モデル
	...
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Tubo2.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureTubo var9 = (DqmTileEntityFigureTubo)var1;
        GL11.glPushMatrix();
