...
public class DqmTileEntityRenderFigureNorowaretaturugi extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelRotonoturugi model = new DqmModelRotonoturugi();

    private float fixA = 0;
    private float fixB = 4.0F;
    private float fixC = 0;
    private float fixD = 4.0F;
    ...
    {
        //エンティティ
        DqmTileEntityFigureNorowaretaturugi var9 = (DqmTileEntityFigureNorowaretaturugi)var1;
        GL11.glPushMatrix();
