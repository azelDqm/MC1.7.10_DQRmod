...
public class DqmTileEntityRenderFigureBehoimisuraimu extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelHoimisura model = new DqmModelHoimisura();
    ...
    {
        //エンティティ
        DqmTileEntityFigureBehoimisuraimu var9 = (DqmTileEntityFigureBehoimisuraimu)var1;
        GL11.glPushMatrix();
