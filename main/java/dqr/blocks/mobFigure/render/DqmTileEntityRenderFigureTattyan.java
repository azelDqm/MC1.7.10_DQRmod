...
public class DqmTileEntityRenderFigureTattyan extends TileEntitySpecialRenderer
{
    //モデル
	...
	private static final ResourceLocation DqmMobTexture = new ResourceLocation("dqr:textures/entity/mob/Tattyan.png");

    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        //エンティティ
        DqmTileEntityFigureTattyan var9 = (DqmTileEntityFigureTattyan)var1;
        GL11.glPushMatrix();
