...
public class DqmTileEntityRenderFigureBuchunpa extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelRippusu model = new DqmModelRippusu();
    ...
    {
        //エンティティ
        DqmTileEntityFigureBuchunpa var9 = (DqmTileEntityFigureBuchunpa)var1;
        GL11.glPushMatrix();
