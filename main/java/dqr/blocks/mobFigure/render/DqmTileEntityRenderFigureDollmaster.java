...
public class DqmTileEntityRenderFigureDollmaster extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelDollmaster model = new DqmModelDollmaster();
    ...
    {
        //エンティティ
        DqmTileEntityFigureDollmaster var9 = (DqmTileEntityFigureDollmaster)var1;
        GL11.glPushMatrix();
