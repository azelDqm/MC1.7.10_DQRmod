...
public class DqmTileEntityRenderFigureOokiduti extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelBurauni model = new DqmModelBurauni();
    ...
    {
        //エンティティ
        DqmTileEntityFigureOokiduti var9 = (DqmTileEntityFigureOokiduti)var1;
        GL11.glPushMatrix();
