...
public class DqmTileEntityRenderFigureHitokuibako extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelMimikku model = new DqmModelMimikku();
    ...
    {
        //エンティティ
        DqmTileEntityFigureHitokuibako var9 = (DqmTileEntityFigureHitokuibako)var1;
        GL11.glPushMatrix();
