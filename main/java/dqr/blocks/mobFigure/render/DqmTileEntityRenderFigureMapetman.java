...
public class DqmTileEntityRenderFigureMapetman extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelMapetman model = new DqmModelMapetman();
    ...
    {
        //エンティティ
        DqmTileEntityFigureMapetman var9 = (DqmTileEntityFigureMapetman)var1;
        GL11.glPushMatrix();
