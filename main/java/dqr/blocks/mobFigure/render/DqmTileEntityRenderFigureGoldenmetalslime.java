...
public class DqmTileEntityRenderFigureGoldenmetalslime extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelEnzeruslime model = new DqmModelEnzeruslime();
    ...
    {
        //エンティティ
        DqmTileEntityFigureGoldenmetalslime var9 = (DqmTileEntityFigureGoldenmetalslime)var1;
        GL11.glPushMatrix();
