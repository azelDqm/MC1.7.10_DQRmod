...
public class DqmTileEntityRenderFigureSweetbag extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelSweetbag model = new DqmModelSweetbag();
    ...
    {
        //エンティティ
        DqmTileEntityFigureSweetbag var9 = (DqmTileEntityFigureSweetbag)var1;
        GL11.glPushMatrix();
