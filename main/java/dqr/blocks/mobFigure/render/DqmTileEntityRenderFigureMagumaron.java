...
public class DqmTileEntityRenderFigureMagumaron extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelJeriman model = new DqmModelJeriman();
    ...
    {
        //エンティティ
        DqmTileEntityFigureMagumaron var9 = (DqmTileEntityFigureMagumaron)var1;
        GL11.glPushMatrix();
