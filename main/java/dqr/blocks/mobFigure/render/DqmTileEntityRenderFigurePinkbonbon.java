...
public class DqmTileEntityRenderFigurePinkbonbon extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelKedamon model = new DqmModelKedamon();
    ...
    {
        //エンティティ
        DqmTileEntityFigurePinkbonbon var9 = (DqmTileEntityFigurePinkbonbon)var1;
        GL11.glPushMatrix();
