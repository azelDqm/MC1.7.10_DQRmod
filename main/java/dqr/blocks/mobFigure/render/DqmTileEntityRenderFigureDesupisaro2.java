...
import dqr.entity.mobEntity.model.DqmModelDesupisaro2;

@SideOnly(Side.CLIENT)
public class DqmTileEntityRenderFigureDesupisaro2 extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelDesupisaro2 model = new DqmModelDesupisaro2();

    private float fixA = 0;
    private float fixB = 2.3F;
    private float fixC = 0;
    private float fixD = 2.3F;
    ...
    {
        //エンティティ
        DqmTileEntityFigureDesupisaro2 var9 = (DqmTileEntityFigureDesupisaro2)var1;
        GL11.glPushMatrix();
