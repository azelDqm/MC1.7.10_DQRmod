...
public class DqmTileEntityRenderFigureShadopan2 extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelKirapan model = new DqmModelKirapan();
    ...
    {
        //エンティティ
        DqmTileEntityFigureShadopan2 var9 = (DqmTileEntityFigureShadopan2)var1;
        GL11.glPushMatrix();
