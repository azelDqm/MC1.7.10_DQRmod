...
public class DqmTileEntityRenderFigureEsterk extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelEsterk model = new DqmModelEsterk();
    ...
    {
        //エンティティ
        DqmTileEntityFigureEsterk var9 = (DqmTileEntityFigureEsterk)var1;
        GL11.glPushMatrix();
