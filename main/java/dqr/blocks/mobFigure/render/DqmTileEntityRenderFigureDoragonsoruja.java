...
public class DqmTileEntityRenderFigureDoragonsoruja extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelBatorurex model = new DqmModelBatorurex();
    ...
    {
        //エンティティ
        DqmTileEntityFigureDoragonsoruja var9 = (DqmTileEntityFigureDoragonsoruja)var1;
        GL11.glPushMatrix();
