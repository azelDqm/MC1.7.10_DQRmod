...
public class DqmTileEntityRenderFigureGorudensuraimu extends TileEntitySpecialRenderer
{
    //モデル
    private DqmModelPuratinaking model = new DqmModelPuratinaking();
    ...
    {
        //エンティティ
        DqmTileEntityFigureGorudensuraimu var9 = (DqmTileEntityFigureGorudensuraimu)var1;
        GL11.glPushMatrix();
