...
public enum EnumDqmMagic {
	...
	RurasinC(EnumDqmMagicCateg.Telepo, 0, 8, 0, 0, 0, 0),
	Basirura(EnumDqmMagicCateg.Telepo, EnumDqmMagicType.Rura.getId(), 16, 0, 0, 0, 20),
	BasiruraC(EnumDqmMagicCateg.Telepo, EnumDqmMagicType.Rura.getId(), 16, 0, 0, 0, 20),
	BasiruraC2(EnumDqmMagicCateg.Telepo, EnumDqmMagicType.Rura.getId(), 16, 0, 0, 0, 20),
	...
	Mahouken3(EnumDqmMagicCateg.ETC, 0, 30, 500, 1200, 0, 0),
	Mahouken4(EnumDqmMagicCateg.ETC, 0, 10, 500, 1200, 0, 0),
	Mahouken5(EnumDqmMagicCateg.ETC, 0, 10, 500, 1200, 0, 0),
	Mahouken6(EnumDqmMagicCateg.ETC, 0, 10, 500, 600, 0, 0),
	Mahouken7(EnumDqmMagicCateg.ETC, 0, 10, 500, 600, 0, 0),
	...
	RuraSinC(EnumDqmMagicCateg.Telepo, EnumDqmMagicType.Rura.getId(), 8, 500, 0, 0, 0),
	RuraSinRC(EnumDqmMagicCateg.Telepo, EnumDqmMagicType.RuraR.getId(), 8, 500, 0, 0, 0),
	RuraSinGC(EnumDqmMagicCateg.Telepo, EnumDqmMagicType.RuraG.getId(), 8, 500, 0, 0, 0),
	RuraSinBC(EnumDqmMagicCateg.Telepo, EnumDqmMagicType.RuraB.getId(), 8, 500, 0, 0, 0),
	RuraSinYC(EnumDqmMagicCateg.Telepo, EnumDqmMagicType.RuraY.getId(), 8, 500, 0, 0, 0),
