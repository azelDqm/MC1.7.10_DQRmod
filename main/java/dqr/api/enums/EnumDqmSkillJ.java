...
public enum EnumDqmSkillJ {
	...
	JSKILL_22_6(84, 22, 6, 1, 35, 30, 80, EnumDqmStatus.MP.getId(), 15, 0, 0, 0, 0),
	...
	private EnumDqmSkillJ(int id, int job, int idx, int activeSkill, int needLv, int needSP, int needSP_all, int needPt_cat, int needPt_val, int coolTime, int duration, int sRate, int sValue, int iconX, int iconY, String iconKey)
	{
		this.id = id;
		this.job = job;
		this.idx = idx;
		...
		this.needLv = needLv;
		this.needSP = needSP;
		this.needSP_all = needSP_all;
		this.needPt_cat = needPt_cat;
		this.needPt_val = needPt_val;
	...
	private EnumDqmSkillJ(int id, int job, int idx, int activeSkill, int needLv, int needSP, int needSP_all, int needPt_cat, int needPt_val, int coolTime, int duration, int sRate, int sValue)
	{
		this(id, job, idx, activeSkill, needLv, needSP, needSP_all, needPt_cat, needPt_val, coolTime, duration, sRate, sValue, -1, -1, "");
	}
	public int getId(){return this.id;}
	public int getJob(){return this.job;}
	public int getIdx(){return this.idx;}
	public int getActiveskill(){return this.activeSkill;}
	public int getNeedlv(){return this.needLv;}
	public int getNeedsp(){return this.needSP;}
	public int getNeedsp_All(){return this.needSP_all;}
	public int getNeedpt_Cat(){return this.needPt_cat;}
	public int getNeedpt_Val(){return this.needPt_val;}
	public int getCooltime(){return this.coolTime;}
	public int getDuration(){return this.duration;}
	public int getSRate(){return this.sRate;}
	public int getSValue(){return this.sValue;}
	public int getIconX() {return this.iconX;}
	public int getIconY() {return this.iconY;}
	public String getIconKey() {return this.iconKey;}

	public int getActiveSkillCount(){return 55;}
